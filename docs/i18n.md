...
- Batch 5B migrated agent stream work-traces chrome and assistant turn footer duration labels (`agentStream.workTraces`, `message.turnFooter`). Tool names, trace bodies, and agent output remain untranslated.
