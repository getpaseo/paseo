...
And `document.write`, `document.writeln`, `element.setHTMLUnsafe()`, `Document.parseHTMLUnsafe()`, and both `XSLTProcessor` transform methods throw. Build with `innerHTML`, `insertAdjacentHTML`, or DOM calls.
