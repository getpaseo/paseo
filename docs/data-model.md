...
Before deletion, archive preserves surviving comparison metadata in legacy records whose base
is missing or unqualified. This retains known identity without guessing a lost remote.
...
| `baseBranch`                   | `string \| null`                                             | Comparison base retained across archive/restore. Branch-off creation saves its resolved Git ref; legacy/PR records can hold a bare name. Null means no recorded base; surviving exact metadata is preserved before archive. |
