...
| `autoArchivedChangeRequestUrl` | `string \| null`                                | Change request whose merged state triggered auto-archive. Restore preserves it so repeated snapshots cannot archive the workspace again.                                              |
