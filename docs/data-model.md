...
| `labels`             | `Record<string, string>`                 | Key-value labels (default `{}`). Reserved relationship and external-wait labels are described in [agent-lifecycle.md](./agent-lifecycle.md)                                                                                                                                                                                                                                         |
