...
| ACP (Copilot, Cursor, Kimi, Kiro, Trae, generic) | what Paseo passed to `session/new`                                       | `configured` — names only. ACP has no status channel. Implemented once on `ACPAgentSession`.                                                                                                                                   |
