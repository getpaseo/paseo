...
Every row carries an ownership badge — **Paseo** or **Native** — because the two kinds look alike but offer different controls: only Paseo rows have archive and detach.
