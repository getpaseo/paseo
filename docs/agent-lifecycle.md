...
Native workflows reconcile persisted turn identity through this same residency and timeline path.
They do not create a second agent-recovery mechanism. See [workflows.md](./workflows.md).
