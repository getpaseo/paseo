...
>
> **In-app browser compositor budget.** Parked guests keep the paintable 1×1 parking geometry, but main allows background throttling and freezes the page. Presenting a pane, or a capture/automation live hold, is what unthrottles and unfreezes that guest. Runaway guest renderers above 1 GiB working set are reloaded, then crashed if they keep growing. Do not disable throttling at attach.
>
