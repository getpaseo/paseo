...
toggles the singleton Files, Changes, and Explorer-compatible plugin views. Agent-context plugin
views bind to the focused main-pane agent. Individual tab menus close instances or move compatible
tabs to main. Explorer tabs can be reordered, but the dock cannot be split. Selecting an Explorer
