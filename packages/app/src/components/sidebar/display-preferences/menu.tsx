...
const GROUPING_ICONS: Record<SidebarGroupMode, OptionIcon> = {
  ...
  recentActivity: withUnistyles(Clock),
};
...
const GROUPING_MODES: readonly SidebarGroupMode[] = ["project", "status", "recentActivity"];
...
const GROUPING_LABEL_KEYS: Record<SidebarGroupMode, string> = {
  ...
  recentActivity: "sidebar.display.grouping.recentActivity",
};
