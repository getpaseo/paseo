// PlainSetupForm — adapted from emdash for React Native
import { useState } from "react";
import { View, Text, TextInput, Pressable, ActivityIndicator } from "react-native";
import { StyleSheet, useUnistyles } from "react-native-unistyles";
import { Info } from "lucide-react-native";

interface PlainSetupFormProps {
...
export function PlainSetupForm({
  onSubmit,
  onClose,
  isLoading = false,
  error,
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.badge}>Plain setup</Text>
        <Text style={styles.subtitle}>Connect to Plain by entering an API key.</Text>
      </View>
      ...
      <View style={styles.infoBox}>
        ...
        <View style={styles.infoContent}>
          <Text style={styles.infoTitle}>How to get a Plain API key</Text>
          <Text style={styles.infoText}>1. Open Plain, go to Settings → API keys.</Text>
          <Text style={styles.infoText}>2. Create a new API key and copy it.</Text>
        </View>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <Pressable
          onPress={() => canSubmit && void onSubmit(apiKey)}
