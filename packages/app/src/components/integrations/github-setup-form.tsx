// GitHubSetupForm — adapted from emdash for React Native
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.badge}>GitHub setup</Text>
        <Text style={styles.subtitle}>Connect to GitHub with a personal access token.</Text>
      </View>
      ...
      <View style={styles.infoBox}>
        ...
        <View style={styles.infoContent}>
          <Text style={styles.infoTitle}>How to get a GitHub token</Text>
          <Text style={styles.infoText}>1. Go to github.com/settings/tokens</Text>
          <Text style={styles.infoText}>2. Generate a new token (classic) with repo scope.</Text>
          <Text style={styles.infoText}>3. Copy the token and paste it here.</Text>
        </View>
      </View>
