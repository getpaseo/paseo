// GitHubIssuePreview — adapted from emdash tooltip to React Native card
import { View, Text, Pressable, Linking } from "react-native";
import { StyleSheet, useUnistyles } from "react-native-unistyles";
import { ExternalLink, Users, Tag } from "lucide-react-native";
import type { GitHubIssueSummary } from "@/types/integrations";

interface GitHubIssuePreviewProps {
...
export function GitHubIssuePreview({ issue }: GitHubIssuePreviewProps) {
    ...
    <View style={styles.card}>
      <View style={styles.headerRow}>
        <View style={styles.headerLeft}>
          <Text style={styles.provider}>GitHub Issue</Text>
      ...
      <View style={styles.metaRow}>
        ...
        {issue.assignees && issue.assignees.length > 0 ? (
          <View style={styles.metaItem}>
            <Users size={10} color={theme.colors.foregroundMuted} />
