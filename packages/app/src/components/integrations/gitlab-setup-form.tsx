// GitLabSetupForm — adapted from emdash for React Native
import { useState } from "react";
import { View, Text, TextInput, Pressable, ActivityIndicator } from "react-native";
import { StyleSheet, useUnistyles } from "react-native-unistyles";
import { Info } from "lucide-react-native";

interface GitLabSetupFormProps {
...
export function GitLabSetupForm({
  onSubmit,
  onClose,
  isLoading = false,
  error,
}: GitLabSetupFormProps) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.badge}>GitLab setup</Text>
        <Text style={styles.subtitle}>Connect to GitLab with a personal access token.</Text>
      </View>
      ...
      <View style={styles.infoBox}>
        ...
        <View style={styles.infoContent}>
          ...
          <Text style={styles.infoText}>
            Create a personal access token with the read_api scope at Settings → Access Tokens.
          </Text>
        </View>
      </View>
