...
export function AddHostModal({
  ...
  const handleCancel = useCallback(() => {
    ...
    setErrorMessage("");
    (onCancel ?? onClose)();
  }, [clearInput, isSaving, onCancel, onClose]);
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      const { title, detail, raw } = buildConnectionFailureCopy(connection.uri, error);
      const combined =
  ...
  return (
    ...
    >
      <Text style={styles.helper}>Enter the address of a Hubcode server.</Text>
