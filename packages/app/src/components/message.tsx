...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "hubcode-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "hubcode-toolcall-shimmer";
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--hubcode-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--hubcode-shimmer-end, 200px) 0;
    }
  }
`;
...
const ExpandableBadge = memo(function ExpandableBadge({
  ...
  const shimmerLabelStyle = isWebShimmer
    ? ({
        ...
        "--hubcode-shimmer-start": `${webShimmerTrackStart - labelOffsetX}px`,
        "--hubcode-shimmer-end": `${webShimmerTrackEnd - labelOffsetX}px`,
      } as never)
    : null;
  ...
  const shimmerSecondaryStyle = isWebShimmer
    ? ({
        ...
        WebkitTextFillColor: "transparent",
        animation: `${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} ${shimmerDuration}s linear infinite`,
        "--hubcode-shimmer-start": `${webShimmerTrackStart - secondaryOffsetX}px`,
        "--hubcode-shimmer-end": `${webShimmerTrackEnd - secondaryOffsetX}px`,
      } as never)
    : null;
