...
type ScrollInvestigationGlobal = typeof globalThis & {
  __HUBCODE_SCROLL_JANK_INVESTIGATION__?: ScrollInvestigationStore;
  __HUBCODE_SCROLL_JANK_INVESTIGATION_DISABLED__?: boolean;
};
...
function shouldInstall(): boolean {
  ...
  return isWeb && isDev && !runtime.__HUBCODE_SCROLL_JANK_INVESTIGATION_DISABLED__;
}
...
export function installScrollJankInvestigation(): void {
  ...
  const runtime = globalThis as ScrollInvestigationGlobal;
  if (runtime.__HUBCODE_SCROLL_JANK_INVESTIGATION__) {
    return;
  }
  ...
  runtime.__HUBCODE_SCROLL_JANK_INVESTIGATION__ = store;
  console.log(
    `${SOURCE_LABEL} installed`,
    "Use window.__HUBCODE_SCROLL_JANK_INVESTIGATION__.snapshot()",
  );
}

function getStore(): ScrollInvestigationStore | null {
  const runtime = globalThis as ScrollInvestigationGlobal;
  return runtime.__HUBCODE_SCROLL_JANK_INVESTIGATION__ ?? null;
}
