...
export function TimelineSyncStatus({ sync }: { sync: AgentScreenReadySyncState | null }) {
  ...
  return <ToastViewport toast={toast} onDismiss={keepUntilSynchronized} placement="panel" />;
}
