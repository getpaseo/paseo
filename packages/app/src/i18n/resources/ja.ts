...
export const ja: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        markReadFailed: "ワークスペースを既読にできませんでした",
  ...
  newWorkspace: {
    ...
    projectPicker: {
      ...
      accessibilityLabel: "ワークスペースのプロジェクト",
    },
    hostPicker: {
      title: "ホスト",
      fallbackLabel: "ホスト",
    ...
    errors: {
      chooseProject: "プロジェクトを選択してください",
      chooseHostForProject: "このプロジェクトのホストを選択してください",
      hostDisconnected: "ホストが接続されていません",
  ...
  settings: {
    ...
    diagnostics: {
      ...
      notification: {
        rowTitle: "通知",
        rowHint: "権限を確認してテスト通知を送信",
        sendTest: "テスト送信",
        sending: "送信中...",
        sent: "テスト通知を送信しました。",
        notDelivered:
          "通知を配信できませんでした。ブラウザまたはシステムの通知設定を確認してください。",
        failed: "通知の送信に失敗しました。",
      },
      app: {
        title: "アプリ診断",
        rowTitle: "アプリ診断",
        rowHint: "接続、デーモン、プロバイダー、デスクトップ、通知、ログの詳細を収集",
        run: "実行",
        running: "診断を実行中...",
        copyLabel: "診断情報",
        copyAccessibility: "診断情報をコピー",
        copyFailed: "診断情報のコピーに失敗しました",
        refreshAccessibility: "診断情報を更新",
        refreshingAccessibility: "診断情報を更新中",
        progress: {
          client: "クライアント",
          notifications: "通知",
          desktop: "デスクトップ",
    ...
    host: {
      ...
      workspaces: {
        ...
        autoArchiveAfterMerge: {
          ...
          hint: "プルリクエストがマージされたら、クリーンな Paseo ワークスペースを自動アーカイブします",
          accessibilityLabel: "マージ済み PR のワークスペースをアーカイブ",
          updateFailedTitle: "ワークスペース設定を更新できません",
        },
      },
      browserTools: {
        title: "ブラウザツール",
        hint: "エージェントが Paseo のブラウザタブ（ログイン状態を含む）にアクセスして操作できるようにします。信頼できるエージェントにのみ有効にしてください。",
        accessibilityLabel: "ブラウザツールを有効にする",
        updating: "ブラウザツールを更新中...",
      },
      terminalAgents: {
        sectionTitle: "ターミナル Agents",
        enableHooks: {
          title: "ターミナル Agent hooks を有効化",
          hint: "ターミナル Agents から通知とステータスを受け取ります。Agent の設定ファイルに hooks をインストールします。",
          accessibilityLabel: "ターミナル Agent hooks を有効化",
          updateFailedTitle: "ターミナル Agent hooks を更新できません",
        },
      },
      terminalProfiles: {
    ...
    providers: {
      ...
      remove: {
        ...
        confirmMessage:
          "config.jsonからこのプロバイダーのエントリを削除します。この操作は元に戻せません。",
        confirm: "削除",
        errorTitle: "プロバイダーを削除できません",
      },
      statuses: {
        disabled: "無効",
        loading: "読み込み中",
  ...
  providerUsage: {
    ...
    hostUnavailable: "プロバイダーの使用量を表示するにはこのホストに接続してください",
    hostUpgradeRequired: "プロバイダーの使用量を表示するにはホストを更新してください",
    clientUnavailable: "ホストへの接続の準備ができていません",
    retry: "再試行",
    ...
    labels: {
      ...
      weekly: "週間",
      weeklyOpus: "週間 · Opus",
      weeklyOmelette: "週間 · Omelette",
      codeReview: "コードレビュー",
      credits: "クレジット",
      monthlyCredits: "月間クレジット",
      extraUsage: "追加使用量",
      codingUsage: "コーディング使用量",
      planUsage: "プラン使用量",
      totalUsage: "合計",
      apiUsage: "API",
    ...
    errors: {
      grokNetwork:
        "Grokの課金APIに接続できませんでした。cli-chat-proxy.grok.comに到達できるか確認してください（プロキシ/VPNのルールでブロックされることがあります）。",
    },
  },
  addProjectFlow: {
    titles: {
      ...
      cloneGithub: "GitHubからクローン",
      chooseDestination: "保存先を選択",
      chooseParent: "親ディレクトリを選択",
      nameDirectory: "ディレクトリ名を入力",
    },
    placeholders: {
      searchHosts: "ホストを検索...",
      searchMethods: "方法を検索...",
      searchDirectories: "ディレクトリを検索するかパスを入力...",
      searchGithub: "検索するかGitHubリポジトリを入力...",
      searchParents: "親ディレクトリを検索するかパスを入力...",
      directoryName: "ディレクトリ名",
    },
    methods: {
      searchDirectory: "ディレクトリを検索",
      searchDirectoryDescription: "{{host}}上のディレクトリを探す",
      browse: "参照",
      browseDescription: "Finderでディレクトリを選択または作成",
      github: "GitHubからクローン",
      githubDescriptionSearch: "GitHubアカウントで利用可能なプロジェクトを検索",
      githubDescriptionManual: "GitHubのURLまたはowner/repoを入力",
      githubDescriptionUpgrade: "GitHubリポジトリをクローンするにはこのホストを更新してください",
      newDirectory: "新しいディレクトリ",
      newDirectoryDescription: "{{host}}上に空のディレクトリを作成",
      newDirectoryDescriptionUpgrade: "ディレクトリを作成するにはこのホストを更新してください",
    },
    empty: {
      noHosts: "接続されているホストがありません",
      noMatching: "一致するオプションがありません",
      enterGithub: "GitHubのURLまたはowner/repoを入力",
      updateHost: "「プロジェクトを追加」を使うにはホストを更新してください。",
    },
    hints: {
      navigate: "移動",
      select: "選択",
    ...
    rows: {
      addHost: "ホストを追加",
      openThisPath: "このパスを開く",
      useThisParent: "この親ディレクトリを使用",
      existingProject: "既存のプロジェクト · {{path}}",
      alreadyExists: "すでに存在します",
      parentDirectory: "親ディレクトリ: {{path}}",
      cloneRepositoryUrl: "このリポジトリURLをクローン",
      cloneViaProtocol: "{{protocol}}でowner/repoをクローン",
      viaProtocol: "{{name}}（{{protocol}}）",
    },
    errors: {
      hostUnavailable: "ホストが利用できません",
      directoryNotFound: "ディレクトリが見つかりません",
      unableToAdd: "プロジェクトを追加できません",
      unableToBrowse: "ディレクトリを参照できません",
      unableToClone: "リポジトリをクローンできません",
      unableToCreateDirectory: "ディレクトリを作成できません",
      enterDirectoryName: "ディレクトリ名を入力してください",
      unableToSearchDirectories: "ディレクトリを検索できません",
      unableToSearchGithub: "GitHubリポジトリを検索できません",
      githubUnavailable: "GitHub検索は利用できません",
    },
    accessibility: {
      back: "戻る",
      page: "プロジェクトを追加: {{kind}}",
  ...
  schedules: {
    ...
    empty: {
      noActive: "有効なスケジュールはありません",
      description: "スケジュールは設定した間隔でエージェントを実行します。",
      noEnded: "終了したスケジュールはありません",
    },
    errors: {
      unableToLoad: "スケジュールを読み込めません",
      hostLoadFailed: "{{serverName}}: スケジュールを読み込めませんでした",
    },
    row: {
      created: "{{time}}に作成",
      lastRun: "前回の実行 {{time}}",
      ...
      menu: {
        actions: "{{productName}}のアクション",
        edit: "{{productName}}を編集",
        editRow: "{{productName}} {{title}}を編集",
        resume: "スケジュールを再開",
        resuming: "再開中...",
        pause: "スケジュールを一時停止",
        pausing: "一時停止中...",
    ...
    form: {
      titleCreate: "新しいスケジュール",
      titleEdit: "スケジュールを編集",
      titleEditHeartbeat: "ハートビートを編集",
      cancel: "キャンセル",
      saveChanges: "変更を保存",
      ...
      fields: {
        name: "名前",
        namePlaceholder: "任意",
        nameAccessibility: "スケジュール名",
        prompt: "プロンプト",
        promptPlaceholder: "実行のたびにエージェントに何をさせますか？",
        maxRuns: "最大実行回数",
        maxRunsPlaceholder: "無制限",
        maxRunsAccessibility: "最大実行回数",
        host: "ホスト",
        hostPlaceholder: "ホストを選択",
        hostEmpty: "ホストが見つかりません",
        project: "プロジェクト",
        projectPlaceholder: "プロジェクトを選択",
        projectEmpty: "プロジェクトが見つかりません",
        projectHint: "先にホストを選択してください。",
        projectSearch: "プロジェクトを検索...",
        projectTitle: "プロジェクトを選択",
        model: "モデル",
        thinking: "思考",
        thinkingPlaceholder: "思考を選択",
        thinkingEmpty: "思考オプションが見つかりません",
        thinkingTitle: "思考を選択",
        mode: "モード",
        modePlaceholder: "デフォルトモード",
        modeEmpty: "モードが見つかりません",
        modeHint: "このモデルでは利用可能なモードがありません。",
        modeTitle: "モードを選択",
        archiveOnFinish: "完了時にアーカイブ",
        isolation: "分離",
        isolationPlaceholder: "分離方法を選択",
        isolationEmpty: "分離オプションが見つかりません",
        isolationLocal: "ローカル",
    ...
    format: {
      untitled: "無題の{{productName}}",
      everyMinute: "毎分",
      everyHour: "毎時",
      everyHourAt: "毎時 :{{minutes}}",
      everyInterval: "{{count}}{{unit}}ごと",
      unitMinute: "分",
      unitMinutes: "分",
      unitHour: "時間",
      unitHours: "時間",
