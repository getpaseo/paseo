  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        ...
        generate: "生成",
        generating: "生成中...",
        generationFailed: "コミットメッセージを生成できませんでした。",
        generationUnsupported: "コミットメッセージを生成するにはホストを更新してください。",
        selectAll: "すべての変更を選択",
        selectedCount: "{{total}} 件中 {{count}} 件選択済み",
        selectAtLeastOne: "コミットするファイルを1つ以上選択してください。",
        includeFile: "コミットに {{path}} を含める",
        discardFile: "{{path}} の変更を破棄",
        commitFailed: "変更をコミットできませんでした。",
      },
      sourceControl: {
        staged: "ステージされた変更",
        unstaged: "変更",
        ...
        stageFile: "{{path}} をステージ",
        unstageFile: "{{path}} をステージ解除",
        stageBeforeCommit: "コミットする前にファイルをステージしてください。",
        indexUpdateFailed: "ステージ済みの変更を更新できませんでした。",
        resizeSections: "ステージ済みと未ステージのセクションのサイズを変更",
      },
      diff: {
