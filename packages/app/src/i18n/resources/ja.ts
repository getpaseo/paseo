  ...
  workspace: {
    ...
    git: {
      ...
      imageDiff: {
        ...
        new: "変更後",
        xray: "差分強調",
        openImagePreview: "{{title}}画像のプレビューを開く",
        heightDefault: "標準",
        heightLarge: "大",
        noPreviousImage: "変更前の画像はありません",
        imageDeleted: "画像は削除されました",
        tooLarge: "画像が大きすぎるためプレビューできません",
        unsupported: "画像のプレビューは利用できません",
        readError: "画像を読み込めません",
        invalid: "画像データが無効です",
        updateHost: "画像差分をプレビューするにはホストを更新してください",
      },
      openInEditor: {
        open: "開く",
