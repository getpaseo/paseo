...
export const ja: TranslationResources = {
  ...
  composer: {
    ...
    stash: {
      stashed: "プロンプトをスタッシュしました",
      stashedEvicted: "プロンプトをスタッシュしました — 空きを作るため最も古いものを削除しました",
      restored: "スタッシュしたプロンプトを復元しました",
      undo: "元に戻す",
      badgeAccessibilityLabel: "スタッシュ済みプロンプト: {{count}}。スタッシュを開く。",
      menuTitle: "スタッシュ済みプロンプト",
      menuEmpty: "まだ何もスタッシュされていません",
      attachmentsOnly_one: "添付 {{count}} 件",
      attachmentsOnly_other: "添付 {{count}} 件",
      deleteEntry: "スタッシュしたプロンプトを削除",
      otherProviders_one: "他のプロバイダーに {{count}} 件のプロンプトがスタッシュされています",
      otherProviders_other: "他のプロバイダーに {{count}} 件のプロンプトがスタッシュされています",
    },
    errors: {
