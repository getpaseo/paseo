  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        ...
        enabledStatus: "有効",
        disabledStatus: "無効",
        updateRequired: "リレーエンドポイントを設定するには、このホストを更新してください",
        configure: "設定",
        configureTitle: "リレーを設定",
        enabled: "リレーを有効にする",
        endpoint: "デーモンエンドポイント",
        endpointHint: "デーモンが接続するアドレス（host:port）",
        useTls: "デーモン接続で TLS を使用",
        publicEndpoint: "公開エンドポイント",
        publicEndpointHint: "ペアリングリンクに含めるアドレス（host:port）",
        publicUseTls: "公開接続で TLS を使用",
        controlledBy:
          "{{env}} によって制御されています。編集するには起動時の上書きを削除してください。",
        hostPortError: "URL スキームを含めず host:port 形式で入力してください",
        save: "保存",
