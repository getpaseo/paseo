  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        submodule: {
          detached: "デタッチ状態 {{sha}}",
          notInitialized: "サブモジュールが初期化されていません",
          unavailable: "サブモジュールのチェックアウトを利用できません",
          added: "サブモジュールが追加されました",
          deleted: "サブモジュールが削除されました",
          historyUnavailable: "サブモジュールのコミット履歴を利用できません",
          headDiffers: "HEAD {{currentSha}} は固定された {{pinnedSha}} と異なります",
          emptyCommitted: "コミット済みの変更なし",
        },
