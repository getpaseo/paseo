...
export const ja: TranslationResources = {
  ...
  sessions: {
    ...
    organization: {
      trigger: "履歴のフィルターと並べ替え",
      emptyFiltered: "条件に一致するセッションはありません",
      labels: {
        status: "状態",
        project: "プロジェクト",
        host: "ホスト",
      ...
      status: { active: "アクティブ", archived: "アーカイブ済み" },
      activity: {
        anyTime: "指定なし",
        today: "今日",
        pastSevenDays: "過去7日間",
        pastThirtyDays: "過去30日間",
      },
      group: { lastActivity: "最終アクティビティ", project: "プロジェクト", none: "なし" },
      sort: {
      ...
      updateHost: "{{label}} · ホストを更新",
      clearFilters: "フィルターをクリア",
    },
  },
  agentList: {
    fallbackTitle: "新しいセッション",
    sections: { pinned: "固定済み" },
    actions: {
      menuAccessibility: "{{title}}の操作",
      fallbackSession: "セッション",
      sheetTitle: "セッションの操作",
      updateHostToPin: "セッションを固定するにはホストを更新してください",
      pin: "セッションを固定",
      unpin: "セッションの固定を解除",
      pinning: "固定中...",
      unpinning: "固定解除中...",
      archive: "セッションをアーカイブ",
      updatePinFailed: "セッションの固定を更新できませんでした",
    },
    dateSections: {
      recent: "最近",
      today: "今日",
  ...
  sidebar: {
    ...
    organization: {
      ...
      labels: {
        ...
        groupBy: "グループ化",
        sortBy: "並べ替え",
        workspaceTitle: "ワークスペースタイトル",
        workspaceLabel: "ワークスペースラベル",
      },
      status: {
        needsInput: "入力待ち",
        working: "作業中",
      ...
      workspaceTitle: { title: "タイトル", branchName: "ブランチ名" },
      selection: {
        all: "すべて",
        oneSelected: "1件選択中",
        selectedCount: "{{count}}件選択中",
      ...
      updateHost: "{{label}} · ホストを更新",
      actions: {
        newProjectGroup: "新しいプロジェクトグループ…",
        newWorkspaceLabel: "新しいワークスペースラベル…",
        newWorkspaceLabelSelectHost: "新しいワークスペースラベル… · ホストを1つ選択",
        clearFilters: "フィルターをクリア",
        create: "作成",
      },
      project: {
        ...
        hide: "プロジェクトを非表示",
        unhide: "プロジェクトを表示",
        moveToProjectGroup: "プロジェクトグループに移動",
        noProjectGroup: "グループなし",
      },
      projectGroup: {
        modalTitle: "新しいプロジェクトグループ",
        placeholder: "グループ名",
        renameTitle: "プロジェクトグループ名を変更",
        delete: "プロジェクトグループを削除",
        deleteMessage: "「{{name}}」を削除しますか？プロジェクトは削除されません。",
        actionsAccessibility: "{{name}}のプロジェクトグループ操作",
      },
      hiddenProjects: {
        title: "非表示のプロジェクト",
        unhideAll: "すべて表示",
        empty: "非表示のプロジェクトはありません",
        description:
          "非表示のプロジェクトとワークスペースは、再表示するまでサイドバーに表示されません。",
        showVisible: "表示中の項目を表示",
      },
      sections: {
        hidden: "非表示",
        workspaces: "ワークスペース",
        projects: "プロジェクト",
        pinnedProjects: "固定したプロジェクト",
      },
      workspaceLabel: {
        modalTitle: "新しいワークスペースラベル",
        placeholder: "ラベル名",
        none: "ラベルなし",
        unknown: "不明なラベル",
        renameTitle: "ワークスペースラベル名を変更",
        delete: "ワークスペースラベルを削除",
        deleteMessage: "「{{name}}」を削除しますか？ワークスペースは削除されません。",
        accessibility: "ワークスペースラベル：{{label}}",
        actionsAccessibility: "ワークスペースラベル「{{name}}」の操作",
      },
      errors: {
        selectOneHost: "ワークスペースラベルを作成する前にホストを1つ選択してください",
        moveFailed: "ワークスペースを移動できませんでした",
        createdMoveFailed:
          "ワークスペースラベルは作成されましたが、ワークスペースを移動できませんでした",
        createdMoveFailedWithError:
          "ワークスペースラベルは作成されましたが、ワークスペースを移動できませんでした: {{error}}",
        createFailed: "ワークスペースラベルを作成できませんでした",
        hostDisconnected: "ホストに接続されていません",
        deleteWorkspaceLabelFailed: "ワークスペースラベルを削除できませんでした",
      },
    },
    host: {
      noHost: "ホストなし",
