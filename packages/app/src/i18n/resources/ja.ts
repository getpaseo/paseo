...
export const ja: TranslationResources = {
  ...
  plugins: {
    ...
    conflictsTitle: "複数のプラグインが要求している拡張子",
    conflictLine: "{{extension}}: {{winner}} が優先され、{{losers}} は無視されます",
    views: {
      installed: "インストール済み",
      browse: "参照",
    },
    ...
    errors: {
      ...
      entryMissing: "プラグインのエントリファイルが見つかりません。",
      previewFailed: "{{plugin}} はこのファイルを表示できませんでした: {{reason}}",
      panelFailed: "{{plugin}} はこのパネルを表示できませんでした: {{reason}}",
    },
  },
  settings: {
    title: "設定",
