...
export const ja: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      agentEnvironment: {
        sectionTitle: "エージェント環境",
        sectionDescription:
          "エージェントの起動前に、そのディレクトリでコマンドを実行します。出力がエージェントの環境になります。",
        add: "環境セットアップを追加",
        addCustom: "カスタムコマンド…",
        addCustomTitle: "環境コマンドを追加",
        editCommand: "コマンドを編集",
        editCommandTitle: "環境コマンドを編集",
        remove: "削除",
        removeConfirmTitle: "環境セットアップを削除しますか？",
        removeConfirmMessage: "「{{name}}」を削除しますか？",
        moveUp: "上に移動",
        moveDown: "下に移動",
        emptyState:
          "エージェントの起動前に実行されるものはありません。direnv またはカスタムコマンドを追加してください。",
        unknownPreset: "このホストはこのプリセットを認識できません",
        rowFormat: "{{format}} 出力を読み取ります",
        commandLabel: "コマンド",
        commandHint: "スペース区切り。シェルが必要な場合は明示的に実行してください。",
        commandPlaceholder: "direnv export json",
        commandRequired: "コマンドは必須です",
        formatLabel: "出力形式",
        formatJson: "JSON 差分",
        formatEnv0: "env -0",
        formatJsonHint: "「KEY」:「value」のオブジェクト。null は変数を削除します。",
        formatEnv0Hint: "NUL 区切りの KEY=VALUE レコード。省略されたものは削除されます。",
        timeoutLabel: "タイムアウト",
        timeoutHint: "コマンドを中断するまでのミリ秒。空にするとホストの既定値を使います。",
        timeoutPlaceholder: "30000",
        timeoutInvalid: "タイムアウトは正の整数である必要があります",
        saving: "保存中...",
        save: "保存",
      },
      terminalProfiles: {
