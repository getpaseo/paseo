...
export const ja: TranslationResources = {
  ...
  providerUsage: {
    ...
    hostUnavailable: "このホストに接続してプロバイダーの使用状況を確認してください",
    hostUpgradeRequired: "ホストを更新してプロバイダーの使用状況を確認してください",
    ...
    timing: {
      ...
      runsOutNow: "まもなく上限に到達",
      runsOutIn: "{{duration}}後に上限に到達",
      justNow: "たった今",
      daysAgo: "{{value}}日前",
      hoursAgo: "{{value}}時間前",
      minutesAgo: "{{value}}分前",
      updated: "更新: {{relativeTime}}",
    },
  },
  settings: {
    title: "設定",
