  ...
  settings: {
    ...
    project: {
      ...
      scripts: {
        ...
        urlAccessibility: "リンク URL",
        nameRequired: "名前は必須です",
        commandRequired: "コマンドは必須です",
        urlRequired: "URL は必須です",
        urlInvalid: "HTTP または HTTPS の URL を入力してください",
        newScript: "新しいスクリプト",
        editScript: "{{name}}を編集",
        ...
        openUrl: "URL を開く",
        openUrlHint:
          "クライアントのブラウザーで開きます。ワークツリーまたはフォルダーのパスには {workspacePath} を使用してください。",
        openUrlUpdateHost: "ブラウザーリンクを追加するには、この Paseo ホストを更新してください。",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
