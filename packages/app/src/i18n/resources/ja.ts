...
export const ja: TranslationResources = {
  ...
  heartbeats: {
    header: "ハートビート",
    headerCount: "ハートビート ({{count}})",
    statusPaused: "一時停止",
    nextRun: "次回 {{when}}",
    pauseAction: "{{label}} を一時停止",
    pauseTooltip: "一時停止",
    pauseFailed: "ハートビートの一時停止に失敗しました",
    resumeAction: "{{label}} を再開",
    resumeTooltip: "再開",
    resumeFailed: "ハートビートの再開に失敗しました",
    deleteAction: "{{label}} を削除",
    deleteTooltip: "削除",
    deleteTitle: "ハートビートを削除",
    deleteMessage: "「{{label}}」を削除しますか？この操作は元に戻せません。",
    deleteConfirm: "削除",
    deleteFailed: "ハートビートの削除に失敗しました",
    providerDetailTitle: "ハートビート",
    detailPrompt: "プロンプト",
    detailMode: "モード",
