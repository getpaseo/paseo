...
export const ja: TranslationResources = {
  ...
  contextWindow: {
    ...
    promptCache: {
      title: "プロンプトキャッシュ",
      statusWarm: "有効",
      statusExpiring: "まもなく失効",
      statusExpired: "失効した可能性",
      statusUnknown: "保持時間不明",
      warmFor: "残り約{{duration}}",
      expiredAgo: "{{duration}}前に失効",
      lastRequestAgo: "最終リクエストは{{duration}}前",
      durationSeconds: "{{value}}秒",
      durationMinutes: "{{value}}分",
      lastRequest: "最終リクエスト {{percent}}% キャッシュ · {{split}}",
      split: "キャッシュ{{cached}}、新規{{fresh}}",
      splitWithWrite: "キャッシュ{{cached}}、新規{{fresh}}、書き込み{{written}}",
      sessionSingular: "セッション {{percent}}% キャッシュ（{{count}}リクエスト）",
      sessionPlural: "セッション {{percent}}% キャッシュ（{{count}}リクエスト）",
      ping: "温める",
      pinging: "送信中...",
      pingHint: "短いメッセージを送信してキャッシュを維持します",
      pingError: "メッセージを送信できません",
    },
  },
  review: {
    comment: {
