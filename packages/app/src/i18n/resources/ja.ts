...
export const ja: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      videoUnavailable: "動画が利用できません",
      videoPreviewUnavailable: "動画プレビューは利用できません。",
      videoPreviewLoadFailed: "動画プレビューを読み込めません。",
      videoPlaybackUnsupported: "このプラットフォームでは動画を再生できません。",
      review: "レビュー",
      commentsOne: "1件のコメント",
