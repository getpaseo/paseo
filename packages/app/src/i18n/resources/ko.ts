  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        ...
        updateRequired: "릴레이 엔드포인트를 구성하려면 이 호스트를 업데이트하세요",
        configure: "구성",
        configureTitle: "릴레이 구성",
        enabled: "릴레이 사용",
        endpoint: "데몬 엔드포인트",
        endpointHint: "데몬이 연결할 주소(host:port)",
        useTls: "데몬 연결에 TLS 사용",
        publicEndpoint: "공개 엔드포인트",
        publicEndpointHint: "페어링 링크에 포함할 주소(host:port)",
        publicUseTls: "공개 연결에 TLS 사용",
        controlledBy: "{{env}}에서 제어합니다. 편집하려면 시작 재정의를 제거하세요.",
        hostPortError: "URL 스킴 없이 host:port 형식으로 입력하세요",
        save: "저장",
