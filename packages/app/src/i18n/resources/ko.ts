  ...
  settings: {
    ...
    host: {
      ...
      orchestration: {
        ...
        managedMcp: {
          title: "외부 MCP 서버",
          hint: "이 호스트가 시작하는 모든 호환 에이전트에 공유 서버를 주입합니다.",
          empty: "구성된 외부 MCP 서버가 없습니다.",
          addServer: "서버 추가",
          addTitle: "MCP 서버 추가",
          editTitle: "{{name}} 편집",
          serverName: "서버 이름",
          ...
          url: "URL",
          arguments: "인수",
          argumentsHint: "한 줄에 인수 하나를 입력하세요.",
          alwaysLoad: "항상 도구 로드",
          alwaysLoadHint: "이 서버의 모든 도구를 에이전트 프롬프트에 유지합니다.",
          alwaysLoadAccessibility: "MCP 도구 항상 로드",
          environmentVariables: "환경 변수",
          requestHeaders: "요청 헤더",
          secretHint: "비공개 직접 값을 사용하거나 daemon 환경을 참조하세요.",
          add: "추가",
          directValue: "직접 값",
          environmentSource: "환경",
          variable: "변수",
          header: "헤더",
          environmentVariableName: "환경 변수 이름",
          value: "값",
          keepValueHint: "구성된 값을 유지하려면 비워 두세요.",
          save: "저장",
          test: "테스트",
          edit: "편집",
          remove: "제거",
          enable: "{{name}} 활성화",
          connected: "{{latencyMs}}ms 만에 연결 · 도구 {{toolCount}}개",
          rejected: "MCP 서버가 연결을 거부했습니다.",
          duplicateName: "'{{name}}' 이름의 MCP 서버가 이미 있습니다.",
          updateFailed: "MCP 서버를 업데이트할 수 없습니다.",
          removeTitle: "MCP 서버를 제거할까요?",
          removeMessage: "이 호스트가 시작하는 모든 에이전트에서 '{{name}}'을(를) 제거할까요?",
          removeFailed: "MCP 서버를 제거할 수 없습니다.",
          testFailed: "MCP 서버를 테스트할 수 없습니다.",
          saveFailed: "MCP 서버를 저장할 수 없습니다.",
          entryNameRequired: "각 헤더 또는 환경 항목에는 이름이 필요합니다.",
          envNameRequired: "환경 참조에는 변수 이름이 필요합니다.",
          directValueRequired: "직접 값은 비워 둘 수 없습니다.",
          uniqueEntries: "헤더와 환경 항목 이름은 고유해야 합니다.",
          nameRequired: "서버 이름이 필요합니다.",
          commandRequired: "명령이 필요합니다.",
          urlRequired: "URL이 필요합니다.",
          invalidUrl: "유효한 MCP 서버 URL을 입력하세요.",
          httpOnly: "MCP 서버 URL은 HTTP 또는 HTTPS를 사용해야 합니다.",
        },
        systemPrompt: {
          title: "시스템 프롬프트",
