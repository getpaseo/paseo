...
export const ko: TranslationResources = {
  ...
  plugins: {
    ...
    loadingRegistry: "플러그인 레지스트리를 불러오는 중…",
    emptyInstalled: "설치된 플러그인이 없습니다.",
    emptyRegistry: "레지스트리에 아직 플러그인이 없습니다.",
    refreshRegistry: "새로 고침",
    panelLoading: "패널을 불러오는 중…",
    unknownAuthor: "알 수 없는 작성자",
    versionLine: "v{{version}} · {{author}}",
    unsupportedTitle: "플러그인에 최신 호스트가 필요합니다",
    unsupportedMessage: "플러그인을 사용하려면 이 호스트를 Paseo 0.2.6 이상으로 업데이트하세요.",
    disconnectedTitle: "연결된 호스트가 없습니다",
    disconnectedMessage: "플러그인을 설치하고 관리하려면 호스트에 연결하세요.",
    unavailableTitle: "플러그인을 사용할 수 없습니다",
    uninstallTitle: "플러그인 제거",
    uninstallMessage: "{{name}} 및 관련 파일을 이 호스트에서 제거할까요?",
    conflictsTitle: "여러 플러그인이 요청한 확장자",
    conflictLine: "{{extension}}: {{winner}} 적용, {{losers}} 무시됨",
    views: {
      installed: "설치됨",
      browse: "둘러보기",
    },
    ...
    toast: {
      installed: "플러그인을 설치했습니다",
      uninstalled: "플러그인을 제거했습니다",
      enabled: "플러그인을 사용합니다",
      disabled: "플러그인을 사용하지 않습니다",
    },
    errors: {
      readyTimeout: "이 플러그인이 로딩을 마치지 못했습니다.",
      listFailed: "플러그인을 불러올 수 없습니다",
      actionFailed: "플러그인 작업에 실패했습니다",
      registryFailed: "플러그인 레지스트리를 불러올 수 없습니다",
      installFailed: "설치에 실패했습니다",
      entryMissing: "플러그인 진입 파일이 없습니다.",
      previewFailed: "{{plugin}}이(가) 이 파일을 표시할 수 없습니다: {{reason}}",
      panelFailed: "{{plugin}}이(가) 이 패널을 표시할 수 없습니다: {{reason}}",
    },
  },
  settings: {
    title: "설정",
