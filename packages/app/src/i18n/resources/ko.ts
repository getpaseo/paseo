  ...
  settings: {
    ...
    project: {
      ...
      scripts: {
        ...
        urlAccessibility: "링크 URL",
        nameRequired: "이름을 입력하세요",
        commandRequired: "명령을 입력하세요",
        urlRequired: "URL을 입력하세요",
        urlInvalid: "HTTP 또는 HTTPS URL을 입력하세요",
        newScript: "새 스크립트",
        editScript: "{{name}} 편집",
        ...
        openUrl: "URL 열기",
        openUrlHint:
          "클라이언트 브라우저에서 엽니다. 워크트리 또는 폴더 경로에는 {workspacePath}를 사용하세요.",
        openUrlUpdateHost: "브라우저 링크를 추가하려면 이 Paseo 호스트를 업데이트하세요.",
        actions: {
          add: "스크립트 추가",
          edit: "편집",
          remove: "제거",
