  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        submodule: {
          detached: "분리됨 {{sha}}",
          notInitialized: "서브모듈이 초기화되지 않았습니다",
          unavailable: "서브모듈 체크아웃을 사용할 수 없습니다",
          added: "서브모듈이 추가되었습니다",
          deleted: "서브모듈이 삭제되었습니다",
          historyUnavailable: "서브모듈 커밋 기록을 사용할 수 없습니다",
          headDiffers: "HEAD {{currentSha}}이(가) 고정된 {{pinnedSha}}과(와) 다릅니다",
          emptyCommitted: "커밋된 변경 사항이 없습니다",
        },
