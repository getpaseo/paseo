  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        ...
        generate: "생성",
        generating: "생성 중...",
        generationFailed: "커밋 메시지를 생성하지 못했습니다.",
        generationUnsupported: "커밋 메시지를 생성하려면 호스트를 업데이트하세요.",
        selectAll: "모든 변경 사항 선택",
        selectedCount: "{{total}}개 중 {{count}}개 선택됨",
        selectAtLeastOne: "커밋할 파일을 하나 이상 선택하세요.",
        includeFile: "커밋에 {{path}} 포함",
        discardFile: "{{path}}의 변경 사항 버리기",
        commitFailed: "변경 사항을 커밋하지 못했습니다.",
      },
      sourceControl: {
        staged: "스테이징된 변경 사항",
        unstaged: "변경 사항",
        ...
        stageFile: "{{path}} 스테이징",
        unstageFile: "{{path}} 스테이징 해제",
        stageBeforeCommit: "커밋하기 전에 파일을 스테이징하세요.",
        indexUpdateFailed: "스테이징된 변경 사항을 업데이트하지 못했습니다.",
        resizeSections: "스테이징된 섹션과 스테이징되지 않은 섹션 크기 조절",
      },
      diff: {
