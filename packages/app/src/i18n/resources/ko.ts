...
export const ko: TranslationResources = {
  ...
  panels: {
    ...
    commitLog: {
      ...
      tooltip: "커밋 기록 보기",
      directoryMissing: "워크스페이스 디렉터리를 찾을 수 없습니다.",
      capabilityMissing: "커밋 기록을 보려면 호스트를 업데이트하세요.",
      connecting: "호스트에 연결하는 중…",
      loading: "기록을 불러오는 중…",
      loadError: "커밋 기록을 불러오지 못했습니다",
      empty: "아직 커밋이 없습니다",
      loadMore: "더 불러오기",
      loadingMore: "불러오는 중…",
      refresh: "새로 고침",
      refreshing: "새로 고치는 중",
      truncatedRefs: "최근에 업데이트된 브랜치와 태그만 표시합니다",
      cursorExpired: "불러오는 동안 기록이 변경되어 처음부터 다시 불러왔습니다.",
      scope: {
        head: "현재 브랜치",
        all: "모든 브랜치",
      },
