  ...
  workspace: {
    ...
    browser: {
      ...
      controls: {
        ...
        annotateElement: "Редактировать элемент",
      ...
      annotate: {
        ...
        submit: "Прикрепить",
        cancel: "Отмена",
        reset: "Восстановить исходное",
        adjust: "Настроить свойства",
        previewFailed: "Не удалось обновить предпросмотр элемента",
        groups: { content: "Содержимое", appearance: "Оформление", properties: "Свойства" },
        fields: {
          checked: "Выбрано",
          value: "Значение",
          text: "Текст",
