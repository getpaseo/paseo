...
export const ru: TranslationResources = {
  ...
  audioSession: {
    busy: {
      voiceMode: "Голосовой режим использует микрофон. Сначала остановите его.",
      dictation: "Диктовка использует микрофон. Сначала остановите её.",
      liveVoice: "Живой голос использует микрофон. Сначала остановите его.",
  ...
  liveVoice: {
    ...
    unavailable: {
      ...
      noHosts: "Добавьте хост, чтобы использовать живой голос.",
      ...
      toolsDisabled:
        "Включите инструменты Paseo в настройках этого хоста, чтобы использовать живой голос.",
    },
    settings: {
      title: "Живой голос",
      voice: {
      ...
      agentReports: {
        ...
        description:
          "Во время звонка вы услышите, когда любая сессия агента завершится, упадёт или запросит разрешение — включая запущенные вне звонка, на любом подключённом хосте.",
      },
      agentReportGuidance: {
        label: "Когда прерывать",
        description: "Передаётся голосовому агенту дословно. Оставьте пустым — решит сам.",
        placeholder: "Прерывай меня только ради запросов разрешений и ошибок.",
      },
      promptComponents: {
        "canonical-tools": {
          label: "Шпаргалка инструментов",
          description: "Даёт ассистенту точные имена инструментов, экономя ходы на поиск.",
        },
        "delegation-brevity": {
          label: "Краткие поручения",
          description:
            "Держит промпты к сессиям агентов короткими — без диктовки кода и списков шагов.",
        },
        "cross-host-reach": {
          label: "Обзор всех машин",
          description: "Объясняет ассистенту, какие чтения покрывают все машины одним вызовом.",
        },
        recipes: {
          label: "Рецепты",
          description:
            "Кратчайшие известные пути для типичных запросов, например архивирования по имени.",
        },
        "speech-style": {
          label: "Стиль речи",
          description: "Разговорные фразы, сначала действие — потом рассказ, словарь Paseo.",
        },
      },
      customInstructions: {
        label: "Постоянные инструкции",
        description: "Передаются голосовому агенту дословно в каждом звонке.",
        placeholder: "Всегда отвечай одним предложением, пока не попрошу подробнее.",
      },
      defaultWorkspaceDirectory: {
        label: "Каталог рабочего пространства по умолчанию",
        description:
          "Где создаются новые рабочие пространства, когда в запросе нет очевидного. Оставьте пустым — голосовой агент спросит.",
    ...
    status: {
      connecting: "Подключение...",
      live: "В эфире",
      audioBlocked: "Звук заблокирован",
      stopping: "Остановка...",
    ...
    errors: {
      busy: "На этом хосте уже идёт звонок живого голоса.",
      unsupported: "Этот хост не поддерживает живой голос.",
      startFailed: "Не удалось запустить живой голос.",
      micBusy: "Микрофон используется другой функцией.",
      notConnected: "Этот хост не подключён.",
      alreadyActive: "Звонок живого голоса уже идёт.",
      stopping: "Предыдущий звонок живого голоса ещё останавливается.",
      micDenied:
        "Доступ к микрофону заблокирован. Разрешите Paseo использовать микрофон и повторите попытку.",
      micUnavailable:
        "Подходящий микрофон не найден. Подключите его или выберите в настройках звука устройства, затем повторите попытку.",
  ...
  assistants: {
    menu: {
      label: "Ассистент",
      none: "Без ассистента",
      manage: "Управление ассистентами…",
    },
    settings: {
      title: "Ассистенты",
      description:
        "Именованные голосовые ассистенты со своими инструкциями, голосом, моделью действий и запомненным разговором. Ассистент, выбранный в меню «Живой голос», заменяет настройки звонка ниже.",
      manage: "Управлять",
    },
    manage: {
      title: "Ассистенты",
      noHosts: "Ни один подключённый хост не поддерживает ассистентов. Обновите его демон.",
      assistants: "Ассистенты",
      empty: "Ассистентов пока нет. Создайте одного, чтобы дать звонкам имя и память.",
      templates: "Шаблоны",
      templatesEmpty:
        "Шаблонов нет. Сохраните ассистента как шаблон, чтобы переиспользовать его настройки.",
      selectedForCalls: "Используется для звонков живого голоса",
      fromTemplate: "Из {{name}}",
      entries: "Записей истории: {{n}}",
    },
    actions: {
      newAssistant: "Новый ассистент",
      newTemplate: "Новый шаблон",
      menu: "Действия для {{name}}",
      useForCalls: "Использовать для звонков",
      stopUsing: "Не использовать для звонков",
      openHistory: "Открыть историю",
      edit: "Изменить",
      saveAsTemplate: "Сохранить как шаблон",
      newFromTemplate: "Новый ассистент из шаблона",
      delete: "Удалить",
      deleteAssistantTitle: "Удалить {{name}}?",
      deleteAssistantMessage:
        "История разговора и сводка будут удалены. Работа, переданная агентам, продолжится.",
      deleteTemplateTitle: "Удалить шаблон {{name}}?",
      deleteTemplateMessage: "Ассистенты, созданные из него, сохраняют собственную копию настроек.",
    },
    form: {
      createAssistantTitle: "Новый ассистент",
      editAssistantTitle: "Изменить ассистента",
      ...
      name: {
        label: "Имя",
        placeholder: "Руководитель аппарата",
      },
      startFrom: {
        label: "Начать с",
        hint: "Копирует настройки шаблона. Дальнейшие правки остаются у этого ассистента.",
        none: "Пусто",
        empty: "Шаблонов нет",
      },
      instructions: {
        label: "Инструкции",
        hint: "{{length}} / {{max}}. Передаются голосовому агенту как есть при каждом звонке.",
        placeholder: "Передавай работу агентам; никогда не пиши код сам.",
      },
      context: {
        label: "Контекст",
        hint: "{{length}} / {{max}}. Постоянный фон, известный ассистенту в начале каждого звонка.",
        placeholder: "Мы выпускаем голосовой проект. Предпочитай репозиторий paseo.",
      },
      voice: {
        label: "Голос",
        hint: "Используется для новых звонков.",
        default: "По умолчанию",
      },
      backendModel: {
        label: "Модель действий",
        hint: "Выполняет действия ассистента в фоне; это не говорящая модель.",
        default: "По умолчанию (быстрая)",
      },
      backendThinking: {
        label: "Рассуждение действий",
        hint: "Глубина рассуждения модели действий.",
        default: "По умолчанию",
      },
      errors: {
    ...
    history: {
      title: "История",
      empty: "Пока ничего не запомнено. Начните звонок.",
      loadOlder: "Загрузить более ранние",
      callStarted: "Звонок начат",
      callEnded: "Звонок завершён · {{cause}}",
      delegationOk: "Делегировано: {{description}}",
      delegationFailed: "Делегирование не удалось ({{code}}): {{description}}",
      user: "Вы",
      assistant: "Ассистент",
      limits:
        "Новые звонки начинаются со сводки и недавней истории, которая помещается в лимит контекста провайдера. Живая речь не возобновляется.",
      summary: {
        label: "Сводка",
        hint: "Написана вами. Новые звонки читают её вместо старой истории.",
        coversThrough: "Охватывает историю до записи №{{seq}}.",
        placeholder: "Что ассистент должен помнить дальше.",
        willCover: "Сохранение охватит историю до записи №{{seq}}.",
