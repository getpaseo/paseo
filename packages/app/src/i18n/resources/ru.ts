  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        submodule: {
          detached: "отсоединённый HEAD {{sha}}",
          notInitialized: "Подмодуль не инициализирован",
          unavailable: "Рабочая копия подмодуля недоступна",
          added: "Подмодуль добавлен",
          deleted: "Подмодуль удалён",
          historyUnavailable: "История коммитов подмодуля недоступна",
          headDiffers: "HEAD {{currentSha}} отличается от закреплённого {{pinnedSha}}",
          emptyCommitted: "Нет зафиксированных изменений",
        },
