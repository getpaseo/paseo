  ...
  settings: {
    ...
    general: {
      ...
      configBackup: {
        ...
        label: "Экспорт или импорт настроек",
        description:
          "Проекты, пользовательские значки, порядок в боковой панели и предпочтения. Сеансы, учётные данные и содержимое репозиториев не включаются.",
        unavailable: "Подключитесь к обновлённому хосту для экспорта или импорта настроек.",
        export: "Экспорт",
        import: "Импорт",
        confirmTitle: "Импортировать настройки?",
        confirmMessage:
          "Проекты и предпочтения будут объединены с этой установкой Paseo. Существующие проекты не удаляются.",
        successTitle: "Резервная копия настроек",
        exportSuccess: "Настройки экспортированы.",
        importSuccess:
          "Добавлено проектов: {{added}}, обновлено: {{updated}}, пропущено: {{skipped}}. Paseo перезагрузится для применения предпочтений.",
        errorTitle: "Не удалось создать резервную копию настроек",
      },
      browserData: {
    ...
    project: {
      ...
      switchHost: "Сменить хост",
      onboarding: {
        title: "Настройка проекта с ИИ",
        description:
          "Сканирует документацию и манифесты, чтобы подготовить хуки, скрипты и инструкции. Ничего не записывается до проверки и сохранения.",
        generate: "Создать черновик",
        generating: "Сканирование проекта...",
        generated: "Черновик создан по {{count}} файлам. Проверьте настройки и сохраните.",
        failedFallback: "Не удалось настроить проект.",
      },
      rename: {
      ...
      icon: {
        ...
        errorFallback: "Не удалось обновить значок",
      },
      readFailures: {
