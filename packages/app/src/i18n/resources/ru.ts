...
export const ru: TranslationResources = {
  ...
  sessions: {
    ...
    errors: {
      loadFailed: "Не удалось загрузить сеансы",
    },
    actions: {
      loadMore: "Загрузить больше",
    },
    organization: {
      trigger: "Фильтры и сортировка истории",
      emptyFiltered: "Нет сеансов, соответствующих этим фильтрам",
      labels: {
        status: "Статус",
        project: "Проект",
        host: "Хост",
      ...
      status: { active: "Активные", archived: "Архивные" },
      activity: {
        anyTime: "За всё время",
        today: "Сегодня",
        pastSevenDays: "За 7 дней",
        pastThirtyDays: "За 30 дней",
      },
      group: { lastActivity: "Последняя активность", project: "Проект", none: "Без групп" },
      sort: {
        alphabetical: "По алфавиту",
        createdTime: "Время создания",
        recency: "По недавней активности",
      },
      selection: {
        all: "Все",
        oneSelected: "Выбран 1",
        selectedCount: "Выбрано: {{count}}",
      },
      updateHost: "{{label}} · Обновите хост",
      clearFilters: "Очистить фильтры",
    },
  },
  agentList: {
    fallbackTitle: "Новая сессия",
    sections: { pinned: "Закреплённые" },
    actions: {
      menuAccessibility: "Действия для {{title}}",
      fallbackSession: "сеанса",
      sheetTitle: "Действия с сеансом",
      updateHostToPin: "Обновите хост, чтобы закреплять сеансы",
      pin: "Закрепить сеанс",
      unpin: "Открепить сеанс",
      pinning: "Закрепление...",
      unpinning: "Открепление...",
      archive: "Архивировать сеанс",
      updatePinFailed: "Не удалось изменить закрепление сеанса",
    },
    dateSections: {
      recent: "Недавний",
      today: "Сегодня",
  ...
  sidebar: {
    ...
    organization: {
      ...
      labels: {
        ...
        workspaceLabel: "Метка рабочего пространства",
      },
      status: {
      ...
      visibility: { visible: "Видимые", hidden: "Скрытые" },
      activity: {
        anyTime: "За всё время",
        today: "Сегодня",
        pastSevenDays: "За 7 дней",
      ...
      workspaceTitle: { title: "Название", branchName: "Название ветки" },
      selection: {
        all: "Все",
        oneSelected: "Выбран 1",
        selectedCount: "Выбрано: {{count}}",
      ...
      updateHost: "{{label}} · Обновите хост",
      actions: {
        newProjectGroup: "Новая группа проектов…",
        newWorkspaceLabel: "Новая метка рабочего пространства…",
        newWorkspaceLabelSelectHost: "Новая метка рабочего пространства… · Выберите один хост",
        clearFilters: "Очистить фильтры",
        create: "Создать",
      },
      project: {
        ...
        moveToProjectGroup: "Переместить в группу проектов",
        noProjectGroup: "Без группы",
      },
      projectGroup: {
        modalTitle: "Новая группа проектов",
        placeholder: "Название группы",
        renameTitle: "Переименовать группу проектов",
        delete: "Удалить группу проектов",
        deleteMessage: "Удалить «{{name}}»? Проекты в ней не будут удалены.",
        actionsAccessibility: "Действия с группой проектов {{name}}",
      },
      hiddenProjects: {
        title: "Скрытые проекты",
        unhideAll: "Показать все",
        empty: "Нет скрытых проектов",
        description:
          "Скрытые проекты и рабочие пространства не отображаются на боковой панели, пока вы не покажете их.",
        showVisible: "Показать видимые элементы",
      },
      sections: {
        hidden: "Скрытые",
      ...
      workspaceLabel: {
        modalTitle: "Новая метка рабочего пространства",
        placeholder: "Название метки",
        none: "Без метки",
        unknown: "Неизвестная метка",
        renameTitle: "Переименовать метку рабочего пространства",
        delete: "Удалить метку рабочего пространства",
        deleteMessage: "Удалить «{{name}}»? Рабочие пространства не будут удалены.",
        accessibility: "Метка рабочего пространства: {{label}}",
        actionsAccessibility: "Действия с меткой рабочего пространства «{{name}}»",
      },
      errors: {
        selectOneHost: "Выберите один хост перед созданием метки рабочего пространства",
        moveFailed: "Не удалось переместить рабочее пространство",
        createdMoveFailed: "Метка создана, но рабочее пространство не было перемещено",
        createdMoveFailedWithError:
          "Метка создана, но рабочее пространство не было перемещено: {{error}}",
        createFailed: "Не удалось создать метку рабочего пространства",
        hostDisconnected: "Хост не подключён",
        deleteWorkspaceLabelFailed: "Не удалось удалить метку рабочего пространства",
      },
    },
    host: {
      noHost: "Нет хоста",
