...
export const ru: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      addIssueOrPr: "Добавить задачу или PR",
  ...
  workspace: {
    ...
    tabs: {
      ...
      switcher: {
        ...
        searchPlaceholder: "Поиск по вкладкам",
      },
      menu: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        openAt: "Открыть {{scriptName}} на {{label}}",
        viewTerminal: "Просмотреть терминал {{scriptName}}",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        registrationFailed:
          "Встроенный демон запущен, но Paseo не удалось сохранить подключение к localhost. Отключите и снова включите управление демоном, либо добавьте localhost вручную.",
        pausedStopFailed:
      ...
      keepRunning: {
        ...
        hint: "Демон продолжает работать, когда вы выходите из Paseo",
      },
      logs: {
        title: "Файл журнала",
  ...
  settings: {
    ...
    general: {
      ...
      serviceUrls: {
        ...
        description: "Где открывать URL из запущенных скриптов",
        options: {
          ask: "Спрашивать",
          inApp: "В Paseo",
      ...
      terminalScrollback: {
        label: "Прокрутка терминала",
        description: "Количество строк, хранящихся во встроенном буфере терминала.",
        accessibilityLabel: "Строки прокрутки терминала",
      },
      language: {
        label: "Язык",
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        argsHint: "Аргументы, разделённые пробелами, передаваемые команде",
        saving: "Сохранение...",
        remove: "Удалить",
        ...
        save: "Сохранить",
        emptyState:
          "Профилей пока нет. Добавьте один, чтобы запускать терминалы с определённой командой.",
      },
      daemon: {
        rename: {
        ...
        restart: {
          ...
          confirmMessage:
            "Это перезапустит демон. Агенты, работающие на нём, продолжат работу; приложение автоматически повторно подключится.",
          restarting: "Перезапуск...",
          unableToReconnectTitle: "Невозможно повторно подключиться",
          unableToReconnectMessage:
            "{{name}} не вернулся в сеть. Пожалуйста, убедитесь, что он перезапущен.",
          unavailableTitle: "Хост недоступен",
          unavailableMessage:
            "Этот хост не подключен. Подождите, пока он подключится к сети, прежде чем перезапускать.",
          offlineTitle: "Хост не в сети",
          offlineMessage:
            "Этот хост не в сети. Paseo автоматически повторно подключается — подождите, пока он снова подключится к сети, прежде чем перезапускать.",
        ...
        update: {
          ...
          confirmMessage:
            "Это обновит демон до последней версии и перезапустит его. Запущенные агенты будут кратковременно прерваны.",
          updating: "Обновление...",
          ...
          unableToReconnectTitle: "Невозможно повторно подключиться",
          unableToReconnectMessage:
            "{{name}} не вернулся в сеть после обновления. Пожалуйста, убедитесь, что демон перезапущен.",
          unavailableTitle: "Хост недоступен",
          unavailableMessage:
            "Этот хост не подключен. Подождите, пока он подключится к сети, прежде чем обновлять.",
          offlineTitle: "Хост не в сети",
          offlineMessage:
            "Этот хост не в сети. Подождите, пока он снова подключится к сети, прежде чем обновлять.",
          requestFailedTitle: "Ошибка обновления",
          requestFailedMessage: "Не удалось обновить демон: {{error}}",
          dialogFailedMessage: "Невозможно открыть диалоговое окно подтверждения обновления.",
        },
        ...
        remove: {
          ...
          confirmMessage: "Удалить {{name}}? Это приведёт к удалению сохранённых подключений.",
          localConfirmMessage:
            "Это приведёт к удалению подключения к localhost, отключению управления встроенным демоном и остановке управляемого демона. Удалённые хосты остаются подключёнными.",
          errorTitle: "Ошибка",
          errorMessage: "Невозможно удалить хост",
          localErrorMessage: "Невозможно удалить подключение к localhost",
        },
      },
    },
    providers: {
    ...
    project: {
      ...
      worktree: {
        ...
        teardown: "Снос",
        teardownAccessibility: "Команды сноса рабочего дерева",
      },
      scripts: {
        title: "Скрипты",
      ...
      metadata: {
        ...
        commitMessagePlaceholder: "Используйте обычные коммиты с областью действия",
        pullRequest: "Запросы на слияние",
        pullRequestPlaceholder:
          "Начните с краткого резюме в один абзац, включая раздел «План тестирования».",
      },
      writeFailures: {
        staleTitle: "Конфигурация изменена на диске",
        staleDescription:
          "Перед сохранением перезагрузите, чтобы получить последнюю версию файла paseo.json.",
