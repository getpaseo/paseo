  ...
  settings: {
    ...
    project: {
      ...
      scripts: {
        ...
        urlAccessibility: "URL ссылки",
        nameRequired: "Укажите название",
        commandRequired: "Требуется команда",
        urlRequired: "Требуется URL",
        urlInvalid: "Введите URL-адрес HTTP или HTTPS",
        ...
        openUrl: "Открыть URL",
        openUrlHint:
          "Открывается в браузере клиента. Используйте {workspacePath} для пути к рабочему дереву или папке.",
        openUrlUpdateHost: "Обновите этот хост Paseo, чтобы добавить ссылки для браузера.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалить",
