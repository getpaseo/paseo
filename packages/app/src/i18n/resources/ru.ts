...
export const ru: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      imageDiff: {
        loading: "Загрузка сравнения изображений",
        old: "До",
        new: "После",
        xray: "Подсветка отличий",
        openImagePreview: "Открыть предпросмотр изображения «{{title}}»",
        heightDefault: "Обычная",
        heightLarge: "Большая",
        noPreviousImage: "Предыдущего изображения нет",
        imageDeleted: "Изображение удалено",
        tooLarge: "Изображение слишком большое для предпросмотра",
        unsupported: "Предпросмотр изображения недоступен",
        readError: "Не удалось загрузить изображение",
        invalid: "Недопустимые данные изображения",
        updateHost: "Обновите хост для предпросмотра различий изображений",
      },
      openInEditor: {
        open: "Открыть",
