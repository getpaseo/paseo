  ...
  sidebar: {
    ...
    project: {
      ...
      group: {
        ...
        ungroup: "Разгруппировать проекты",
        ungrouping: "Разгруппировка...",
        headerMenu: "Действия группы",
        updateHost: "Обновите хост, чтобы использовать группы",
        hostDisconnected: "Хост не подключён",
        failed: "Не удалось обновить группу",
      },
      confirmations: {
