...
export const ru: TranslationResources = {
  ...
  agentList: {
    ...
    deleteSheet: {
      ...
      confirmMessage:
        "Это навсегда удалит сеанс и его историю с диска. Это действие нельзя отменить.",
      delete: "Удалить навсегда",
      voiceStopFailedTitle: "Не удалось остановить голосовой режим",
      voiceStopFailedMessage:
        "Не удалось освободить захват микрофона. Сеанс не удалён — повторите попытку после остановки голосового режима.",
    },
  },
  message: {
    diagram: {
