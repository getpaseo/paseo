  ...
  workspace: {
    ...
    git: {
      ...
      pr: {
        ...
        reviewComments: {
          title: "Комментарии ревью",
          loading: "Загрузка комментариев ревью…",
          empty: "Нет нерешённых комментариев ревью.",
          hostUpdateRequired: "Обновите хост, чтобы использовать комментарии ревью PR.",
          fixWithAgent: "Исправить {{count}} комментарий с агентом",
          fixWithAgentPlural: "Исправить {{count}} комментариев с агентом",
          replies: "{{count}} ответ",
          repliesPlural: "{{count}} ответов",
          noActiveAgent:
            "Откройте агента в этом рабочем пространстве, чтобы исправить комментарии ревью.",
          errors: {
            missingCli:
              "Для получения комментариев ревью PR требуется GitHub CLI. Установите gh на хосте и повторите попытку.",
            authRequired:
              "GitHub CLI не аутентифицирован. Выполните gh auth login на хосте и повторите попытку.",
            forbidden:
              "GitHub CLI не может получить доступ к этому PR. Проверьте права доступа к репозиторию.",
            notFound: "Не удалось загрузить комментарии ревью PR для этого рабочего пространства.",
            unknown: "Не удалось загрузить комментарии ревью PR для этого рабочего пространства.",
          },
        },
      },
    },
