  ...
  settings: {
    ...
    appearance: {
      ...
      fonts: {
        ...
        codeFont: "Шрифт кода",
        codeFontHint:
          "Используется в коде и различиях. Оставьте пустым для системного значения по умолчанию.",
      ...
      terminal: {
        title: "Терминал",
        font: "Шрифт терминала",
        fontHint:
          "Должен быть моноширинный шрифт. Оставьте пустым для набора по умолчанию с глифами Nerd Font для приглашений",
        fontAccessibility: "Семейство шрифтов терминала",
        size: "Размер терминала",
        sizeAccessibility: "Размер шрифта терминала",
        sizeInherit: "Авто",
        lineHeight: "Межстрочный интервал",
        lineHeightAccessibility: "Межстрочный интервал терминала",
        boldText: "Жирный текст",
        boldTextHint:
          "При выключении жирный вывод отображается обычной насыщенностью. Цвета не меняются",
      },
      syntax: {
        title: "Синтаксис",
