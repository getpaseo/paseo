...
export const ru: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        commits: {
          openHistory: "Открыть вкладку «История»",
          title: "Коммиты",
  ...
  panels: {
    ...
    commitLog: {
      label: "История",
      subtitle: "История коммитов",
      tooltip: "Просмотр истории коммитов",
      directoryMissing: "Каталог рабочего пространства не найден.",
      capabilityMissing: "Обновите хост, чтобы просматривать историю коммитов.",
      connecting: "Подключение к хосту…",
      ...
      refresh: "Обновить",
      refreshing: "Обновление",
      truncatedRefs: "Показаны только недавно обновлённые ветки и теги",
      cursorExpired: "История изменилась во время загрузки. Загружено заново с начала.",
      scope: {
        head: "Текущая ветка",
        all: "Все ветки",
      },
