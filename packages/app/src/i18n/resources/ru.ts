    ...
    host: {
      ...
      orchestration: {
        ...
        agentTemplates: {
          ...
          hint: "Define reusable roles that every agent can discover and use when creating subagents.",
          empty: "No agent templates configured.",
          add: "Add template",
          addTitle: "Add agent template",
          editTitle: "Edit {{name}}",
          id: "Template ID",
          name: "Name",
          description: "Description",
          provider: "Provider and model",
          providerHint: "Optional. Leave empty to make the template available across providers.",
          instructions: "Role instructions",
          save: "Save",
          edit: "Edit",
          remove: "Remove",
          removeTitle: "Remove agent template?",
          removeMessage: "Remove '{{id}}' from every agent on this host?",
          enableAccessibility: "Enable {{name}}",
          duplicateId: "An agent template named '{{id}}' already exists.",
          invalidId: "Use letters, numbers, dots, underscores, or hyphens for the template ID.",
          requiredFields: "Name, description, and role instructions are required.",
          invalidProvider: "Use provider/model format, for example codex/gpt-5.4.",
        },
        managedMcp: {
          title: "Внешние серверы MCP",
          hint: "Добавлять общие серверы каждому совместимому агенту, запущенному этим хостом.",
          empty: "Внешние серверы MCP не настроены.",
          ...
          url: "URL",
          arguments: "Аргументы",
          argumentsHint: "Введите по одному аргументу в строке.",
          alwaysLoad: "Всегда загружать инструменты",
          alwaysLoadHint: "Сохранять все инструменты этого сервера в подсказке агента.",
          alwaysLoadAccessibility: "Всегда загружать инструменты MCP",
          environmentVariables: "Переменные окружения",
          requestHeaders: "Заголовки запроса",
          secretHint: "Используйте прямое секретное значение или ссылку на окружение демона.",
          add: "Добавить",
          directValue: "Прямое значение",
          environmentSource: "Окружение",
          variable: "Переменная",
          header: "Заголовок",
          environmentVariableName: "Имя переменной окружения",
          value: "Значение",
          keepValueHint: "Оставьте поле пустым, чтобы сохранить настроенное значение.",
          save: "Сохранить",
          test: "Проверить",
          edit: "Изменить",
          remove: "Удалить",
          enable: "Включить {{name}}",
          connected: "Подключено за {{latencyMs}} мс · инструментов: {{toolCount}}",
          rejected: "Сервер MCP отклонил подключение.",
          duplicateName: "Сервер MCP с именем '{{name}}' уже существует.",
          updateFailed: "Не удалось обновить сервер MCP.",
          removeTitle: "Удалить сервер MCP?",
          removeMessage: "Удалить '{{name}}' из каждого агента, запускаемого этим хостом?",
          removeFailed: "Не удалось удалить сервер MCP.",
          testFailed: "Не удалось проверить сервер MCP.",
          saveFailed: "Не удалось сохранить сервер MCP.",
          entryNameRequired: "Каждой записи заголовка или окружения требуется имя.",
          envNameRequired: "Ссылке на окружение требуется имя переменной.",
          directValueRequired: "Прямое значение не может быть пустым.",
          uniqueEntries: "Имена записей заголовков и окружения должны быть уникальными.",
          nameRequired: "Требуется имя сервера.",
          commandRequired: "Требуется команда.",
          urlRequired: "Требуется URL.",
          invalidUrl: "Введите допустимый URL сервера MCP.",
          httpOnly: "URL серверов MCP должны использовать HTTP или HTTPS.",
        },
        systemPrompt: {
