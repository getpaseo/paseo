  ...
  workspace: {
    ...
    tabs: {
      ...
      confirmations: {
        ...
        bulk: {
          all: "Будут закрыты {{agents}} вкладка(и) агента, {{terminals}} терминал(а/ов) и {{tabs}} вкладка(и). Любой запущенный процесс в закрытом терминале будет немедленно остановлен.",
          agentsAndTerminals:
            "Будут закрыты {{agents}} вкладка(и) агента и {{terminals}} терминал(а/ов). Любой запущенный процесс в закрытом терминале будет немедленно остановлен.",
          terminalsAndTabs:
            "Это закроет терминал(ы) {{terminals}} и вкладки {{tabs}}. Любой запущенный процесс в закрытом терминале будет немедленно остановлен.",
          agentsAndTabs: "Будут закрыты {{agents}} вкладка(и) агента и {{tabs}} вкладка(и).",
          terminals:
          ...
          agents: "Будут закрыты {{agents}} вкладка(и) агента.",
        },
      },
    },
    header: {
