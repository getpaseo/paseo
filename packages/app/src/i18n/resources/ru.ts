...
export const ru: TranslationResources = {
  ...
  contextWindow: {
    ...
    promptCache: {
      title: "Кэш промптов",
      statusWarm: "Активен",
      statusExpiring: "Скоро истечёт",
      statusExpired: "Вероятно, истёк",
      statusUnknown: "Срок неизвестен",
      warmFor: "активен ещё ~{{duration}}",
      expiredAgo: "истёк {{duration}} назад",
      lastRequestAgo: "последний запрос {{duration}} назад",
      durationSeconds: "{{value}} сек",
      durationMinutes: "{{value}} мин",
      lastRequest: "Последний запрос {{percent}}% из кэша · {{split}}",
      split: "{{cached}} из кэша, {{fresh}} новых",
      splitWithWrite: "{{cached}} из кэша, {{fresh}} новых, {{written}} записано",
      sessionSingular: "Сеанс {{percent}}% из кэша за {{count}} запрос",
      sessionPlural: "Сеанс {{percent}}% из кэша за {{count}} запросов",
      ping: "Прогреть",
      pinging: "Прогрев...",
      pingHint: "Отправляет короткое сообщение, чтобы кэш оставался тёплым",
      pingError: "Не удалось отправить сообщение",
    },
  },
  review: {
    comment: {
