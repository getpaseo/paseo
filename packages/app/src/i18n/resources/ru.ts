...
export const ru: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        ...
        placeholder: "Опишите свои изменения",
        generate: "Создать",
        generating: "Создание...",
        generationFailed: "Не удалось создать сообщение коммита.",
        generationUnsupported: "Обновите хост для создания сообщений коммитов.",
        selectAll: "Выбрать все изменения",
        selectedCount: "Выбрано {{count}} из {{total}}",
        selectAtLeastOne: "Выберите хотя бы один файл для коммита.",
        includeFile: "Включить {{path}} в коммит",
        discardFile: "Отменить изменения в {{path}}",
        commitFailed: "Не удалось закоммитить изменения.",
      },
      sourceControl: {
        staged: "Подготовленные изменения",
        unstaged: "Изменения",
        stage: "Подготовить",
        unstage: "Убрать из подготовленных",
        stageAll: "Подготовить все",
        unstageAll: "Убрать все из подготовленных",
        stageFile: "Подготовить {{path}}",
        unstageFile: "Убрать {{path}} из подготовленных",
        stageBeforeCommit: "Подготовьте файлы перед коммитом.",
        indexUpdateFailed: "Не удалось обновить подготовленные изменения.",
        resizeSections: "Изменить размер разделов подготовленных и неподготовленных изменений",
      },
      diff: {
  ...
  workspaceLabels: {
    ...
    manage: {
      ...
      deleteMessage_one: "Метка будет удалена из {{count}} рабочего пространства на этом хосте.",
      deleteMessage_other: "Метка будет удалена из {{count}} рабочих пространств на этом хосте.",
