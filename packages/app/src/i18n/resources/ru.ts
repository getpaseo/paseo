...
export const ru: TranslationResources = {
  ...
  plugins: {
    ...
    conflictsTitle: "Расширения, заявленные несколькими плагинами",
    conflictLine: "{{extension}}: побеждает {{winner}}, {{losers}} игнорируется",
    views: {
    ...
    errors: {
      ...
      entryMissing: "Отсутствует входной файл плагина.",
      previewFailed: "{{plugin}} не смог отобразить этот файл: {{reason}}",
      panelFailed: "{{plugin}} не смог отобразить эту панель: {{reason}}",
    },
  },
  settings: {
    title: "Настройки",
