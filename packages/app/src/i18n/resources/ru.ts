...
export const ru: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      removeFile: "Удалить вложение файла",
  ...
  message: {
    ...
    turnFooter: {
      ...
      endedAt: "{{duration}}, завершено {{time}}",
    },
  },
  toolCall: {
    displayNames: {
      ...
      search: "Поиск",
      fetch: "Загрузить",
      worktreeSetup: "Настройка worktree",
      task: "Задача",
  ...
  workspace: {
    route: {
      ...
      browserTabTitle: "Рабочее пространство",
      connecting: "Подключение",
  ...
  sidebar: {
    ...
    workspace: {
      sectionTitle: "Рабочие пространства",
      ...
      toasts: {
        ...
        markReadFailed: "Не удалось отметить рабочее пространство как прочитанное",
  ...
  newWorkspace: {
    ...
    projectPicker: {
      ...
      accessibilityLabel: "Проект рабочего пространства",
    },
    hostPicker: {
      title: "Хост",
      fallbackLabel: "Хост",
    ...
    isolation: {
      ...
      label: "Изоляция",
      accessibilityLabel: "Изоляция рабочего пространства",
    },
    fields: {
      project: "Проект",
      base: "База",
    ...
    errors: {
      chooseProject: "Выберите проект",
      chooseHostForProject: "Выберите хост для этого проекта",
      hostDisconnected: "Host не подключен",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        registrationFailed:
          "Встроенный daemon запущен, но Paseo не смог сохранить подключение localhost. Выключите и снова включите управление daemon или добавьте localhost вручную.",
        pausedStopFailed:
    ...
    updates: {
      status: {
        ...
        upToDateWithLastChecked: "Актуально. Последняя проверка: {{time}}.",
  ...
  settings: {
    ...
    diagnostics: {
      ...
      notification: {
        rowTitle: "Уведомления",
        rowHint: "Проверить разрешение и отправить тестовое уведомление",
        sendTest: "Отправить тест",
        sending: "Отправка...",
        sent: "Тестовое уведомление отправлено.",
        notDelivered:
          "Уведомление не доставлено. Проверьте настройки уведомлений браузера или системы.",
        failed: "Не удалось отправить уведомление.",
      },
      app: {
        ...
        rowHint:
          "Собрать сведения о подключении, daemon, провайдере, рабочем столе, уведомлениях и журналах",
        run: "Запустить",
    ...
    host: {
      ...
      workspaces: {
        ...
        autoArchiveAfterMerge: {
          title: "Архивировать рабочие пространства с объединённым PR",
          hint: "Автоматически архивировать чистые рабочие пространства Paseo после слияния их pull request",
          accessibilityLabel: "Архивировать рабочие пространства с объединённым PR",
          updateFailedTitle: "Не удалось обновить настройки рабочих пространств",
        },
      },
      browserTools: {
        title: "Инструменты браузера",
        hint: "Разрешить агентам получать доступ и управлять вкладками браузера Paseo, включая состояние входа. Включайте только для агентов, которым доверяете.",
      ...
      terminalAgents: {
        ...
        enableHooks: {
          ...
          hint: "Получайте уведомления и статус от терминальных агентов. Это устанавливает hooks в файлы конфигурации агента.",
          accessibilityLabel: "Включить hooks терминальных агентов",
          updateFailedTitle: "Не удалось обновить hooks терминальных агентов",
        },
      },
      terminalProfiles: {
        ...
        argsHint: "Аргументы команды через пробел",
        saving: "Сохранение...",
        remove: "Удалить",
        ...
        save: "Сохранить",
        emptyState:
          "Профилей пока нет. Добавьте один, чтобы запускать терминалы с нужной командой.",
      },
      daemon: {
        rename: {
        ...
        update: {
          ...
          hint: "Обновить daemon до последней версии и перезапустить его",
          confirm: "Обновить",
          confirmTitle: "Обновить {{name}}",
          confirmMessage:
            "Это обновит daemon до последней версии и перезапустит его. Запущенные агенты будут кратко прерваны.",
          updating: "Обновление...",
          ...
          unableToReconnectMessage:
            "{{name}} не вернулся онлайн после обновления. Проверьте, что daemon перезапустился.",
          unavailableTitle: "Хост недоступен",
          unavailableMessage:
            "Этот хост не подключён. Дождитесь, пока он будет онлайн, прежде чем обновлять.",
          offlineTitle: "Хост офлайн",
          offlineMessage:
            "Этот хост офлайн. Дождитесь, пока он снова будет онлайн, прежде чем обновлять.",
          requestFailedTitle: "Обновление не удалось",
        ...
        remove: {
          ...
          localHint: "Удаляет localhost с этого устройства и останавливает встроенный daemon",
          ...
          localConfirmMessage:
            "Это удалит подключение localhost, отключит управление встроенным daemon и остановит управляемый daemon. Удалённые хосты останутся подключёнными.",
          errorTitle: "Ошибка",
    ...
    providers: {
      ...
      remove: {
        ...
        confirmMessage: "Это удалит запись провайдера из config.json. Действие нельзя отменить.",
        confirm: "Удалить",
  ...
  providerUsage: {
    ...
    hostUnavailable: "Подключитесь к этому хосту, чтобы видеть использование провайдера",
    hostUpgradeRequired: "Обновите хост, чтобы видеть использование провайдера",
    ...
    errors: {
      grokNetwork:
        "Не удалось связаться с API биллинга Grok. Проверьте доступность cli-chat-proxy.grok.com (прокси/VPN часто блокируют его).",
    },
  },
  addProjectFlow: {
    titles: {
      ...
      addProject: "Добавить проект",
      searchDirectory: "Найти каталог",
      cloneGithub: "Клонировать с GitHub",
      chooseDestination: "Выберите назначение",
      chooseParent: "Выберите родительский каталог",
      nameDirectory: "Имя каталога",
    },
    placeholders: {
      searchHosts: "Поиск хостов...",
      searchMethods: "Поиск способов...",
      searchDirectories: "Ищите каталоги или введите путь...",
      searchGithub: "Ищите или введите репозиторий GitHub...",
      searchParents: "Ищите родительские каталоги или введите путь...",
      directoryName: "Имя каталога",
    },
    methods: {
      searchDirectory: "Найти каталог",
      searchDirectoryDescription: "Найти каталог на {{host}}",
      browse: "Обзор",
      browseDescription: "Выберите или создайте каталог в Finder",
      github: "Клонировать с GitHub",
      githubDescriptionSearch: "Ищите проекты, доступные вашему аккаунту GitHub",
      githubDescriptionManual: "Введите URL GitHub или owner/repo",
      githubDescriptionUpgrade: "Обновите этот хост, чтобы клонировать репозитории GitHub",
      newDirectory: "Новый каталог",
      newDirectoryDescription: "Создать пустой каталог на {{host}}",
      newDirectoryDescriptionUpgrade: "Обновите этот хост, чтобы создавать каталоги",
    },
    empty: {
      noHosts: "Нет подключённых хостов",
      noMatching: "Нет подходящих вариантов",
      enterGithub: "Введите URL GitHub или owner/repo",
      updateHost: "Обновите хост, чтобы использовать «Добавить проект».",
    },
    hints: {
      navigate: "Навигация",
      select: "Выбрать",
    ...
    progress: {
      ...
      creating: "Создание каталога...",
      loading: "Загрузка...",
    },
    rows: {
      addHost: "Добавить хост",
      openThisPath: "Открыть этот путь",
      useThisParent: "Использовать этот родительский каталог",
      existingProject: "Существующий проект · {{path}}",
      alreadyExists: "Уже существует",
      parentDirectory: "Родительский каталог: {{path}}",
      cloneRepositoryUrl: "Клонировать по этому URL репозитория",
      cloneViaProtocol: "Клонировать owner/repo через {{protocol}}",
      viaProtocol: "{{name}} через {{protocol}}",
    },
    errors: {
      hostUnavailable: "Хост недоступен",
      directoryNotFound: "Каталог не найден",
      unableToAdd: "Не удалось добавить проект",
      unableToBrowse: "Не удалось открыть выбор каталога",
      unableToClone: "Не удалось клонировать репозиторий",
      unableToCreateDirectory: "Не удалось создать каталог",
      enterDirectoryName: "Введите имя каталога",
      unableToSearchDirectories: "Не удалось искать каталоги",
      unableToSearchGithub: "Не удалось искать репозитории GitHub",
      githubUnavailable: "Поиск GitHub недоступен",
    },
    accessibility: {
      back: "Назад",
      page: "Добавить проект: {{kind}}",
    },
  },
  schedules: {
    screen: {
    ...
    actions: {
      ...
      tryAgain: "Повторить",
      seeDocs: "Документация",
    },
    empty: {
      noActive: "Нет активных расписаний",
      description: "Расписания запускают агентов по заданному ритму.",
      noEnded: "Нет завершённых расписаний",
    },
    errors: {
      unableToLoad: "Не удалось загрузить расписания",
      hostLoadFailed: "{{serverName}}: не удалось загрузить расписания",
    },
    row: {
      ...
      menu: {
        actions: "Действия {{productName}}",
        edit: "Изменить {{productName}}",
        editRow: "Изменить {{productName}} {{title}}",
        ...
        starting: "Запуск...",
        delete: "Удалить {{productName}}",
        deleting: "Удаление...",
      },
    },
    delete: {
      title: "Удалить {{productName}}",
      message: "Удалить «{{title}}»? Это действие нельзя отменить.",
      confirm: "Удалить",
    },
    form: {
      titleCreate: "Новое расписание",
      titleEdit: "Изменить расписание",
      titleEditHeartbeat: "Изменить heartbeat",
      cancel: "Отмена",
      ...
      fields: {
        ...
        nameAccessibility: "Имя расписания",
        prompt: "Промпт",
        promptPlaceholder: "Что должен делать агент при каждом запуске?",
        maxRuns: "Макс. запусков",
        maxRunsPlaceholder: "Без ограничений",
        maxRunsAccessibility: "Макс. запусков",
        host: "Хост",
        hostPlaceholder: "Выберите хост",
        hostEmpty: "Хосты не найдены",
        project: "Проект",
        projectPlaceholder: "Выберите проект",
        projectEmpty: "Проекты не найдены",
        projectHint: "Сначала выберите хост.",
        projectSearch: "Поиск проектов...",
        projectTitle: "Выберите проект",
        model: "Модель",
        thinking: "Размышление",
        thinkingPlaceholder: "Выберите размышление",
        thinkingEmpty: "Варианты размышления не найдены",
        thinkingTitle: "Выберите размышление",
        mode: "Режим",
        modePlaceholder: "Режим по умолчанию",
        modeEmpty: "Режимы не найдены",
        modeHint: "Для этой модели нет доступных режимов.",
        modeTitle: "Выберите режим",
        archiveOnFinish: "Архивировать по завершении",
        isolation: "Изоляция",
        isolationPlaceholder: "Выберите изоляцию",
        isolationEmpty: "Варианты изоляции не найдены",
        isolationLocal: "Локально",
    ...
    cadence: {
      fieldLabel: "Ритм",
      placeholder: "Выберите ритм",
      empty: "Ритмы не найдены",
      cronAccessibility: "Cron-выражение",
      presets: {
        everyMinute: "Каждую минуту",
        everyHour: "Каждый час",
        daily9: "Ежедневно в 9:00",
    ...
    format: {
      untitled: "{{productName}} без названия",
      everyMinute: "Каждую минуту",
      everyHour: "Каждый час",
      everyHourAt: "Каждый час в :{{minutes}}",
      everyInterval: "Каждые {{count}} {{unit}}",
      unitMinute: "минуту",
      unitMinutes: "мин",
      unitHour: "час",
      unitHours: "ч",
      ...
      weekends: "Выходные",
      dayPlural: "{{day}}",
      atTime: "{{when}} в {{time}} {{timezone}}",
      soon: "скоро",
      inMinutes: "через {{count}} мин",
      inHours: "через {{count}} ч",
      inDays: "через {{count}} дн.",
      enterCron: "Введите cron-выражение",
      invalidCron: "Недействительно: {{detail}}",
      days: {
        sunday: "Воскресенье",
        monday: "Понедельник",
        tuesday: "Вторник",
