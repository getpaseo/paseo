...
export const ru: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      imagePreviewHint: "Нажмите, чтобы открыть. Удерживайте, чтобы сохранить.",
      imageSaving: "Сохранение изображения…",
      imageSaved: "Сохранено в Фото",
      imageSavePermissionDenied: "Разрешите доступ к Фото, чтобы сохранить изображение.",
