...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      agentEnvironment: {
        sectionTitle: "Окружение агента",
        sectionDescription:
          "Команды выполняются в каталоге агента перед его запуском. Их вывод становится окружением агента.",
        add: "Добавить настройку окружения",
        addCustom: "Своя команда…",
        addCustomTitle: "Добавить команду окружения",
        editCommand: "Изменить команду",
        editCommandTitle: "Изменить команду окружения",
        remove: "Удалить",
        removeConfirmTitle: "Удалить настройку окружения?",
        removeConfirmMessage: "Удалить «{{name}}»?",
        moveUp: "Переместить вверх",
        moveDown: "Переместить вниз",
        emptyState:
          "Перед запуском агента ничего не выполняется. Добавьте direnv или свою команду.",
        unknownPreset: "Этот хост не знает этот пресет",
        rowFormat: "Читает вывод {{format}}",
        commandLabel: "Команда",
        commandHint: "Через пробел. Запускайте оболочку явно, если она нужна.",
        commandPlaceholder: "direnv export json",
        commandRequired: "Команда обязательна",
        formatLabel: "Формат вывода",
        formatJson: "JSON-разница",
        formatEnv0: "env -0",
        formatJsonHint: 'Объект вида "КЛЮЧ": "значение", где null удаляет переменную.',
        formatEnv0Hint: "Записи КЛЮЧ=ЗНАЧЕНИЕ, разделённые NUL. Всё пропущенное удаляется.",
        timeoutLabel: "Тайм-аут",
        timeoutHint:
          "Миллисекунды до отказа от команды. Оставьте пустым для значения хоста по умолчанию.",
        timeoutPlaceholder: "30000",
        timeoutInvalid: "Тайм-аут должен быть положительным целым числом",
        saving: "Сохранение...",
        save: "Сохранить",
      },
      terminalProfiles: {
