  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        decreaseThinking: "Уменьшить интенсивность рассуждений",
        increaseThinking: "Увеличить интенсивность рассуждений",
        previousFavoriteModel: "Предыдущая избранная модель",
        nextFavoriteModel: "Следующая избранная модель",
