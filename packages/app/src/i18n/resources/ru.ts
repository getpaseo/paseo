...
export const ru: TranslationResources = {
  ...
  composer: {
    ...
    stash: {
      stashed: "Промпт отложен",
      stashedEvicted: "Промпт отложен — самый старый удалён, чтобы освободить место",
      restored: "Отложенный промпт восстановлен",
      undo: "Отменить",
      badgeAccessibilityLabel: "Отложенные промпты: {{count}}. Открыть список.",
      menuTitle: "Отложенные промпты",
      menuEmpty: "Пока ничего не отложено",
      attachmentsOnly_one: "{{count}} вложение",
      attachmentsOnly_other: "{{count}} вложений",
      deleteEntry: "Удалить отложенный промпт",
      otherProviders_one: "{{count}} промпт отложен для другого провайдера",
      otherProviders_other: "{{count}} промптов отложено для других провайдеров",
    },
    errors: {
