...
export const ru: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        discardFile: "Отменить изменения файла",
        discardFileTitle: "Отменить изменения файла?",
        discardFileMessage: "Это навсегда удалит незафиксированные изменения в {{path}}.",
        discardFileConfirm: "Отменить",
        fileActionFailed: "Не удалось обновить изменения файла.",
        fileActionUnavailable: "Действия с изменениями файла недоступны.",
  ...
  newWorkspace: {
    ...
    newBranch: {
      accessibilityLabel: "Название новой ветки",
      placeholder: "Новая ветка",
      invalid: "Введите допустимое название ветки.",
    },
  },
  desktop: {
    quitting: {
