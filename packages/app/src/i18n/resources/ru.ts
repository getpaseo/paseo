  ...
  settings: {
    ...
    project: {
      ...
      agentEnv: {
        ...
        info: "Окружение агента и MCP-серверов, которые он запускает. Задайте переменные напрямую или выполните команду, печатающую их",
        accessibility: "Команда окружения агента",
        empty: "Окружение не настроено. Агент запустится с окружением демона.",
        orderHint: "Применяются по порядку. Побеждают последние записи.",
        staticTitle: "Переменные",
        commandTitle: "Команда",
        varKeyAccessibility: "Имя переменной",
        varValueAccessibility: "Значение переменной",
        varValuePlaceholder: "значение",
        unsupported:
          "agentEnv этого проекта нельзя показать здесь. Отредактируйте его в paseo.json — сохранение его не изменит.",
        removeTitle: "Удалить запись?",
        removeMessage: "Агент больше не получит это окружение.",
        actions: {
        ...
        docsTooltip:
          "Подробности и доступные для этой команды переменные окружения см. в документации",
      },
      scripts: {
        title: "Скрипты",
