  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        autoInstall: {
          title: "Автоматически устанавливать обновления",
          hint: "Если выключено, Paseo продолжает проверять обновления в фоновом режиме, но никогда не скачивает и не устанавливает их, пока вы не выберете «Обновить».",
        },
