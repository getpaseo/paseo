...
export const ru: TranslationResources = {
  ...
  sessions: {
    ...
    errors: {
      load: "Не удалось загрузить сеансы",
    },
  },
  agentList: {
  ...
  message: {
    ...
    turnTime: {
      ...
      ended: "ended {{time}}",
      units: { second: "s", minute: "m", hour: "h" },
    },
    compaction: {
      loading: "Уплотнение...",
  ...
  sidebar: {
    host: {
      ...
      openSettings: "Open {{hostName}} settings",
  ...
  schedules: {
    ...
    empty: {
      activeTitle: "No active schedules",
      activeDescription: "Schedules run agents on a cadence.",
      endedTitle: "No ended schedules",
    },
    actions: {
      docs: "See docs",
      new: "New schedule",
      ...
      deleting: "Deleting...",
      menu: "Schedule actions",
    },
    errors: {
      load: "Unable to load schedules",
      hostLoad: "{{hostName}}: Could not load schedules",
    },
    form: {
    ...
    cadence: {
      ...
      noOptions: "No cadences found",
      cronExpression: "Cron expression",
      custom: "Custom cron",
      everyMinute: "Every minute",
      everyHour: "Every hour",
      dailyAtNine: "Daily 9:00",
      weekdaysAtNine: "Weekdays 9:00",
      mondaysAtNine: "Mondays 9:00",
    },
    status: {
      active: "Active",
      paused: "Paused",
    ...
    format: {
      ...
      cron: {
        ...
        dailyAt: "Daily at {{time}} {{timezone}}",
        weekdaysAt: "Weekdays at {{time}} {{timezone}}",
        weekendsAt: "Weekends at {{time}} {{timezone}}",
        dayAt: "{{day}} at {{time}} {{timezone}}",
      },
      days: {
        sunday: "Sundays",
        monday: "Mondays",
  ...
  newWorkspace: {
    ...
    projectPicker: {
      ...
      accessibilityLabel: "Проект рабочей области",
      isolationAccessibilityLabel: "Изоляция рабочей области",
    },
    errors: {
      hostDisconnected: "Host не подключен",
      ...
      chooseHostForProject: "Выберите Host для этого проекта",
    },
    refPicker: {
  ...
  settings: {
    ...
    host: {
      ...
      workspaces: {
        ...
        archiveMergedTitle: "Archive merged PR workspaces",
        archiveMergedHint:
      ...
      terminalProfiles: {
        ...
        hooksTitle: "Enable terminal agent hooks",
        hooksHint:
