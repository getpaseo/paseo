...
export const ru: TranslationResources = {
  ...
  heartbeats: {
    header: "Heartbeats",
    headerCount: "Heartbeats ({{count}})",
    statusPaused: "На паузе",
    nextRun: "Следующий {{when}}",
    pauseAction: "Приостановить {{label}}",
    pauseTooltip: "Пауза",
    pauseFailed: "Не удалось приостановить heartbeat",
    resumeAction: "Возобновить {{label}}",
    resumeTooltip: "Возобновить",
    resumeFailed: "Не удалось возобновить heartbeat",
    deleteAction: "Удалить {{label}}",
    deleteTooltip: "Удалить",
    deleteTitle: "Удалить heartbeat",
    deleteMessage: "Удалить «{{label}}»? Это действие нельзя отменить.",
    deleteConfirm: "Удалить",
    deleteFailed: "Не удалось удалить heartbeat",
    providerDetailTitle: "Heartbeat",
    detailPrompt: "Промпт",
    detailMode: "Режим",
    detailSchedule: "Расписание",
    detailNext: "Следующий",
    detailTaskId: "ID задачи",
    noNextHint: "Неизвестно",
    modeRecurring: "Повторяющийся",
    modeOneShot: "Одноразовый",
    modeDynamic: "Динамический",
  },
  backgroundTasks: {
  ...
  settings: {
    ...
    permissions: {
      ...
      attention: {
        ...
        preset: {
          label: "Sound",
          description: "Choose an attention sound. Selecting one plays a preview.",
          accessibilityLabel: "Attention sound, {{value}}",
          soft: "Soft",
          chime: "Chime",
          ping: "Ping",
          glass: "Glass",
    ...
    host: {
      ...
      orchestration: {
        ...
        metadataEndpoint: {
          ...
          enableAccessibilityLabel: "Enable metadata generation endpoint",
    ...
    providers: {
      ...
      models: {
        ...
        contextWindowPlaceholder: "e.g. 500000",
        contextWindowHint: "Tokens. Autofilled from models.dev when available.",
        contextWindowInvalid: "Enter a positive whole number of tokens.",
        ...
        metadataSourceEmpty: "No matching sources",
        metadataSourceCustom: "Custom",
        metadataSourceCustomDescription: "Set every value yourself",
        inputTypes: "Input",
        outputTypes: "Output",
