...
export const ru: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      videoPreviewUnavailable: "Предварительный просмотр видео недоступен.",
      videoPreviewLoadFailed: "Не удалось загрузить предварительный просмотр видео.",
      videoPlaybackUnsupported: "Воспроизведение видео недоступно на этой платформе.",
      review: "Ревью",
