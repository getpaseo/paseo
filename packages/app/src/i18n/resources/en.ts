export const en = {
  ...
  message: {
    ...
    attachments: {
      ...
      imagePreviewHint: "Tap to open. Touch and hold to save.",
      imageSaving: "Saving image...",
      imageSaved: "Saved to Photos",
      imageSavePermissionDenied: "Allow Photos access to save this image.",
      imageSaveFailed: "Couldn't save image",
