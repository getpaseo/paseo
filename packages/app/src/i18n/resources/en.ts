export const en = {
  ...
  workspace: {
    ...
    git: {
      ...
      imageDiff: {
        loading: "Loading image diff",
        old: "Old",
        new: "New",
        xray: "X-ray",
        openImagePreview: "Open {{title}} image preview",
        heightDefault: "Default",
        heightLarge: "Large",
        noPreviousImage: "No previous image",
        imageDeleted: "Image deleted",
        tooLarge: "Image is too large to preview",
        unsupported: "Image preview unavailable",
        readError: "Unable to load image",
        invalid: "Invalid image data",
        updateHost: "Update the host to preview image diffs",
      },
      openInEditor: {
        open: "Open",
