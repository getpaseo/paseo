  ...
  sidebar: {
    ...
    pinned: {
      ...
      groups: {
        ...
        deleting: "Deleting...",
        deleteTitle: "Delete {{name}}?",
        deleteDescription: "This deletes the group and unpins its workspaces.",
        loading: "Loading groups...",
        loadError: "Unable to load pinned groups",
        actionError: "Unable to update pinned groups",
        updateHost: "Update the host to use pinned groups",
        retry: "Try again",
      },
    },
    host: {
