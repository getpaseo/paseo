export const en = {
  ...
  sessions: {
    ...
    organization: {
      trigger: "History filters and sorting",
  ...
  agentList: {
    ...
    actions: {
      menuAccessibility: "Actions for {{title}}",
      fallbackSession: "session",
      sheetTitle: "Session actions",
      updateHostToPin: "Update host to pin sessions",
      pin: "Pin session",
      unpin: "Unpin session",
      pinning: "Pinning...",
      unpinning: "Unpinning...",
      archive: "Archive session",
      updatePinFailed: "Failed to update session pin",
    },
    dateSections: {
      recent: "Recent",
      today: "Today",
  ...
  sidebar: {
    ...
    organization: {
      ...
      actions: {
        ...
        newWorkspaceLabel: "New workspace label…",
        newWorkspaceLabelSelectHost: "New workspace label… · Select one host",
        clearFilters: "Clear filters",
        create: "Create",
      },
      project: {
        ...
        moveToProjectGroup: "Move to project group",
        noProjectGroup: "No group",
      },
      projectGroup: {
        modalTitle: "New project group",
        placeholder: "Group name",
        renameTitle: "Rename project group",
        delete: "Delete project group",
        deleteMessage: 'Delete "{{name}}"? Its projects will not be deleted.',
        actionsAccessibility: "Project group actions for {{name}}",
      },
      hiddenProjects: {
        ...
        description:
          "Hidden projects and workspaces stay out of the sidebar until you unhide them.",
        showVisible: "Show visible items",
      },
      sections: {
        hidden: "Hidden",
      ...
      workspaceLabel: {
        modalTitle: "New workspace label",
        placeholder: "Label name",
        none: "No label",
        unknown: "Unknown label",
        renameTitle: "Rename workspace label",
        delete: "Delete workspace label",
        deleteMessage: 'Delete "{{name}}"? Its workspaces will not be deleted.',
        accessibility: "Workspace label: {{label}}",
        actionsAccessibility: "Workspace label actions for {{name}}",
      },
      errors: {
        selectOneHost: "Select one host before creating a workspace label",
        moveFailed: "Failed to move workspace",
        createdMoveFailed: "Workspace label created, but the workspace was not moved",
        createdMoveFailedWithError:
          "Workspace label created, but the workspace was not moved: {{error}}",
        createFailed: "Failed to create workspace label",
        hostDisconnected: "Host is not connected",
        deleteWorkspaceLabelFailed: "Failed to delete workspace label",
      },
    },
    host: {
      noHost: "No host",
