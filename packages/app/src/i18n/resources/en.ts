export const en = {
  ...
  plugins: {
    ...
    conflictsTitle: "Extensions claimed by more than one plugin",
    conflictLine: "{{extension}}: {{winner}} wins, {{losers}} ignored",
    views: {
      installed: "Installed",
      browse: "Browse",
    },
    ...
    errors: {
      ...
      entryMissing: "The plugin entry file is missing.",
      previewFailed: "{{plugin}} could not render this file: {{reason}}",
      panelFailed: "{{plugin}} could not render this panel: {{reason}}",
    },
  },
  settings: {
    title: "Settings",
