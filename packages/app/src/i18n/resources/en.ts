  ...
  settings: {
    ...
    project: {
      ...
      agentEnv: {
        ...
        info: "The environment for the agent and the MCP servers it spawns. Set variables directly, or run a command that prints them",
        accessibility: "Agent environment command",
        empty: "No environment configured. The agent starts with the daemon's environment.",
        orderHint: "Applied in order. Later entries win.",
        staticTitle: "Variables",
        commandTitle: "Command",
        varKeyAccessibility: "Variable name",
        varValueAccessibility: "Variable value",
        varValuePlaceholder: "value",
        unsupported:
          "This project's agentEnv can't be shown here. Edit it in paseo.json — saving won't change it.",
        removeTitle: "Remove entry?",
        removeMessage: "The agent will no longer get this environment.",
        actions: {
        ...
        docsTooltip: "See docs for details and the environment variables available to this command",
      },
      scripts: {
        title: "Scripts",
