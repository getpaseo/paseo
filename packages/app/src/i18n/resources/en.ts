  ...
  settings: {
    ...
    project: {
      ...
      scripts: {
        ...
        openUrl: "Open a URL",
        openUrlHint:
          "Opens in the client browser. Use {workspacePath} for the worktree or folder path.",
        openUrlUpdateHost: "Update this Paseo host to add browser links.",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
