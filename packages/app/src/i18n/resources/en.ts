    ...
    host: {
      ...
      orchestration: {
        ...
        managedMcp: {
          ...
          hint: "Inject shared servers into every compatible agent launched by this host.",
          ...
          alwaysLoad: "Always load tools",
          alwaysLoadHint: "Keep all tools from this server in the agent prompt.",
          alwaysLoadAccessibility: "Always load MCP tools",
          environmentVariables: "Environment variables",
          requestHeaders: "Request headers",
          secretHint: "Use a direct private value or reference daemon env.",
          add: "Add",
          ...
          value: "Value",
          keepValueHint: "Leave blank to keep the configured value.",
          save: "Save",
          test: "Test",
          edit: "Edit",
          remove: "Remove",
          enable: "Enable {{name}}",
          connected: "Connected in {{latencyMs}} ms · {{toolCount}} tools",
          rejected: "The MCP server rejected the connection.",
          duplicateName: "An MCP server named '{{name}}' already exists.",
          updateFailed: "Unable to update MCP server.",
          removeTitle: "Remove MCP server?",
          removeMessage: "Remove '{{name}}' from every agent launched by this host?",
          removeFailed: "Unable to remove MCP server.",
          testFailed: "Unable to test MCP server.",
          saveFailed: "Unable to save MCP server.",
          entryNameRequired: "Every header or environment entry needs a name.",
          envNameRequired: "An environment reference needs a variable name.",
          directValueRequired: "A direct value cannot be empty.",
          uniqueEntries: "Header and environment entry names must be unique.",
          nameRequired: "Server name is required.",
          commandRequired: "Command is required.",
          urlRequired: "URL is required.",
          invalidUrl: "Enter a valid MCP server URL.",
          httpOnly: "MCP server URLs must use HTTP or HTTPS.",
        },
        systemPrompt: {
          title: "System prompt",
