export const en = {
  ...
  panels: {
    ...
    commitLog: {
      ...
      directoryMissing: "Workspace directory not found.",
      capabilityMissing: "Update the host to browse commit history.",
      connecting: "Connecting to host…",
      loading: "Loading history…",
      loadError: "Failed to load commit history",
      empty: "No commits yet",
      loadMore: "Load more",
      loadingMore: "Loading…",
      refresh: "Refresh",
      refreshing: "Refreshing",
      truncatedRefs: "Showing only the most recently updated branches and tags",
      cursorExpired: "History changed while loading. Reloaded from the top.",
      scope: {
        head: "Current branch",
        all: "All branches",
      },
