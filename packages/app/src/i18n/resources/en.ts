  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        submodule: {
          detached: "detached {{sha}}",
          notInitialized: "Submodule is not initialized",
          unavailable: "Submodule checkout is unavailable",
          added: "Submodule was added",
          deleted: "Submodule was deleted",
          historyUnavailable: "Submodule commit history is unavailable",
          headDiffers: "HEAD {{currentSha}} differs from pinned {{pinnedSha}}",
          emptyCommitted: "No committed changes",
        },
