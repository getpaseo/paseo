export const en = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        markReadFailed: "Failed to mark workspace as read",
  ...
  newWorkspace: {
    ...
    errors: {
      ...
      chooseHostForProject: "Choose a host for this project",
      hostDisconnected: "Host is not connected",
  ...
  settings: {
    ...
    diagnostics: {
      ...
      notification: {
        ...
        rowHint: "Check permission and send a test notification",
        sendTest: "Send test",
        sending: "Sending...",
        sent: "Test notification sent.",
        notDelivered:
          "Notification was not delivered. Check browser or system notification settings.",
        failed: "Failed to send notification.",
      },
      app: {
        title: "App diagnostic",
        rowTitle: "App diagnostic",
        rowHint: "Collect connection, daemon, provider, desktop, notification, and log details",
        run: "Run",
  ...
  addProjectFlow: {
    ...
    placeholders: {
      ...
      searchGithub: "Search or enter a GitHub repository...",
    ...
    methods: {
      ...
      githubDescriptionSearch: "Search projects available to your GitHub account",
      githubDescriptionManual: "Enter a GitHub URL or owner/repo",
      githubDescriptionUpgrade: "Update this host to clone GitHub repositories",
      newDirectory: "New directory",
      newDirectoryDescription: "Create an empty directory on {{host}}",
      newDirectoryDescriptionUpgrade: "Update this host to create directories",
    },
    empty: {
      noHosts: "No connected hosts",
      noMatching: "No matching options",
      enterGithub: "Enter a GitHub URL or owner/repo",
    ...
    rows: {
      ...
      existingProject: "Existing project · {{path}}",
      alreadyExists: "Already exists",
      parentDirectory: "Parent directory: {{path}}",
      cloneRepositoryUrl: "Clone this repository URL",
      cloneViaProtocol: "Clone owner/repo via {{protocol}}",
      viaProtocol: "{{name}} via {{protocol}}",
    },
    errors: {
      hostUnavailable: "Host is unavailable",
      directoryNotFound: "Directory not found",
      unableToAdd: "Unable to add project",
      unableToBrowse: "Unable to browse for a directory",
      unableToClone: "Unable to clone repository",
      unableToCreateDirectory: "Unable to create directory",
      enterDirectoryName: "Enter a directory name",
      unableToSearchDirectories: "Unable to search directories",
      unableToSearchGithub: "Unable to search GitHub repositories",
      githubUnavailable: "GitHub search is unavailable",
    },
    accessibility: {
      back: "Back",
      page: "Add project: {{kind}}",
    },
  },
  schedules: {
    screen: {
    ...
    empty: {
      noActive: "No active schedules",
      description: "Schedules run agents on a cadence.",
      noEnded: "No ended schedules",
    },
    errors: {
    ...
    row: {
      ...
      menu: {
        actions: "{{productName}} actions",
        edit: "Edit {{productName}}",
        editRow: "Edit {{productName}} {{title}}",
    ...
    form: {
      ...
      titleEditHeartbeat: "Edit heartbeat",
      cancel: "Cancel",
      ...
      fields: {
        ...
        nameAccessibility: "Schedule name",
        prompt: "Prompt",
        promptPlaceholder: "What should the agent do each run?",
        maxRuns: "Max runs",
        maxRunsPlaceholder: "Unlimited",
        maxRunsAccessibility: "Max runs",
        host: "Host",
        hostPlaceholder: "Select host",
        hostEmpty: "No hosts found",
        project: "Project",
        projectPlaceholder: "Select project",
        projectEmpty: "No projects found",
        projectHint: "Choose a host first.",
        projectSearch: "Search projects...",
        projectTitle: "Select project",
        model: "Model",
        thinking: "Thinking",
        thinkingPlaceholder: "Select thinking",
        thinkingEmpty: "No thinking options found",
        thinkingTitle: "Select thinking",
        mode: "Mode",
        modePlaceholder: "Default mode",
        modeEmpty: "No modes found",
        modeHint: "No modes are available for this model.",
        modeTitle: "Select mode",
        archiveOnFinish: "Archive on finish",
        isolation: "Isolation",
        isolationPlaceholder: "Select isolation",
        isolationEmpty: "No isolation options found",
    ...
    cadence: {
      ...
      cronAccessibility: "Cron expression",
      presets: {
    ...
    format: {
      untitled: "Untitled {{productName}}",
      everyMinute: "Every minute",
      everyHour: "Every hour",
      everyHourAt: "Every hour at :{{minutes}}",
      ...
      weekends: "Weekends",
      dayPlural: "{{day}}s",
      atTime: "{{when}} at {{time}} {{timezone}}",
      soon: "soon",
      inMinutes: "in {{count}}m",
      inHours: "in {{count}}h",
      inDays: "in {{count}}d",
      enterCron: "Enter a cron expression",
      invalidCron: "Invalid {{detail}}",
      days: {
        sunday: "Sunday",
        monday: "Monday",
        tuesday: "Tuesday",
