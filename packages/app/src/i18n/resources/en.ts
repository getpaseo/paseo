export const en = {
  ...
  heartbeats: {
    ...
    statusPaused: "Paused",
    nextRun: "Next {{when}}",
    pauseAction: "Pause {{label}}",
    pauseTooltip: "Pause",
    pauseFailed: "Failed to pause heartbeat",
    resumeAction: "Resume {{label}}",
    resumeTooltip: "Resume",
    resumeFailed: "Failed to resume heartbeat",
    deleteAction: "Delete {{label}}",
    deleteTooltip: "Delete",
    deleteTitle: "Delete heartbeat",
    deleteMessage: 'Delete "{{label}}"? This cannot be undone.',
    deleteConfirm: "Delete",
    deleteFailed: "Failed to delete heartbeat",
  ...
  settings: {
    ...
    providers: {
      ...
      models: {
        ...
        contextWindowHint: "How much conversation history the model can keep.",
        ...
        lookingUpModel: "Looking up model data…",
        modelsDevNotFound: "We couldn't find this model. You can set the numbers yourself.",
        modelsDevLookupFailed: "Couldn't check model data right now. You can still save.",
        modelsDevAutofilled: "Filled from known model data",
