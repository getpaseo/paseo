export const en = {
  ...
  changeStats: {
    ...
    commentsIncluded:
      "Comments included in this portion of Production (unsupported syntax or incomplete analysis)",
    unavailable: "Update the host to see the change breakdown.",
  },
  ...
  chapters: {
    title: "Chapters",
    subtitle: "Read changes as a story",
    loading: "Building the story…",
    regenerate: "Regenerate",
    stale: "Changes have updated",
    empty: "No changes to explain.",
    unsupported: "Update the host to use Chapters.",
    disconnected: "Reconnect to load or update chapters.",
    retry: "Retry",
    previous: "Previous",
    next: "Next",
    select: "Select a chapter to read its changes.",
    lines: "{{count}} changed lines",
    lines_one: "{{count}} changed line",
    lines_other: "{{count}} changed lines",
    collapse: "Collapse category",
    expand: "Expand category",
    older: "You are reading an older version. Regenerate before adding comments.",
  },
  backgroundActivity: {
    retry: "Retry loading",
    title: "Background activity",
    subtitle: "Live background model requests",
    thread: "Background thread",
    thisWorkspace: "This workspace",
    allWorkspaces: "All workspaces",
    providerDefault: "Provider default",
    awaitingModel: "Awaiting model selection",
    loading: "Loading background activity…",
    empty: "No background requests in this session",
    unsupported: "Update the host to inspect background activity.",
    disconnected: "Disconnected — reconnecting to live activity…",
    unavailable: "This background session is no longer available.",
    truncated:
      "Some transcript content was omitted to keep session history within its memory limit.",
    instructions: "System instructions",
    noInstructions: "No system instructions were reported.",
    kind: {
      commit: "Generate commit message",
      pull_request: "Generate pull request text",
      labels: "Generate tool labels",
    },
    status: {
      queued: "Queued",
      running: "Running",
