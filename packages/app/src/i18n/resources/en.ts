export const en = {
  ...
  settings: {
    ...
    host: {
      ...
      agentEnvironment: {
        sectionTitle: "Agent environment",
        sectionDescription:
          "Commands run in an agent's directory before it starts. Their output becomes the agent's environment.",
        add: "Add environment setup",
        addCustom: "Custom command…",
        addCustomTitle: "Add environment command",
        editCommand: "Edit command",
        editCommandTitle: "Edit environment command",
        remove: "Remove",
        removeConfirmTitle: "Remove environment setup?",
        removeConfirmMessage: 'Remove "{{name}}"?',
        moveUp: "Move up",
        moveDown: "Move down",
        emptyState: "Nothing runs before an agent starts. Add direnv or a custom command.",
        unknownPreset: "This host does not recognize this preset",
        rowFormat: "Reads {{format}} output",
        commandLabel: "Command",
        commandHint: "Space-separated. Run a shell explicitly if you need one.",
        commandPlaceholder: "direnv export json",
        commandRequired: "Command is required",
        formatLabel: "Output format",
        formatJson: "JSON diff",
        formatEnv0: "env -0",
        formatJsonHint: 'An object of "KEY": "value", where null unsets the variable.',
        formatEnv0Hint: "NUL-separated KEY=VALUE records. Anything omitted is unset.",
        timeoutLabel: "Timeout",
        timeoutHint:
          "Milliseconds before the command is given up on. Leave blank to use the host default.",
        timeoutPlaceholder: "30000",
        timeoutInvalid: "Timeout must be a positive whole number",
        saving: "Saving...",
        save: "Save",
      },
      terminalProfiles: {
