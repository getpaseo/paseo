export const en = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        discardFileMessage: "This will permanently remove uncommitted changes in {{path}}.",
        discardFileConfirm: "Discard",
        fileActionFailed: "Failed to update file changes.",
        fileActionUnavailable: "File change actions are unavailable.",
  ...
  newWorkspace: {
    ...
    newBranch: {
      ...
      invalid: "Enter a valid branch name.",
    },
  },
  desktop: {
    quitting: {
