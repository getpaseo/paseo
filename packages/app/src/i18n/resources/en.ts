  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        ...
        generationUnsupported: "Update the host to generate commit messages.",
        selectAll: "Select all changes",
        selectedCount: "{{count}} of {{total}} selected",
        selectAtLeastOne: "Select at least one file to commit.",
        includeFile: "Include {{path}} in commit",
        discardFile: "Discard changes in {{path}}",
        commitFailed: "Couldn't commit changes.",
      },
      sourceControl: {
        ...
        stageBeforeCommit: "Stage files before committing.",
        indexUpdateFailed: "Couldn't update staged changes.",
        resizeSections: "Resize staged and unstaged sections",
      },
      diff: {
