export const en = {
  ...
  composer: {
    ...
    stash: {
      ...
      stashedEvicted: "Prompt stashed — the oldest stashed prompt was discarded to make room",
      restored: "Stashed prompt restored",
      undo: "Undo",
      badgeAccessibilityLabel: "Stashed prompts: {{count}}. Open stash.",
      menuTitle: "Stashed prompts",
      menuEmpty: "Nothing stashed yet",
      attachmentsOnly_one: "{{count}} attachment",
      attachmentsOnly_other: "{{count}} attachments",
      deleteEntry: "Delete stashed prompt",
      otherProviders_one: "{{count}} prompt is stashed under another provider",
      otherProviders_other: "{{count}} prompts are stashed under other providers",
    },
    errors: {
