export const en = {
  ...
  contextWindow: {
    ...
    promptCache: {
      ...
      statusExpired: "Likely expired",
      statusUnknown: "Lifetime unknown",
      warmFor: "warm for ~{{duration}}",
      expiredAgo: "expired {{duration}} ago",
      lastRequestAgo: "last request {{duration}} ago",
      durationSeconds: "{{value}} sec",
      durationMinutes: "{{value}} min",
      lastRequest: "Last request {{percent}}% cached · {{split}}",
      split: "{{cached}} cached, {{fresh}} new",
      splitWithWrite: "{{cached}} cached, {{fresh}} new, {{written}} written",
      sessionSingular: "Session {{percent}}% cached over {{count}} request",
      sessionPlural: "Session {{percent}}% cached over {{count}} requests",
      ping: "Ping",
      pinging: "Pinging...",
      pingHint: "Sends a short message to keep the cache warm",
      pingError: "Unable to send the ping",
    },
  },
  review: {
    comment: {
