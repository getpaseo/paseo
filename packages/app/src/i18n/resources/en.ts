export const en = {
  ...
  workspace: {
    ...
    browser: {
      ...
      annotate: {
        title: "Edit element",
        placeholder: "Describe another change for the agent…",
        submit: "Attach",
        cancel: "Cancel",
        reset: "Restore original",
        adjust: "Adjust properties",
        previewFailed: "Couldn't update the element preview",
        groups: { content: "Content", appearance: "Appearance", properties: "Properties" },
        fields: {
          checked: "Checked",
          value: "Value",
          text: "Text",
