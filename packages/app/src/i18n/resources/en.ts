  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        ...
        updateRequired: "Update this host to configure relay endpoints",
        configure: "Configure",
        configureTitle: "Configure relay",
        enabled: "Enable relay",
        endpoint: "Daemon endpoint",
        endpointHint: "Address the daemon uses to connect, as host:port",
        useTls: "Use TLS for daemon connection",
        publicEndpoint: "Public endpoint",
        publicEndpointHint: "Address included in pairing links, as host:port",
        publicUseTls: "Use TLS for public connection",
        controlledBy: "Controlled by {{env}}. Remove the launch override to edit this setting.",
        hostPortError: "Enter an address as host:port without a URL scheme",
        save: "Save",
