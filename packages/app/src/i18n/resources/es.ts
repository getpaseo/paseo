  ...
  settings: {
    ...
    project: {
      ...
      scripts: {
        ...
        urlAccessibility: "URL del enlace",
        nameRequired: "El nombre es obligatorio",
        commandRequired: "Se requiere comando",
        urlRequired: "La URL es obligatoria",
        urlInvalid: "Introduce una URL HTTP o HTTPS",
        ...
        openUrl: "Abrir una URL",
        openUrlHint:
          "Se abre en el navegador del cliente. Usa {workspacePath} para la ruta del árbol de trabajo o de la carpeta.",
        openUrlUpdateHost: "Actualiza este host de Paseo para añadir enlaces del navegador.",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
