...
export const es: TranslationResources = {
  ...
  agentList: {
    ...
    archiveSheet: {
      hostOffline: "Host fuera de línea",
  ...
  workspace: {
    ...
    tabs: {
      ...
      fallback: {
        newAgent: "Nuevo agente",
        setup: "Configuración",
        workspaceSetup: "Configuración del espacio de trabajo",
      ...
      menu: {
        ...
        closeBelow: "Cerrar pestañas abajo",
      ...
      toasts: {
        ...
        agentIdCopiedLabel: "ID del agente",
        resumeCommandCopiedLabel: "comando de reanudación",
        filePathCopiedLabel: "Ruta del archivo",
        resumeIdUnavailable: "ID de reanudación no disponible",
        resumeCommandUnavailable: "Comando de reanudación no disponible",
        reloadingAgent: "Recargando agente...",
    ...
    scripts: {
      ...
      accessibility: {
        trigger: "Scripts del espacio de trabajo",
        openAt: "Abrir {{scriptName}} en {{label}}",
        viewTerminal: "Ver terminal {{scriptName}}",
        runScript: "Ejecutar el script {{scriptName}}",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        pauseAndStop: "Pausar y detener",
        registrationFailed:
          "El demonio integrado se inició, pero Paseo no pudo guardar la conexión localhost. Desactive y reactive la gestión del demonio, o añada localhost manualmente.",
        pausedStopFailed:
    ...
    updates: {
      status: {
        ...
        upToDateWithLastChecked: "Actualizado. Última verificación a las {{time}}.",
  ...
  settings: {
    ...
    diagnostics: {
      ...
      app: {
        ...
        rowHint: "Recopilar detalles de conexión, demonio, proveedor, escritorio y registros",
        run: "Ejecutar",
        running: "Ejecutando diagnóstico...",
        copyLabel: "diagnóstico",
        copyAccessibility: "Copiar diagnóstico",
        copyFailed: "Error al copiar el diagnóstico",
    ...
    about: {
      ...
      releaseChannel: {
        ...
        description: "Cambie a Beta para recibir actualizaciones antes y ayudar a darles forma",
        stable: "Estable",
        beta: "Beta",
      },
      updates: {
    ...
    host: {
      ...
      agents: {
        unavailable: "Conéctese a este host para administrar los agentes",
      },
      workspaces: {
        unavailable: "Conéctese a este host para administrar los espacios de trabajo",
      },
      terminalProfiles: {
        unavailable: "Conéctese a este host para administrar los perfiles de terminal",
        ...
        save: "Guardar",
        emptyState:
          "Aún no hay perfiles. Añada uno para iniciar terminales con un comando específico.",
      },
      daemon: {
        rename: {
        ...
        restart: {
          ...
          offlineTitle: "Host fuera de línea",
          offlineMessage:
        ...
        update: {
          ...
          hint: "Actualice el demonio a la última versión y reinícielo",
          confirm: "Actualizar",
          ...
          unableToReconnectTitle: "No se puede volver a conectar",
          unableToReconnectMessage:
            "{{name}} no volvió a conectarse después de la actualización. Por favor verifique que el demonio se haya reiniciado.",
          unavailableTitle: "Host no disponible",
          unavailableMessage:
            "Este host no está conectado. Espere a que se conecte antes de actualizar.",
          offlineTitle: "Host fuera de línea",
          offlineMessage:
            "Este host está fuera de línea. Espere hasta que vuelva a estar en línea antes de actualizar.",
          requestFailedTitle: "Actualización fallida",
          requestFailedMessage: "No se pudo actualizar el demonio: {{error}}",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de actualización.",
        },
        ...
        remove: {
          ...
          localConfirmMessage:
            "Esto eliminará la conexión localhost, desactivará la gestión del demonio integrado y detendrá el demonio administrado. Los hosts remotos permanecen conectados.",
          errorTitle: "Error",
          errorMessage: "No se puede eliminar el host",
          localErrorMessage: "No se puede eliminar la conexión localhost",
        },
      },
    },
    providers: {
    ...
    project: {
      ...
      worktree: {
        ...
        docs: "Documentación",
        docsTooltip:
          "Consulte la documentación para obtener más detalles y las variables de entorno disponibles para estos comandos.",
        setup: "Configuración",
      ...
      metadata: {
        ...
        branchName: "Nombres de ramas",
        branchNamePlaceholder: "Prefije las ramas con feat/ o fix/, mb/ para ramas personales",
        commitMessage: "Mensajes de confirmación",
        commitMessagePlaceholder: "Utilice confirmaciones convencionales con un alcance",
        pullRequest: "Pull requests",
        pullRequestPlaceholder:
          "Comience con un resumen de un párrafo e incluya una sección de plan de prueba",
      },
      writeFailures: {
