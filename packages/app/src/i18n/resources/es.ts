...
export const es: TranslationResources = {
  ...
  sessions: {
    ...
    organization: {
      trigger: "Filtros y ordenación del historial",
      ...
      status: { active: "Activas", archived: "Archivadas" },
      activity: {
        anyTime: "Cualquier momento",
        today: "Hoy",
        pastSevenDays: "Últimos 7 días",
        pastThirtyDays: "Últimos 30 días",
      },
      group: { lastActivity: "Última actividad", project: "Proyecto", none: "Sin agrupar" },
      sort: {
      ...
      selection: {
        all: "Todos",
        oneSelected: "1 seleccionado",
        selectedCount: "{{count}} seleccionados",
      },
      updateHost: "{{label}} · Actualiza el host",
      clearFilters: "Borrar filtros",
    },
  },
  agentList: {
    fallbackTitle: "Nueva sesión",
    sections: { pinned: "Fijadas" },
    actions: {
      menuAccessibility: "Acciones para {{title}}",
      fallbackSession: "sesión",
      sheetTitle: "Acciones de la sesión",
      updateHostToPin: "Actualiza el host para fijar sesiones",
      pin: "Fijar sesión",
      unpin: "Desfijar sesión",
      pinning: "Fijando...",
      unpinning: "Desfijando...",
      archive: "Archivar sesión",
      updatePinFailed: "No se pudo actualizar la fijación de la sesión",
    },
    dateSections: {
      recent: "Reciente",
      today: "Hoy",
  ...
  sidebar: {
    ...
    organization: {
      ...
      labels: {
        ...
        workspaceLabel: "Etiqueta de espacio de trabajo",
      },
      status: {
        needsInput: "Necesita intervención",
        working: "En curso",
        readyToReview: "Lista para revisar",
        failed: "Falló",
        done: "Hecho",
      },
      ...
      group: {
        project: "Proyecto",
        projectGroup: "Grupo de proyectos",
        status: "Estado",
        workspaceLabel: "Etiqueta de espacio de trabajo",
        none: "Ninguno",
      },
      ...
      workspaceTitle: { title: "Título", branchName: "Nombre de rama" },
      selection: {
        all: "Todos",
        oneSelected: "1 seleccionado",
        selectedCount: "{{count}} seleccionados",
      ...
      actions: {
        ...
        newWorkspaceLabel: "Nueva etiqueta de espacio de trabajo…",
        newWorkspaceLabelSelectHost: "Nueva etiqueta de espacio de trabajo… · Selecciona un host",
        clearFilters: "Borrar filtros",
        create: "Crear",
      },
      project: {
        ...
        moveToProjectGroup: "Mover al grupo de proyectos",
        noProjectGroup: "Sin grupo",
      },
      projectGroup: {
        modalTitle: "Nuevo grupo de proyectos",
        placeholder: "Nombre del grupo",
        renameTitle: "Renombrar grupo de proyectos",
        delete: "Eliminar grupo de proyectos",
        deleteMessage: '¿Eliminar "{{name}}"? Sus proyectos no se eliminarán.',
        actionsAccessibility: "Acciones del grupo de proyectos {{name}}",
      },
      hiddenProjects: {
        title: "Proyectos ocultos",
        unhideAll: "Mostrar todos",
        empty: "No hay nada oculto",
        description:
          "Los proyectos y espacios de trabajo ocultos no aparecen en la barra lateral hasta que los muestres.",
        showVisible: "Mostrar elementos visibles",
      },
      sections: {
        hidden: "Ocultos",
        workspaces: "Espacios de trabajo",
        projects: "Proyectos",
        pinnedProjects: "Proyectos fijados",
      },
      workspaceLabel: {
        modalTitle: "Nueva etiqueta de espacio de trabajo",
        placeholder: "Nombre de la etiqueta",
        none: "Sin etiqueta",
        unknown: "Etiqueta desconocida",
        renameTitle: "Renombrar etiqueta de espacio de trabajo",
        delete: "Eliminar etiqueta de espacio de trabajo",
        deleteMessage: '¿Eliminar "{{name}}"? Sus espacios de trabajo no se eliminarán.',
        accessibility: "Etiqueta de espacio de trabajo: {{label}}",
        actionsAccessibility: "Acciones de la etiqueta de espacio de trabajo {{name}}",
      },
      errors: {
        selectOneHost: "Selecciona un host antes de crear una etiqueta de espacio de trabajo",
        moveFailed: "No se pudo mover el espacio de trabajo",
        createdMoveFailed: "La etiqueta se creó, pero el espacio de trabajo no se pudo mover",
        createdMoveFailedWithError:
          "La etiqueta se creó, pero el espacio de trabajo no se pudo mover: {{error}}",
        createFailed: "No se pudo crear la etiqueta de espacio de trabajo",
        hostDisconnected: "El host no está conectado",
        deleteWorkspaceLabelFailed: "No se pudo eliminar la etiqueta de espacio de trabajo",
      },
    },
    host: {
