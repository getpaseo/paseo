...
export const es: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        discardFile: "Descartar cambios del archivo",
        discardFileTitle: "¿Descartar cambios del archivo?",
        discardFileMessage:
          "Esto eliminará permanentemente los cambios no confirmados en {{path}}.",
        discardFileConfirm: "Descartar",
        fileActionFailed: "No se pudieron actualizar los cambios del archivo.",
        fileActionUnavailable: "Las acciones de cambios de archivo no están disponibles.",
  ...
  newWorkspace: {
    ...
    newBranch: {
      accessibilityLabel: "Nombre de la nueva rama",
      placeholder: "Nueva rama",
      invalid: "Introduce un nombre de rama válido.",
    },
  },
  desktop: {
    quitting: {
