...
export const es: TranslationResources = {
    ...
    git: {
      ...
      diff: {
        ...
        commits: {
          ...
          openHistory: "Abrir la pestaña Historial",
        },
      },
      openInEditor: {
        open: "Abierto",
  ...
  panels: {
    ...
    commitLog: {
      label: "Historial",
      subtitle: "Historial de commits",
      tooltip: "Explorar el historial de commits",
      directoryMissing: "No se encontró el directorio del espacio de trabajo.",
      capabilityMissing: "Actualiza el host para explorar el historial de commits.",
      connecting: "Conectando con el host…",
      ...
      truncatedRefs: "Mostrando solo las ramas y etiquetas actualizadas más recientemente",
      cursorExpired: "El historial cambió durante la carga. Se recargó desde el principio.",
      scope: {
        head: "Rama actual",
        all: "Todas las ramas",
      },
