...
export const es: TranslationResources = {
  ...
  settings: {
    ...
    notifications: {
      ...
      customSound: "Sonido de notificación",
      customSoundDefault: "Sonido del sistema",
      customSoundChoose: "Elegir",
      customSoundClear: "Restablecer",
      customSoundFilter: "Archivos de audio",
