  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        ...
        updateRequired: "Actualiza este host para configurar los endpoints del relé",
        configure: "Configurar",
        configureTitle: "Configurar relé",
        enabled: "Activar relé",
        endpoint: "Endpoint del daemon",
        endpointHint: "Dirección que usa el daemon para conectarse, como host:port",
        useTls: "Usar TLS para la conexión del daemon",
        publicEndpoint: "Endpoint público",
        publicEndpointHint: "Dirección incluida en los enlaces de vinculación, como host:port",
        publicUseTls: "Usar TLS para la conexión pública",
        controlledBy:
          "Controlado por {{env}}. Elimina la sustitución de inicio para editar este ajuste.",
        hostPortError: "Introduce una dirección como host:port sin esquema de URL",
        save: "Guardar",
