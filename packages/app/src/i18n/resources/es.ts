...
export const es: TranslationResources = {
  ...
  plugins: {
    ...
    conflictsTitle: "Extensiones reclamadas por más de un complemento",
    conflictLine: "{{extension}}: gana {{winner}}, se ignora {{losers}}",
    views: {
    ...
    errors: {
      ...
      entryMissing: "Falta el archivo de entrada del complemento.",
      previewFailed: "{{plugin}} no pudo mostrar este archivo: {{reason}}",
      panelFailed: "{{plugin}} no pudo mostrar este panel: {{reason}}",
    },
  },
  settings: {
    title: "Ajustes",
