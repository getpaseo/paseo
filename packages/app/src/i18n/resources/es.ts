  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        submodule: {
          detached: "desacoplado {{sha}}",
          notInitialized: "El submódulo no está inicializado",
          unavailable: "El checkout del submódulo no está disponible",
          added: "Se añadió el submódulo",
          deleted: "Se eliminó el submódulo",
          historyUnavailable: "El historial de commits del submódulo no está disponible",
          headDiffers: "HEAD {{currentSha}} difiere del commit fijado {{pinnedSha}}",
          emptyCommitted: "Sin cambios confirmados",
        },
