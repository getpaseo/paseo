    ...
    host: {
      ...
      orchestration: {
        ...
        managedMcp: {
          ...
          hint: "Inyecta servidores compartidos en cada agente compatible iniciado por este host.",
          empty: "No hay servidores MCP externos configurados.",
          ...
          argumentsHint: "Introduce un argumento por línea.",
          alwaysLoad: "Cargar siempre las herramientas",
          alwaysLoadHint: "Mantén todas las herramientas de este servidor en el prompt del agente.",
          alwaysLoadAccessibility: "Cargar siempre las herramientas MCP",
          environmentVariables: "Variables de entorno",
          requestHeaders: "Encabezados de solicitud",
          secretHint: "Usa un valor privado directo o referencia el entorno del daemon.",
          add: "Añadir",
          directValue: "Valor directo",
          environmentSource: "Entorno",
          variable: "Variable",
          header: "Encabezado",
          environmentVariableName: "Nombre de la variable de entorno",
          value: "Valor",
          keepValueHint: "Déjalo vacío para conservar el valor configurado.",
          save: "Guardar",
          test: "Probar",
          edit: "Editar",
          remove: "Eliminar",
          enable: "Activar {{name}}",
          connected: "Conectado en {{latencyMs}} ms · {{toolCount}} herramientas",
          rejected: "El servidor MCP rechazó la conexión.",
          duplicateName: "Ya existe un servidor MCP llamado '{{name}}'.",
          updateFailed: "No se pudo actualizar el servidor MCP.",
          removeTitle: "¿Eliminar servidor MCP?",
          removeMessage: "¿Eliminar '{{name}}' de todos los agentes iniciados por este host?",
          removeFailed: "No se pudo eliminar el servidor MCP.",
          testFailed: "No se pudo probar el servidor MCP.",
          saveFailed: "No se pudo guardar el servidor MCP.",
          entryNameRequired: "Cada encabezado o entrada de entorno necesita un nombre.",
          envNameRequired: "Una referencia de entorno necesita un nombre de variable.",
          directValueRequired: "Un valor directo no puede estar vacío.",
          uniqueEntries: "Los nombres de encabezados y entradas de entorno deben ser únicos.",
          nameRequired: "El nombre del servidor es obligatorio.",
          commandRequired: "El comando es obligatorio.",
          urlRequired: "La URL es obligatoria.",
          invalidUrl: "Introduce una URL válida del servidor MCP.",
          httpOnly: "Las URL del servidor MCP deben usar HTTP o HTTPS.",
        },
        systemPrompt: {
