  ...
  workspace: {
    ...
    browser: {
      ...
      controls: {
        ...
        annotateElement: "Editar elemento",
      ...
      annotate: {
        ...
        adjust: "Ajustar propiedades",
        previewFailed: "No se pudo actualizar la vista previa del elemento",
        groups: { content: "Contenido", appearance: "Apariencia", properties: "Propiedades" },
        fields: {
