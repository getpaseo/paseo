...
export const es: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      imagePreviewHint: "Toca para abrir. Mantén pulsado para guardar.",
      imageSaving: "Guardando imagen…",
      imageSaved: "Guardada en Fotos",
      imageSavePermissionDenied: "Permite el acceso a Fotos para guardar esta imagen.",
