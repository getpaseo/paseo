...
export const es: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        messageLabel: "Mensaje de confirmación",
        placeholder: "Describe tus cambios",
        generate: "Generar",
        generating: "Generando...",
        generationFailed: "No se pudo generar un mensaje de confirmación.",
        generationUnsupported: "Actualiza el host para generar mensajes de confirmación.",
        selectAll: "Seleccionar todos los cambios",
        selectedCount: "{{count}} de {{total}} seleccionados",
        selectAtLeastOne: "Selecciona al menos un archivo para confirmar.",
        includeFile: "Incluir {{path}} en la confirmación",
        discardFile: "Descartar cambios en {{path}}",
        commitFailed: "No se pudieron confirmar los cambios.",
      },
      sourceControl: {
        ...
        stageFile: "Preparar {{path}}",
        unstageFile: "Despreparar {{path}}",
        stageBeforeCommit: "Prepara los archivos antes de confirmar.",
        indexUpdateFailed: "No se pudieron actualizar los cambios preparados.",
        resizeSections: "Cambiar tamaño de las secciones preparadas y no preparadas",
      },
      diff: {
