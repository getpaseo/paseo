...
export const es: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      videoPreviewLoadFailed: "No se puede cargar la vista previa del vídeo.",
      videoPlaybackUnsupported: "La reproducción de vídeo no está disponible en esta plataforma.",
      review: "Revisión",
