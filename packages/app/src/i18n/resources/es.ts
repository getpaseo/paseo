...
export const es: TranslationResources = {
  ...
  toolCall: {
    displayNames: {
      ...
      search: "Buscar",
      fetch: "Obtener",
      worktreeSetup: "Configuración de Worktree",
      task: "Tarea",
  ...
  workspace: {
    route: {
      ...
      browserTabTitle: "Espacio de trabajo",
      connecting: "Conectando",
  ...
  sidebar: {
    ...
    workspace: {
      sectionTitle: "Espacios de trabajo",
      ...
      toasts: {
        ...
        markReadFailed: "No se pudo marcar el espacio de trabajo como leído",
  ...
  newWorkspace: {
    ...
    projectPicker: {
      ...
      accessibilityLabel: "Proyecto del espacio de trabajo",
    },
    hostPicker: {
      title: "Host",
      fallbackLabel: "Host",
    ...
    isolation: {
      ...
      label: "Aislamiento",
      accessibilityLabel: "Aislamiento del espacio de trabajo",
    },
    fields: {
      project: "Proyecto",
      base: "Base",
    ...
    errors: {
      ...
      chooseHostForProject: "Elige un host para este proyecto",
      hostDisconnected: "Hostno está conectado",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        registrationFailed:
          "El demonio integrado se inició, pero Paseo no pudo guardar la conexión localhost. Desactiva y vuelve a activar la gestión del demonio, o añade localhost manualmente.",
        pausedStopFailed:
  ...
  settings: {
    ...
    general: {
      ...
      sendButtonVisibility: {
        ...
        descriptions: {
          always:
            "Mostrar siempre el botón de enviar. Permanece desactivado hasta que haya contenido.",
          whenContent:
            "Mostrar el botón de enviar solo cuando haya texto, archivos adjuntos o un envío en curso.",
        },
        options: {
          always: "Siempre",
          whenContent: "Al escribir",
        },
      },
      enterKey: {
        label: "Tecla Enter",
        description: "Elige si Enter envía el mensaje o inserta una nueva línea",
        options: {
          send: "Enviar",
          newline: "Nueva línea",
        },
    ...
    diagnostics: {
      ...
      notification: {
        ...
        rowHint: "Comprobar el permiso y enviar una notificación de prueba",
        sendTest: "Enviar prueba",
        sending: "Enviando...",
        sent: "Notificación de prueba enviada.",
        notDelivered:
          "La notificación no se entregó. Revisa la configuración de notificaciones del navegador o del sistema.",
        failed: "No se pudo enviar la notificación.",
      },
      app: {
        ...
        rowHint:
          "Recopilar detalles de conexión, demonio, proveedor, escritorio, notificaciones y registros",
        run: "Ejecutar",
        ...
        refreshingAccessibility: "Actualizando diagnóstico",
        progress: {
          client: "Cliente",
    ...
    host: {
      ...
      voice: {
        updating: "Actualizando ajustes de voz…",
        dictation: {
          title: "Dictado",
          hint: "Micrófono a texto en el compositor. Desactivado, el host no carga modelos de voz para dictado.",
          accessibilityLabel: "Activar dictado",
        },
        voiceMode: {
          title: "Modo de voz",
          hint: "Conversaciones de voz en tiempo real con agentes. Desactivado, el host no ejecuta STT/TTS de voz.",
          accessibilityLabel: "Activar modo de voz",
        },
      },
      agents: {
      ...
      workspaces: {
        ...
        autoArchiveAfterMerge: {
          ...
          hint: "Archivar automáticamente los espacios de trabajo limpios de Paseo cuando se fusiona su pull request",
          accessibilityLabel: "Archivar espacios de trabajo de PR fusionados",
          updateFailedTitle: "No se pudieron actualizar los espacios de trabajo",
        },
      },
      browserTools: {
        title: "Herramientas del navegador",
        hint: "Permitir que los agentes accedan y controlen las pestañas del navegador de Paseo, incluido el estado con sesión iniciada. Actívalo solo para agentes de confianza.",
      ...
      terminalAgents: {
        ...
        enableHooks: {
          title: "Activar hooks de agents de terminal",
          hint: "Recibe notificaciones y estado de los agents de terminal. Esto instala hooks en los archivos de configuración del agent.",
          accessibilityLabel: "Activar hooks de agents de terminal",
          updateFailedTitle: "No se pudieron actualizar los hooks de agents de terminal",
        },
      },
      terminalProfiles: {
        unavailable: "Conéctate a este host para gestionar perfiles de terminal",
      ...
      daemon: {
        ...
        update: {
          ...
          title: "Actualizar demonio",
          hint: "Actualizar el demonio a la última versión y reiniciarlo",
          confirm: "Actualizar",
          confirmTitle: "Actualizar {{name}}",
          confirmMessage:
            "Esto actualizará el demonio a la última versión y lo reiniciará. Los agentes en ejecución se interrumpirán brevemente.",
          updating: "Actualizando...",
          phaseStarting: "Preparando actualización...",
          phaseDownloading: "Descargando paquetes...",
          phaseInstalling: "Instalando...",
          phaseComplete: "Actualización completa, reiniciando...",
          unableToReconnectTitle: "No se pudo reconectar",
          unableToReconnectMessage:
            "{{name}} no volvió a estar en línea tras la actualización. Comprueba que el demonio se reinició.",
          unavailableTitle: "Host no disponible",
          unavailableMessage:
            "Este host no está conectado. Espera a que esté en línea antes de actualizar.",
          offlineTitle: "Host sin conexión",
          offlineMessage:
            "Este host está sin conexión. Espera a que vuelva a estar en línea antes de actualizar.",
          requestFailedTitle: "Error al actualizar",
          requestFailedMessage: "No se pudo actualizar el demonio: {{error}}",
          dialogFailedMessage: "No se pudo abrir el cuadro de confirmación de actualización.",
        },
        dangerZone: "Zona de peligro",
        remove: {
          title: "Eliminar host",
          localTitle: "Eliminar conexión localhost",
          hint: "Elimina este host y sus conexiones guardadas de este dispositivo",
          localHint: "Elimina localhost de este dispositivo y detiene el demonio integrado",
          localConfirmTitle: "¿Eliminar la conexión localhost y detener el demonio?",
          confirmMessage: "¿Quitar{{name}}? Esto eliminará sus conexiones guardadas.",
          localConfirmMessage:
            "Esto eliminará la conexión localhost, desactivará la gestión del demonio integrado y detendrá el demonio gestionado. Los hosts remotos seguirán conectados.",
          errorTitle: "Error",
          errorMessage: "No se puede eliminar el host",
          localErrorMessage: "No se pudo eliminar la conexión localhost",
        },
      },
    },
    providers: {
      ...
      remove: {
        ...
        confirmMessage:
          "Esto elimina la entrada del proveedor de config.json. No se puede deshacer.",
        confirm: "Eliminar",
        errorTitle: "No se pudo eliminar el proveedor",
      },
      statuses: {
  ...
  providerUsage: {
    ...
    resetsIn: "se reinicia {{duration}}",
    runsOutIn: "se agota {{duration}}",
    ...
    errors: {
      grokNetwork:
        "No se pudo alcanzar la API de facturación de Grok. Comprueba que cli-chat-proxy.grok.com sea accesible (las reglas de proxy/VPN suelen bloquearlo).",
    },
  },
  addProjectFlow: {
    titles: {
      ...
      chooseParent: "Elegir directorio padre",
      nameDirectory: "Nombrar directorio",
    },
    placeholders: {
      searchHosts: "Buscar hosts...",
      searchMethods: "Buscar métodos...",
      searchDirectories: "Buscar directorios o introducir una ruta...",
      searchGithub: "Buscar o introducir un repositorio de GitHub...",
      searchParents: "Buscar directorios padre o introducir una ruta...",
      directoryName: "Nombre del directorio",
    },
    methods: {
      searchDirectory: "Buscar directorio",
      searchDirectoryDescription: "Encontrar un directorio en {{host}}",
      browse: "Explorar",
      browseDescription: "Elegir o crear un directorio en Finder",
      github: "Clonar desde GitHub",
      githubDescriptionSearch: "Buscar proyectos disponibles en tu cuenta de GitHub",
      githubDescriptionManual: "Introduce una URL de GitHub o owner/repo",
      githubDescriptionUpgrade: "Actualiza este host para clonar repositorios de GitHub",
      newDirectory: "Nuevo directorio",
      newDirectoryDescription: "Crear un directorio vacío en {{host}}",
      newDirectoryDescriptionUpgrade: "Actualiza este host para crear directorios",
    },
    empty: {
      noHosts: "No hay hosts conectados",
      noMatching: "No hay opciones coincidentes",
      enterGithub: "Introduce una URL de GitHub o owner/repo",
    ...
    progress: {
      ...
      creating: "Creando directorio...",
      loading: "Cargando...",
    },
    rows: {
      addHost: "Añadir host",
      openThisPath: "Abrir esta ruta",
      useThisParent: "Usar este padre",
      existingProject: "Proyecto existente · {{path}}",
      alreadyExists: "Ya existe",
      parentDirectory: "Directorio padre: {{path}}",
      cloneRepositoryUrl: "Clonar esta URL de repositorio",
      cloneViaProtocol: "Clonar owner/repo vía {{protocol}}",
      viaProtocol: "{{name}} vía {{protocol}}",
    },
    errors: {
      hostUnavailable: "El host no está disponible",
      directoryNotFound: "Directorio no encontrado",
      unableToAdd: "No se pudo añadir el proyecto",
      unableToBrowse: "No se pudo explorar un directorio",
      unableToClone: "No se pudo clonar el repositorio",
      unableToCreateDirectory: "No se pudo crear el directorio",
      enterDirectoryName: "Introduce un nombre de directorio",
      unableToSearchDirectories: "No se pudieron buscar directorios",
      unableToSearchGithub: "No se pudieron buscar repositorios de GitHub",
      githubUnavailable: "La búsqueda de GitHub no está disponible",
    },
    accessibility: {
      back: "Atrás",
      page: "Añadir proyecto: {{kind}}",
    },
  },
  schedules: {
    screen: {
    ...
    empty: {
      noActive: "No hay horarios activos",
      description: "Los horarios ejecutan agentes con una cadencia.",
      noEnded: "No hay horarios finalizados",
    },
    errors: {
      unableToLoad: "No se pudieron cargar los horarios",
      hostLoadFailed: "{{serverName}}: No se pudieron cargar los horarios",
    },
    row: {
      created: "Creado {{time}}",
      ...
      status: {
        ...
        expired: "Caducado",
        finished: "Finalizado",
        targetGone: "Destino inexistente",
      },
      menu: {
        actions: "Acciones de {{productName}}",
        edit: "Editar {{productName}}",
        editRow: "Editar {{productName}} {{title}}",
        resume: "Reanudar horario",
        resuming: "Reanudando...",
        pause: "Pausar horario",
        pausing: "Pausando...",
        runNow: "Ejecutar ahora",
        starting: "Iniciando...",
        delete: "Eliminar {{productName}}",
        deleting: "Eliminando...",
      },
    },
    delete: {
    ...
    form: {
      titleCreate: "Nuevo horario",
      titleEdit: "Editar horario",
      titleEditHeartbeat: "Editar heartbeat",
      cancel: "Cancelar",
      ...
      fields: {
        ...
        nameAccessibility: "Nombre del horario",
        prompt: "Prompt",
        promptPlaceholder: "¿Qué debe hacer el agente en cada ejecución?",
        maxRuns: "Ejecuciones máximas",
        maxRunsPlaceholder: "Ilimitadas",
        maxRunsAccessibility: "Ejecuciones máximas",
        host: "Host",
        hostPlaceholder: "Seleccionar host",
        hostEmpty: "No se encontraron hosts",
        project: "Proyecto",
        projectPlaceholder: "Seleccionar proyecto",
        projectEmpty: "No se encontraron proyectos",
        projectHint: "Elige un host primero.",
        projectSearch: "Buscar proyectos...",
        projectTitle: "Seleccionar proyecto",
        model: "Modelo",
        thinking: "Pensamiento",
        thinkingPlaceholder: "Seleccionar pensamiento",
        thinkingEmpty: "No se encontraron opciones de pensamiento",
        thinkingTitle: "Seleccionar pensamiento",
        mode: "Modo",
        modePlaceholder: "Modo predeterminado",
        modeEmpty: "No se encontraron modos",
        modeHint: "No hay modos disponibles para este modelo.",
        modeTitle: "Seleccionar modo",
        archiveOnFinish: "Archivar al finalizar",
        isolation: "Aislamiento",
        isolationPlaceholder: "Seleccionar aislamiento",
        isolationEmpty: "No se encontraron opciones de aislamiento",
    ...
    cadence: {
      ...
      presets: {
        ...
        weekdays9: "Días laborables a las 9:00",
        mondays9: "Lunes a las 9:00",
        custom: "Cron personalizado",
      },
    },
    format: {
      untitled: "{{productName}} sin título",
      everyMinute: "Cada minuto",
      everyHour: "Cada hora",
      everyHourAt: "Cada hora a :{{minutes}}",
      ...
      dayPlural: "{{day}}s",
      atTime: "{{when}} a las {{time}} {{timezone}}",
      soon: "pronto",
      inMinutes: "en {{count}} min",
      inHours: "en {{count}} h",
      inDays: "en {{count}} d",
      enterCron: "Introduce una expresión cron",
      invalidCron: "{{detail}} no válido",
      days: {
        sunday: "Domingo",
        monday: "Lunes",
        tuesday: "Martes",
