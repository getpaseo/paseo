...
export const ar: TranslationResources = {
  ...
  timelineSearch: {
    ...
    matchCountCapped: "{{count}}+ نتيجة",
    historyLoadFailed: "تعذّر تحميل السجل الأقدم — قد تكون النتائج غير مكتملة",
    next: "النتيجة التالية",
    prev: "النتيجة السابقة",
    close: "إغلاق",
    searchingHistory: "جارٍ البحث في السجل…",
    loadingOlderHistory: "جارٍ تحميل السجل الأقدم…",
    filters: {
      all: "الكل",
      prompts: "المطالبات",
      messages: "الرسائل",
