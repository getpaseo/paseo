...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        stageFile: "إضافة الملف إلى الفهرس",
        unstageFile: "إزالة الملف من الفهرس",
        discardFile: "تجاهل تغييرات الملف",
        discardFileTitle: "تجاهل تغييرات الملف؟",
        discardFileMessage: "سيؤدي هذا إلى إزالة التغييرات غير الملتزم بها في {{path}} نهائياً.",
        discardFileConfirm: "تجاهل",
        fileActionFailed: "فشل تحديث تغييرات الملف.",
        fileActionUnavailable: "إجراءات تغييرات الملف غير متاحة.",
  ...
  newWorkspace: {
    ...
    newBranch: {
      accessibilityLabel: "اسم الفرع الجديد",
      placeholder: "فرع جديد",
      invalid: "أدخل اسم فرع صالحًا.",
    },
  },
  desktop: {
    quitting: {
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        newTerminal: "محطة جديدة",
        openScripts: "فتح البرامج النصية",
