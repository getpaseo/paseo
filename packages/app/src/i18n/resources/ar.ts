...
export const ar: TranslationResources = {
  ...
  sessions: {
    ...
    errors: {
      loadFailed: "تعذر تحميل الجلسات",
    },
    actions: {
      loadMore: "تحميل المزيد",
    },
    organization: {
      trigger: "عوامل تصفية السجل وفرزه",
      emptyFiltered: "لا توجد جلسات تطابق عوامل التصفية هذه",
      labels: {
        status: "الحالة",
        project: "المشروع",
        host: "المضيف",
      ...
      activity: {
        anyTime: "في أي وقت",
        today: "اليوم",
        pastSevenDays: "آخر 7 أيام",
        pastThirtyDays: "آخر 30 يومًا",
      },
      group: {
        lastActivity: "آخر نشاط",
        project: "المشروع",
      ...
      selection: {
        all: "الكل",
        oneSelected: "عنصر واحد محدد",
        selectedCount: "{{count}} عناصر محددة",
      },
      updateHost: "{{label}} · حدّث المضيف",
  ...
  agentList: {
    ...
    actions: {
      menuAccessibility: "إجراءات {{title}}",
      fallbackSession: "الجلسة",
      sheetTitle: "إجراءات الجلسة",
      updateHostToPin: "حدّث المضيف لتثبيت الجلسات",
      pin: "تثبيت الجلسة",
      unpin: "إلغاء تثبيت الجلسة",
      pinning: "جارٍ التثبيت...",
      unpinning: "جارٍ إلغاء التثبيت...",
      archive: "أرشفة الجلسة",
      updatePinFailed: "فشل تحديث تثبيت الجلسة",
    },
    dateSections: {
      recent: "مؤخرًا",
      today: "اليوم",
  ...
  sidebar: {
    ...
    organization: {
      ...
      labels: {
        ...
        workspaceLabel: "تصنيف مساحة العمل",
      },
      status: {
      ...
      actions: {
        ...
        newWorkspaceLabel: "تصنيف مساحة عمل جديد…",
        newWorkspaceLabelSelectHost: "تصنيف مساحة عمل جديد… · اختر مضيفًا واحدًا",
        clearFilters: "مسح عوامل التصفية",
        create: "إنشاء",
      },
      project: {
        ...
        moveToProjectGroup: "نقل إلى مجموعة مشاريع",
        noProjectGroup: "بلا مجموعة",
      },
      projectGroup: {
        modalTitle: "مجموعة مشاريع جديدة",
        placeholder: "اسم المجموعة",
        renameTitle: "إعادة تسمية مجموعة المشاريع",
        delete: "حذف مجموعة المشاريع",
        deleteMessage: 'هل تريد حذف "{{name}}"؟ لن تُحذف مشاريعها.',
        actionsAccessibility: "إجراءات مجموعة المشاريع {{name}}",
      },
      hiddenProjects: {
        title: "المشاريع المخفية",
        unhideAll: "إظهار الكل",
        empty: "لا توجد مشاريع مخفية",
        description: "لا تظهر المشاريع ومساحات العمل المخفية في الشريط الجانبي حتى تُظهرها.",
        showVisible: "إظهار العناصر الظاهرة",
      },
      sections: {
        hidden: "مخفية",
        workspaces: "مساحات العمل",
        projects: "المشاريع",
        pinnedProjects: "المشاريع المثبتة",
      },
      workspaceLabel: {
        modalTitle: "تصنيف مساحة عمل جديد",
        placeholder: "اسم التصنيف",
        none: "بلا تصنيف",
        unknown: "تصنيف غير معروف",
        renameTitle: "إعادة تسمية تصنيف مساحة العمل",
        delete: "حذف تصنيف مساحة العمل",
        deleteMessage: 'هل تريد حذف "{{name}}"؟ لن تُحذف مساحات العمل.',
        accessibility: "تصنيف مساحة العمل: {{label}}",
        actionsAccessibility: 'إجراءات تصنيف مساحة العمل "{{name}}"',
      },
      errors: {
        selectOneHost: "اختر مضيفًا واحدًا قبل إنشاء تصنيف لمساحة العمل",
        moveFailed: "فشل نقل مساحة العمل",
        createdMoveFailed: "تم إنشاء تصنيف مساحة العمل، لكن لم يتم نقل مساحة العمل",
        createdMoveFailedWithError:
          "تم إنشاء تصنيف مساحة العمل، لكن لم يتم نقل مساحة العمل: {{error}}",
        createFailed: "فشل إنشاء تصنيف مساحة العمل",
        hostDisconnected: "المضيف غير متصل",
        deleteWorkspaceLabelFailed: "فشل حذف تصنيف مساحة العمل",
      },
    },
    host: {
      noHost: "لا مضيف",
