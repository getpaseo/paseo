...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        modifiedFile: "معدّل",
        commits: {
          openHistory: "فتح علامة تبويب السجل",
          title: "الإيداعات",
  ...
  panels: {
    ...
    commitLog: {
      label: "السجل",
      subtitle: "سجل الإيداعات",
      tooltip: "تصفح سجل الإيداعات",
      directoryMissing: "لم يتم العثور على دليل مساحة العمل.",
      capabilityMissing: "حدّث المضيف لتصفح سجل الإيداعات.",
      connecting: "جارٍ الاتصال بالمضيف…",
      loading: "جارٍ تحميل السجل…",
      loadError: "تعذر تحميل سجل الإيداعات",
      empty: "لا توجد إيداعات بعد",
      loadMore: "تحميل المزيد",
      loadingMore: "جارٍ التحميل…",
      refresh: "تحديث",
      refreshing: "جارٍ التحديث",
      truncatedRefs: "يتم عرض الفروع والعلامات المحدّثة مؤخرًا فقط",
      cursorExpired: "تغيّر السجل أثناء التحميل. أُعيد التحميل من البداية.",
      scope: {
        head: "الفرع الحالي",
        all: "كل الفروع",
      },
