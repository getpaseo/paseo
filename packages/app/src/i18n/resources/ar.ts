  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        ...
        updateRequired: "حدّث هذا المضيف لإعداد نقاط نهاية المرحل",
        configure: "إعداد",
        configureTitle: "إعداد المرحل",
        enabled: "تفعيل المرحل",
        endpoint: "نقطة نهاية البرنامج الخفي",
        endpointHint: "العنوان الذي يستخدمه البرنامج الخفي للاتصال بصيغة host:port",
        useTls: "استخدام TLS لاتصال البرنامج الخفي",
        publicEndpoint: "نقطة النهاية العامة",
        publicEndpointHint: "العنوان المضمّن في روابط الاقتران بصيغة host:port",
        publicUseTls: "استخدام TLS للاتصال العام",
        controlledBy: "يتحكم {{env}} في هذا الإعداد. أزل تجاوز التشغيل لتعديله.",
        hostPortError: "أدخل عنوانًا بصيغة host:port من دون مخطط URL",
        save: "حفظ",
