  ...
  workspace: {
    ...
    browser: {
      ...
      annotate: {
        ...
        submit: "إرفاق",
        cancel: "إلغاء",
        reset: "استعادة الحالة الأصلية",
        adjust: "ضبط الخصائص",
        previewFailed: "تعذّر تحديث معاينة العنصر",
        groups: { content: "المحتوى", appearance: "المظهر", properties: "الخصائص" },
        fields: {
          checked: "محدد",
          value: "القيمة",
          text: "النص",
          alternativeText: "النص البديل",
          textColor: "لون النص",
          background: "الخلفية",
          font: "الخط",
          fontSize: "حجم الخط",
