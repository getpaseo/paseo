  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        submodule: {
          detached: "منفصل {{sha}}",
          notInitialized: "لم تتم تهيئة الوحدة الفرعية",
          unavailable: "نسخة العمل للوحدة الفرعية غير متاحة",
          added: "تمت إضافة الوحدة الفرعية",
          deleted: "تم حذف الوحدة الفرعية",
          historyUnavailable: "سجل التثبيتات للوحدة الفرعية غير متاح",
          headDiffers: "يختلف HEAD {{currentSha}} عن التثبيت المثبّت {{pinnedSha}}",
          emptyCommitted: "لا توجد تغييرات ملتزم بها",
        },
