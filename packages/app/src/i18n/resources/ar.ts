  ...
  workspace: {
    ...
    tabs: {
      ...
      confirmations: {
        ...
        bulk: {
          all: "سيؤدي هذا إلى إغلاق {{agents}} من علامات تبويب الوكيل، وإغلاق {{terminals}} من المحطات، وإغلاق {{tabs}} من علامات التبويب. سيتم إيقاف أي عملية جارية في محطة مغلقة على الفور.",
          agentsAndTerminals:
            "سيؤدي هذا إلى إغلاق {{agents}} من علامات تبويب الوكيل وإغلاق {{terminals}} من المحطات. سيتم إيقاف أي عملية جارية في محطة مغلقة على الفور.",
          terminalsAndTabs:
          ...
          agentsAndTabs:
            "سيؤدي هذا إلى إغلاق {{agents}} من علامات تبويب الوكيل وإغلاق {{tabs}} من علامات التبويب.",
          terminals:
          ...
          agents: "سيؤدي هذا إلى إغلاق {{agents}} من علامات تبويب الوكيل.",
        },
      },
    },
    header: {
