  ...
  settings: {
    ...
    host: {
      ...
      orchestration: {
        ...
        managedMcp: {
          title: "خوادم MCP الخارجية",
          hint: "حقن الخوادم المشتركة في كل وكيل متوافق يشغله هذا المضيف.",
          empty: "لم يتم إعداد أي خوادم MCP خارجية.",
          ...
          url: "عنوان URL",
          arguments: "المعاملات",
          argumentsHint: "أدخل معاملاً واحداً في كل سطر.",
          alwaysLoad: "تحميل الأدوات دائماً",
          alwaysLoadHint: "الاحتفاظ بجميع أدوات هذا الخادم في موجه الوكيل.",
          alwaysLoadAccessibility: "تحميل أدوات MCP دائماً",
          environmentVariables: "متغيرات البيئة",
          requestHeaders: "ترويسات الطلب",
          secretHint: "استخدم قيمة خاصة مباشرة أو مرجعاً إلى بيئة البرنامج الخفي.",
          add: "إضافة",
          directValue: "قيمة مباشرة",
          environmentSource: "البيئة",
          variable: "متغير",
          header: "ترويسة",
          environmentVariableName: "اسم متغير البيئة",
          value: "القيمة",
          keepValueHint: "اتركه فارغاً للاحتفاظ بالقيمة المعدّة.",
          save: "حفظ",
          test: "اختبار",
          edit: "تعديل",
          remove: "إزالة",
          enable: "تمكين {{name}}",
          connected: "تم الاتصال خلال {{latencyMs}} مللي ثانية · {{toolCount}} أداة",
          rejected: "رفض خادم MCP الاتصال.",
          duplicateName: "يوجد بالفعل خادم MCP باسم '{{name}}'.",
          updateFailed: "تعذر تحديث خادم MCP.",
          removeTitle: "إزالة خادم MCP؟",
          removeMessage: "إزالة '{{name}}' من كل وكيل يشغله هذا المضيف؟",
          removeFailed: "تعذرت إزالة خادم MCP.",
          testFailed: "تعذر اختبار خادم MCP.",
          saveFailed: "تعذر حفظ خادم MCP.",
          entryNameRequired: "يحتاج كل إدخال ترويسة أو بيئة إلى اسم.",
          envNameRequired: "يحتاج مرجع البيئة إلى اسم متغير.",
          directValueRequired: "لا يمكن أن تكون القيمة المباشرة فارغة.",
          uniqueEntries: "يجب أن تكون أسماء إدخالات الترويسات والبيئة فريدة.",
          nameRequired: "اسم الخادم مطلوب.",
          commandRequired: "الأمر مطلوب.",
          urlRequired: "عنوان URL مطلوب.",
          invalidUrl: "أدخل عنوان URL صالحاً لخادم MCP.",
          httpOnly: "يجب أن تستخدم عناوين خادم MCP بروتوكول HTTP أو HTTPS.",
        },
        systemPrompt: {
          title: "موجه النظام",
