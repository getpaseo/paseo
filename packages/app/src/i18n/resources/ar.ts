...
export const ar: TranslationResources = {
  ...
  plugins: {
    ...
    conflictsTitle: "امتدادات تطالب بها أكثر من إضافة",
    conflictLine: "{{extension}}: فازت {{winner}}، وتم تجاهل {{losers}}",
    views: {
      installed: "المثبتة",
      browse: "تصفّح",
    },
    ...
    errors: {
      ...
      entryMissing: "ملف دخول الإضافة مفقود.",
      previewFailed: "تعذّر على {{plugin}} عرض هذا الملف: {{reason}}",
      panelFailed: "تعذّر على {{plugin}} عرض هذه اللوحة: {{reason}}",
    },
  },
  settings: {
    title: "إعدادات",
