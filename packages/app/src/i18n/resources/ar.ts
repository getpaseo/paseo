...
export const ar: TranslationResources = {
  ...
  composer: {
    ...
    errors: {
      ...
      initialPromptRequired: "مطلوب موجه أولي",
  ...
  workspace: {
    ...
    tabs: {
      ...
      switcher: {
        trigger: "تبديل علامات التبويب (مفتوح {{count}})",
        title: "تبديل علامة التبويب",
        searchPlaceholder: "البحث في علامات التبويب",
      },
      menu: {
        ...
        closeLeft: "إغلاق علامات التبويب على اليسار",
        closeRight: "إغلاق علامات التبويب على اليمين",
        closeOthers: "إغلاق علامات التبويب الأخرى",
        reloadAgent: "إعادة تحميل الوكيل",
        reloadAgentTooltip: "أعد تحميل الوكيل لتحديث المهارات أو MCPs أو حالة تسجيل الدخول.",
        close: "إغلاق",
        renameTerminal: "إعادة تسمية الطرفية",
        renameAgent: "إعادة تسمية الوكيل",
      },
      actions: {
        newAgent: "وكيل جديد",
        newTerminal: "محطة طرفية جديدة",
        preparingTerminal: "إعداد علامة تبويب الطرفية",
        preparingTerminalTooltip: "جارٍ تحضير الطرفية...",
        newBrowser: "متصفح جديد",
        splitRight: "تقسيم الجزء إلى اليمين",
        splitDown: "تقسيم الجزء إلى الأسفل",
        terminalProfilesMenu: "ملفات تعريف الطرفية",
        editTerminalProfiles: "تحرير الملفات…",
        pinTarget: "تثبيت",
      ...
      toasts: {
        ...
        agentIdCopiedLabel: "معرّف الوكيل",
        resumeCommandCopiedLabel: "أمر الاستئناف",
        filePathCopiedLabel: "مسار الملف",
        resumeIdUnavailable: "معرّف الاستئناف غير متوفر",
        resumeCommandUnavailable: "أمر الاستئناف غير متوفر",
        reloadingAgent: "جارٍ إعادة تحميل الوكيل...",
        reloadedAgent: "تم إعادة تحميل الوكيل",
    ...
    scripts: {
      ...
      accessibility: {
        trigger: "برامج مساحة العمل النصية",
        openAt: "افتح {{scriptName}} في {{label}}",
        viewTerminal: "عرض طرفية {{scriptName}}",
        runScript: "تشغيل البرنامج النصي {{scriptName}}",
        script: "البرنامج النصي {{scriptName}}",
      },
      states: {
        exitCode: "الخروج {{code}}",
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        openNewWindowFailed: "تعذر فتح نافذة جديدة",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        pauseAndStop: "إيقاف مؤقت وإيقاف",
        registrationFailed:
          "تم بدء البرنامج الخفي المدمج، لكن Paseo لم يتمكن من حفظ اتصال localhost. قم بإيقاف تشغيل إدارة البرنامج الخفي وإعادة تشغيلها، أو أضف localhost يدويًا.",
        pausedStopFailed:
      ...
      keepRunning: {
        ...
        hint: "يستمر تشغيل البرنامج الخفي عند إنهاء Paseo",
      },
      logs: {
        title: "ملف السجل",
        modalTitle: "سجلات البرنامج الخفي",
      ...
      fullStatus: {
        title: "الوضع الكامل",
        modalTitle: "حالة البرنامج الخفي",
    ...
    updates: {
      status: {
        ...
        upToDateWithLastChecked: "محدّث. آخر تحقق في {{time}}.",
  ...
  settings: {
    ...
    general: {
      ...
      terminalScrollback: {
        label: "التمرير في الطرفية",
        description: "يتم الاحتفاظ بالأسطر في المخزن المؤقت للطرفية المدمجة",
        accessibilityLabel: "أسطر التمرير في الطرفية",
      },
      language: {
        label: "لغة",
    ...
    diagnostics: {
      ...
      playTest: "تشغيل الاختبار",
      playing: "جارٍ التشغيل...",
      playbackFailed: "فشل التشغيل: {{message}}",
      app: {
        title: "تشخيص التطبيق",
        rowTitle: "تشخيص التطبيق",
        rowHint: "جمع تفاصيل الاتصال والبرنامج الخفي ومزود الخدمة وسطح المكتب والسجلات",
        run: "تشغيل",
    ...
    appearance: {
      theme: {
        title: "سمة",
        accessibilityLabel: "السمة: {{value}}",
        options: {
          light: "فاتح",
          dark: "داكن",
          zinc: "زنك",
      ...
      syntax: {
        title: "بناء الجملة",
        highlightTheme: "سمة التمييز",
        highlightThemeHint: "ألوان التعليمات البرمجية، مستقلة عن سمة التطبيق",
        highlightThemeAccessibility: "سمة التمييز: {{value}}",
        previewAccessibility: "معاينة مباشرة لسمة بناء الجملة وخط التعليمات البرمجية",
      },
    },
    shortcuts: {
    ...
    integrations: {
      ...
      skills: {
        ...
        uninstallMessage: "يزيل جميع مهارات تنسيق Paseo من ~/.agents و ~/.claude و ~/.codex.",
      },
      actions: {
        install: "تثبيت",
        installing: "جارٍ التثبيت...",
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        addProfileTitle: "إضافة ملف تعريف للطرفية",
        editProfileTitle: "تحرير ملف تعريف الطرفية",
        ...
        argsHint: "وسائط مفصولة بمسافات تُمرر إلى الأمر",
        saving: "جارٍ الحفظ...",
        remove: "إزالة",
        ...
        save: "حفظ",
        emptyState: "لا توجد ملفات تعريف بعد. أضف واحدًا لتشغيل الطرفية بأمر محدد.",
      },
      daemon: {
        rename: {
          editLabel: "تحرير التسمية",
          title: "إعادة تسمية المضيف",
          placeholder: "المضيف الخاص بي",
          submit: "إعادة تسمية",
        },
        restart: {
          ...
          unavailableTitle: "المضيف غير متوفر",
          unavailableMessage:
            "هذا المضيف غير متصل. انتظر حتى يصبح متصلاً بالإنترنت قبل إعادة التشغيل.",
          offlineTitle: "المضيف غير متصل",
          offlineMessage:
            "هذا المضيف غير متصل. يقوم Paseo بإعادة الاتصال تلقائيًا - انتظر حتى يعود متصلاً بالإنترنت قبل إعادة التشغيل.",
        ...
        update: {
          title: "تحديث البرنامج الخفي",
          hint: "قم بتحديث البرنامج الخفي إلى أحدث إصدار وإعادة تشغيله",
          confirm: "تحديث",
          confirmTitle: "تحديث {{name}}",
          confirmMessage:
            "سيؤدي هذا إلى تحديث البرنامج الخفي إلى أحدث إصدار وإعادة تشغيله. سيتم مقاطعة الوكلاء قيد التشغيل لفترة وجيزة.",
          updating: "جارٍ التحديث...",
          phaseStarting: "جارٍ التحضير للتحديث...",
          phaseDownloading: "جارٍ تنزيل الحزم...",
          phaseInstalling: "جارٍ التثبيت...",
          phaseComplete: "اكتمل التحديث، جارٍ إعادة التشغيل...",
          unableToReconnectTitle: "غير قادر على إعادة الاتصال",
          unableToReconnectMessage:
            "لم يعد {{name}} متصلاً بالإنترنت بعد التحديث. يرجى التحقق من إعادة تشغيل البرنامج الخفي.",
          unavailableTitle: "المضيف غير متوفر",
          unavailableMessage: "هذا المضيف غير متصل. انتظر حتى يعود متصلاً بالإنترنت قبل التحديث.",
          offlineTitle: "المضيف غير متصل",
          offlineMessage: "هذا المضيف غير متصل. انتظر حتى يعود متصلاً بالإنترنت قبل التحديث.",
          requestFailedTitle: "فشل التحديث",
          requestFailedMessage: "فشل تحديث البرنامج الخفي: {{error}}",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد التحديث.",
        },
        ...
        remove: {
          ...
          localConfirmMessage:
            "سيؤدي هذا إلى إزالة اتصال localhost وإيقاف إدارة البرنامج الخفي المدمج ووقف البرنامج الخفي المُدار. تظل المضيفات البعيدة متصلة.",
          errorTitle: "خطأ",
    ...
    providers: {
      ...
      models: {
        ...
        modelIdPlaceholder: "على سبيل المثال openai/gpt-5",
        add: "إضافة",
        adding: "جارٍ الإضافة...",
    ...
    project: {
      ...
      worktree: {
        ...
        docs: "الوثائق",
        docsTooltip: "راجع الوثائق لمزيد من التفاصيل ومتغيرات البيئة المتاحة لهذه الأوامر",
        setup: "إعداد",
      ...
      metadata: {
        ...
        branchName: "أسماء الفروع",
        branchNamePlaceholder: "بادئة الفروع بـ feat/ أو fix/، mb/ للفروع الشخصية",
        commitMessage: "رسائل الالتزام",
        commitMessagePlaceholder: "استخدم الالتزامات التقليدية مع نطاق",
        pullRequest: "طلبات السحب",
        pullRequestPlaceholder: "ابدأ بملخص من فقرة واحدة، وتضمين قسم لخطة الاختبار",
      },
      writeFailures: {
