...
export const ar: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      imagePreviewHint: "اضغط للفتح. اضغط مطولاً للحفظ.",
      imageSaving: "جارٍ حفظ الصورة…",
      imageSaved: "تم الحفظ في الصور",
      imageSavePermissionDenied: "اسمح بالوصول إلى الصور لحفظ هذه الصورة.",
      imageSaveFailed: "تعذر حفظ الصورة",
