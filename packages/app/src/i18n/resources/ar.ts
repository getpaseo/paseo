...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    tabs: {
      ...
      actions: {
        ...
        editTerminalProfiles: "تعديل ملفات التعريف…",
        pinTarget: "تثبيت",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        markReadFailed: "فشل تعليم مساحة العمل كمقروءة",
  ...
  newWorkspace: {
    ...
    projectPicker: {
      ...
      accessibilityLabel: "مشروع مساحة العمل",
    },
    hostPicker: {
      title: "المضيف",
      fallbackLabel: "المضيف",
    },
    isolation: {
      local: "محلي",
      worktree: "شجرة عمل جديدة",
      label: "العزل",
      accessibilityLabel: "عزل مساحة العمل",
    },
    fields: {
      project: "المشروع",
      base: "الأساس",
    ...
    errors: {
      chooseProject: "اختر مشروعًا",
      chooseHostForProject: "اختر مضيفًا لهذا المشروع",
      hostDisconnected: "Host غير متصل",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        registrationFailed:
          "تم تشغيل Daemon المدمج، لكن تعذّر على Paseo حفظ اتصال localhost. أوقف إدارة Daemon ثم أعد تشغيلها، أو أضف localhost يدويًا.",
        pausedStopFailed:
    ...
    updates: {
      status: {
        ...
        upToDateWithLastChecked: "محدَّث. آخر فحص في {{time}}.",
  ...
  settings: {
    ...
    diagnostics: {
      ...
      notification: {
        rowTitle: "الإشعارات",
        rowHint: "تحقق من الإذن وأرسل إشعار اختبار",
        sendTest: "إرسال اختبار",
        sending: "جارٍ الإرسال...",
        sent: "تم إرسال إشعار الاختبار.",
        notDelivered: "لم يتم تسليم الإشعار. تحقق من إعدادات الإشعارات في المتصفح أو النظام.",
        failed: "فشل إرسال الإشعار.",
      },
      app: {
        title: "تشخيص التطبيق",
        rowTitle: "تشخيص التطبيق",
        rowHint: "جمع تفاصيل الاتصال وDaemon والمزود وسطح المكتب والإشعارات والسجلات",
        run: "تشغيل",
    ...
    host: {
      ...
      workspaces: {
        ...
        autoArchiveAfterMerge: {
          ...
          updateFailedTitle: "تعذّر تحديث مساحات العمل",
        },
      },
      browserTools: {
        title: "أدوات المتصفح",
        hint: "اسمح للوكلاء بالوصول إلى علامات تبويب متصفح Paseo والتحكم فيها، بما في ذلك حالة تسجيل الدخول. فعّل هذا فقط للوكلاء الذين تثق بهم.",
      ...
      terminalAgents: {
        ...
        enableHooks: {
          ...
          hint: "احصل على الإشعارات والحالة من وكلاء الطرفية. يثبت هذا خطافات في ملفات إعداد الوكيل.",
      ...
      terminalProfiles: {
        ...
        argsHint: "وسائط مفصولة بمسافات تُمرَّر إلى الأمر",
        saving: "جارٍ الحفظ...",
        remove: "إزالة",
        removeConfirmTitle: "إزالة ملف التعريف؟",
      ...
      daemon: {
        ...
        update: {
          ...
          title: "تحديث Daemon",
          hint: "حدّث Daemon إلى أحدث إصدار وأعد تشغيله",
          confirm: "تحديث",
          confirmTitle: "تحديث {{name}}",
          confirmMessage:
            "سيؤدي هذا إلى تحديث Daemon إلى أحدث إصدار وإعادة تشغيله. ستتقطع الوكلاء قيد التشغيل لفترة وجيزة.",
          updating: "جارٍ التحديث...",
          phaseStarting: "جارٍ إعداد التحديث...",
          phaseDownloading: "جارٍ تنزيل الحزم...",
          phaseInstalling: "جارٍ التثبيت...",
          phaseComplete: "اكتمل التحديث، جارٍ إعادة التشغيل...",
          unableToReconnectTitle: "تعذّر إعادة الاتصال",
          unableToReconnectMessage:
            "لم يعد {{name}} متصلًا بعد التحديث. يُرجى التحقق من إعادة تشغيل Daemon.",
          unavailableTitle: "المضيف غير متاح",
          unavailableMessage: "هذا المضيف غير متصل. انتظر حتى يصبح متصلًا قبل التحديث.",
          offlineTitle: "المضيف غير متصل",
          offlineMessage: "هذا المضيف غير متصل. انتظر حتى يعود متصلًا قبل التحديث.",
          requestFailedTitle: "فشل التحديث",
          requestFailedMessage: "فشل تحديث Daemon: {{error}}",
        ...
        remove: {
          ...
          localHint: "يزيل localhost من هذا الجهاز ويوقف Daemon المدمج",
          localConfirmTitle: "إزالة اتصال localhost وإيقاف Daemon؟",
          confirmMessage: "إزالة{{name}}؟ سيؤدي هذا إلى حذف اتصالاته المحفوظة.",
          localConfirmMessage:
            "سيؤدي هذا إلى إزالة اتصال localhost، وإيقاف إدارة Daemon المدمجة، وإيقاف Daemon المُدار. تبقى المضيفات البعيدة متصلة.",
          errorTitle: "خطأ",
          errorMessage: "غير قادر على إزالة المضيف",
          localErrorMessage: "تعذّر إزالة اتصال localhost",
        },
      },
    },
    providers: {
      ...
      loading: "تحميل...",
      addErrorTitle: "تعذّر إضافة المزود",
      ...
      remove: {
        ...
        confirmMessage: "يحذف هذا إدخال المزود من config.json. لا يمكن التراجع عنه.",
        confirm: "إزالة",
        errorTitle: "تعذّر إزالة المزود",
      },
      statuses: {
        disabled: "عاجز",
        loading: "تحميل",
  ...
  providerUsage: {
    ...
    justNow: "الآن",
    agoMinutes: "منذ {{count}}د",
    agoHours: "منذ {{count}}س",
    agoDays: "منذ {{count}}ي",
    resettingNow: "يُعاد التعيين الآن",
    ...
    errors: {
      grokNetwork:
        "تعذّر الوصول إلى واجهة فوترة Grok. تحقق من إمكانية الوصول إلى cli-chat-proxy.grok.com (غالبًا ما تحظره قواعد الوكيل/VPN).",
    },
  },
  addProjectFlow: {
    titles: {
      chooseHost: "اختر المضيف",
      addProject: "إضافة مشروع",
      searchDirectory: "البحث عن دليل",
      cloneGithub: "استنساخ من GitHub",
      chooseDestination: "اختر الوجهة",
      chooseParent: "اختر الدليل الأب",
      nameDirectory: "تسمية الدليل",
    },
    placeholders: {
      searchHosts: "ابحث في المضيفات...",
      searchMethods: "ابحث في الطرق...",
      searchDirectories: "ابحث في الأدلة أو أدخل مسارًا...",
      searchGithub: "ابحث أو أدخل مستودع GitHub...",
      searchParents: "ابحث في الأدلة الأب أو أدخل مسارًا...",
      directoryName: "اسم الدليل",
    },
    methods: {
      searchDirectory: "البحث عن دليل",
      searchDirectoryDescription: "ابحث عن دليل على {{host}}",
      browse: "تصفّح",
      browseDescription: "اختر أو أنشئ دليلاً في Finder",
      github: "استنساخ من GitHub",
      githubDescriptionSearch: "ابحث عن المشاريع المتاحة لحساب GitHub الخاص بك",
      githubDescriptionManual: "أدخل رابط GitHub أو owner/repo",
      githubDescriptionUpgrade: "حدّث هذا المضيف لاستنساخ مستودعات GitHub",
      newDirectory: "دليل جديد",
      newDirectoryDescription: "إنشاء دليل فارغ على {{host}}",
      newDirectoryDescriptionUpgrade: "حدّث هذا المضيف لإنشاء الأدلة",
    },
    empty: {
      noHosts: "لا توجد مضيفات متصلة",
      noMatching: "لا توجد خيارات مطابقة",
      enterGithub: "أدخل رابط GitHub أو owner/repo",
    ...
    progress: {
      ...
      creating: "جارٍ إنشاء الدليل...",
      loading: "جارٍ التحميل...",
    },
    rows: {
      addHost: "إضافة مضيف",
      openThisPath: "فتح هذا المسار",
      useThisParent: "استخدام هذا الأب",
      existingProject: "مشروع موجود · {{path}}",
      alreadyExists: "موجود بالفعل",
      parentDirectory: "الدليل الأب: {{path}}",
      cloneRepositoryUrl: "استنساخ رابط المستودع هذا",
      cloneViaProtocol: "استنساخ owner/repo عبر {{protocol}}",
      viaProtocol: "{{name}} عبر {{protocol}}",
    },
    errors: {
      hostUnavailable: "المضيف غير متاح",
      directoryNotFound: "لم يتم العثور على الدليل",
      unableToAdd: "تعذّر إضافة المشروع",
      unableToBrowse: "تعذّر تصفّح دليل",
      unableToClone: "تعذّر استنساخ المستودع",
      unableToCreateDirectory: "تعذّر إنشاء الدليل",
      enterDirectoryName: "أدخل اسم الدليل",
      unableToSearchDirectories: "تعذّر البحث في الأدلة",
      unableToSearchGithub: "تعذّر البحث في مستودعات GitHub",
      githubUnavailable: "بحث GitHub غير متاح",
    },
    accessibility: {
      back: "رجوع",
      page: "إضافة مشروع: {{kind}}",
    },
  },
  schedules: {
    screen: {
    ...
    actions: {
      ...
      seeDocs: "عرض المستندات",
    },
    empty: {
      noActive: "لا توجد جداول نشطة",
      description: "تشغّل الجداول الوكلاء وفق إيقاع محدد.",
      noEnded: "لا توجد جداول منتهية",
    },
    errors: {
      unableToLoad: "تعذّر تحميل الجداول",
      hostLoadFailed: "{{serverName}}: تعذّر تحميل الجداول",
    },
    row: {
      created: "تم الإنشاء {{time}}",
      lastRun: "آخر تشغيل {{time}}",
      neverRun: "لم يُشغَّل مطلقًا",
      nextRun: "التشغيل التالي {{time}}",
      status: {
        active: "نشط",
        paused: "متوقف مؤقتًا",
        expired: "منتهٍ الصلاحية",
        finished: "مكتمل",
        targetGone: "الهدف غير موجود",
      },
      menu: {
        actions: "إجراءات {{productName}}",
        edit: "تعديل {{productName}}",
        editRow: "تعديل {{productName}} {{title}}",
        ...
        runNow: "تشغيل الآن",
        starting: "جارٍ البدء...",
        delete: "حذف {{productName}}",
        deleting: "جارٍ الحذف...",
      },
    },
    delete: {
      title: "حذف {{productName}}",
      message: 'حذف "{{title}}"؟ لا يمكن التراجع عن هذا.',
      confirm: "حذف",
    },
    form: {
      titleCreate: "جدول جديد",
      titleEdit: "تعديل الجدول",
      titleEditHeartbeat: "تعديل النبضة",
      cancel: "إلغاء",
      ...
      fields: {
        ...
        nameAccessibility: "اسم الجدول",
        prompt: "الموجّه",
        promptPlaceholder: "ماذا يجب أن يفعل الوكيل في كل تشغيل؟",
        maxRuns: "الحد الأقصى للتشغيلات",
        maxRunsPlaceholder: "غير محدود",
        maxRunsAccessibility: "الحد الأقصى للتشغيلات",
        host: "المضيف",
        hostPlaceholder: "اختر المضيف",
        hostEmpty: "لم يتم العثور على مضيفات",
        project: "المشروع",
        projectPlaceholder: "اختر المشروع",
        projectEmpty: "لم يتم العثور على مشاريع",
        projectHint: "اختر مضيفًا أولاً.",
        projectSearch: "ابحث في المشاريع...",
        projectTitle: "اختر المشروع",
        model: "النموذج",
        thinking: "التفكير",
        thinkingPlaceholder: "اختر التفكير",
        thinkingEmpty: "لم يتم العثور على خيارات تفكير",
        thinkingTitle: "اختر التفكير",
        mode: "الوضع",
        modePlaceholder: "الوضع الافتراضي",
        modeEmpty: "لم يتم العثور على أوضاع",
        modeHint: "لا تتوفر أوضاع لهذا النموذج.",
        modeTitle: "اختر الوضع",
        archiveOnFinish: "الأرشفة عند الانتهاء",
        isolation: "العزل",
        isolationPlaceholder: "اختر العزل",
        isolationEmpty: "لم يتم العثور على خيارات عزل",
        isolationLocal: "محلي",
    ...
    cadence: {
      ...
      presets: {
        ...
        everyHour: "كل ساعة",
        daily9: "يوميًا 9:00",
        weekdays9: "أيام العمل 9:00",
        mondays9: "الاثنين 9:00",
        custom: "Cron مخصص",
      },
    },
    format: {
      untitled: "{{productName}} بلا عنوان",
      everyMinute: "كل دقيقة",
      everyHour: "كل ساعة",
      everyHourAt: "كل ساعة عند :{{minutes}}",
      everyInterval: "كل {{count}} {{unit}}",
      unitMinute: "دقيقة",
      unitMinutes: "دقائق",
      unitHour: "ساعة",
      unitHours: "ساعات",
      ...
      dayPlural: "{{day}}",
      atTime: "{{when}} في {{time}} {{timezone}}",
      soon: "قريبًا",
      inMinutes: "خلال {{count}}د",
      inHours: "خلال {{count}}س",
      inDays: "خلال {{count}}ي",
      enterCron: "أدخل تعبير cron",
      invalidCron: "{{detail}} غير صالح",
      days: {
        sunday: "الأحد",
        monday: "الاثنين",
        tuesday: "الثلاثاء",
