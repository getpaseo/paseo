  ...
  settings: {
    ...
    project: {
      ...
      scripts: {
        ...
        urlAccessibility: "عنوان URL للرابط",
        nameRequired: "الاسم مطلوب",
        commandRequired: "الأمر مطلوب",
        urlRequired: "عنوان URL مطلوب",
        urlInvalid: "أدخل عنوان URL يبدأ بـ HTTP أو HTTPS",
        newScript: "نص جديد",
        ...
        openUrlHint: "يفتح في متصفح العميل. استخدم {workspacePath} لمسار شجرة العمل أو المجلد.",
        openUrlUpdateHost: "حدّث مضيف Paseo هذا لإضافة روابط المتصفح.",
        actions: {
