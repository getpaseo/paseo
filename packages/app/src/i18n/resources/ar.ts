...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    general: {
      title: "عام",
      configBackup: {
        title: "نسخة احتياطية للإعدادات",
        label: "تصدير الإعدادات أو استيرادها",
        description:
          "المشاريع والأيقونات المخصصة وترتيب الشريط الجانبي والتفضيلات. لا تشمل الجلسات أو بيانات الاعتماد أو محتويات المستودعات.",
        unavailable: "اتصل بمضيف محدّث لتصدير الإعدادات أو استيرادها.",
        export: "تصدير",
        import: "استيراد",
        confirmTitle: "استيراد الإعدادات؟",
        confirmMessage: "سيتم دمج المشاريع والتفضيلات في تثبيت Paseo هذا. لن تُحذف المشاريع الحالية.",
        successTitle: "نسخة احتياطية للإعدادات",
        exportSuccess: "تم تصدير الإعدادات.",
        importSuccess:
          "تمت إضافة {{added}} مشروعًا وتحديث {{updated}} وتخطي {{skipped}}. سيُعاد تحميل Paseo لتطبيق التفضيلات.",
        errorTitle: "فشلت النسخة الاحتياطية للإعدادات",
      },
      browserData: {
