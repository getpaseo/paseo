...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        messageLabel: "رسالة الإيداع",
        placeholder: "صف تغييراتك",
        generate: "توليد",
        generating: "جارٍ التوليد...",
        generationFailed: "تعذر إنشاء رسالة الإيداع.",
        generationUnsupported: "قم بتحديث المضيف لإنشاء رسائل الإيداع.",
        selectAll: "تحديد كل التغييرات",
        selectedCount: "تم تحديد {{count}} من {{total}}",
        selectAtLeastOne: "حدد ملفًا واحدًا على الأقل للإيداع.",
        includeFile: "تضمين {{path}} في الإيداع",
        discardFile: "تجاهل التغييرات في {{path}}",
        commitFailed: "تعذر إيداع التغييرات.",
      },
      sourceControl: {
        staged: "التغييرات المدرجة",
        unstaged: "التغييرات",
        stage: "إدراج",
        unstage: "إلغاء الإدراج",
        stageAll: "إدراج الكل",
        unstageAll: "إلغاء إدراج الكل",
        stageFile: "إدراج {{path}}",
        unstageFile: "إلغاء إدراج {{path}}",
        stageBeforeCommit: "أدرج الملفات قبل الإيداع.",
        indexUpdateFailed: "تعذر تحديث التغييرات المدرجة.",
        resizeSections: "تغيير حجم الأقسام المدرجة وغير المدرجة",
      },
      diff: {
