    ...
    git: {
      ...
      pr: {
        ...
        reviewComments: {
          ...
          loading: "جارٍ تحميل تعليقات المراجعة…",
          empty: "لا توجد تعليقات مراجعة غير محلولة.",
          hostUpdateRequired: "قم بتحديث المضيف لاستخدام تعليقات مراجعة طلب السحب.",
          fixWithAgent: "إصلاح {{count}} تعليق باستخدام الوكيل",
          fixWithAgentPlural: "إصلاح {{count}} تعليقات باستخدام الوكيل",
          replies: "{{count}} رد",
          repliesPlural: "{{count}} ردود",
          noActiveAgent: "افتح وكيلاً في مساحة العمل هذه لإصلاح تعليقات المراجعة.",
          errors: {
            missingCli:
              "يتطلب الأمر GitHub CLI لجلب تعليقات مراجعة طلب السحب. ثبّت gh على المضيف ثم أعد المحاولة.",
            authRequired: "لم تتم مصادقة GitHub CLI. شغّل gh auth login على المضيف ثم أعد المحاولة.",
            forbidden: "لا يمكن لـ GitHub CLI الوصول إلى طلب السحب هذا. تحقق من أذونات المستودع.",
            notFound: "تعذّر تحميل تعليقات مراجعة طلب السحب لمساحة العمل هذه.",
            unknown: "تعذّر تحميل تعليقات مراجعة طلب السحب لمساحة العمل هذه.",
          },
        },
      },
    },
