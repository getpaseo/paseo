  ...
  settings: {
    ...
    project: {
      ...
      scripts: {
        ...
        urlAccessibility: "URL du lien",
        nameRequired: "Le nom est requis",
        commandRequired: "La commande est requise",
        urlRequired: "L’URL est requise",
        urlInvalid: "Saisissez une URL HTTP ou HTTPS",
        ...
        openUrlHint:
          "S’ouvre dans le navigateur du client. Utilisez {workspacePath} pour le chemin de l’arbre de travail ou du dossier.",
        openUrlUpdateHost: "Mettez à jour cet hôte Paseo pour ajouter des liens de navigateur.",
        actions: {
