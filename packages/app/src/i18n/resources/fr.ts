  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        ...
        generationFailed: "Impossible de générer un message de commit.",
        generationUnsupported: "Mettez à jour l'hôte pour générer des messages de commit.",
        selectAll: "Sélectionner toutes les modifications",
        selectedCount: "{{count}} sur {{total}} sélectionnés",
        selectAtLeastOne: "Sélectionnez au moins un fichier à commiter.",
        includeFile: "Inclure {{path}} dans le commit",
        discardFile: "Annuler les modifications dans {{path}}",
        commitFailed: "Impossible de commiter les modifications.",
      },
      sourceControl: {
        ...
        stageFile: "Indexer {{path}}",
        unstageFile: "Désindexer {{path}}",
        stageBeforeCommit: "Indexez les fichiers avant de commiter.",
        indexUpdateFailed: "Impossible de mettre à jour les modifications indexées.",
        resizeSections: "Redimensionner les sections indexées et non indexées",
      },
      diff: {
