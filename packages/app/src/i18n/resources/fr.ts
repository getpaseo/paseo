...
export const fr: TranslationResources = {
  ...
  sessions: {
    ...
    organization: {
      trigger: "Filtres et tri de l’historique",
      emptyFiltered: "Aucune session ne correspond à ces filtres",
      labels: {
        status: "Statut",
        project: "Projet",
        host: "Hôte",
      ...
      status: { active: "Actives", archived: "Archivées" },
      activity: {
        anyTime: "À tout moment",
        today: "Aujourd’hui",
        pastSevenDays: "7 derniers jours",
        pastThirtyDays: "30 derniers jours",
      },
      group: { lastActivity: "Dernière activité", project: "Projet", none: "Aucun" },
      sort: {
      ...
      updateHost: "{{label}} · Mettre à jour l’hôte",
      clearFilters: "Effacer les filtres",
    },
  },
  agentList: {
    fallbackTitle: "Nouvelle séance",
    sections: { pinned: "Épinglées" },
    actions: {
      menuAccessibility: "Actions pour {{title}}",
      fallbackSession: "la session",
      sheetTitle: "Actions de la session",
      updateHostToPin: "Mettez à jour l’hôte pour épingler des sessions",
      pin: "Épingler la session",
      unpin: "Désépingler la session",
      pinning: "Épinglage...",
      unpinning: "Désépinglage...",
      archive: "Archiver la session",
      updatePinFailed: "Impossible de mettre à jour l’épinglage de la session",
    },
    dateSections: {
      recent: "Récent",
      today: "Aujourd'hui",
  ...
  sidebar: {
    ...
    organization: {
      ...
      labels: {
        ...
        workspaceLabel: "Libellé d’espace de travail",
      },
      status: {
        needsInput: "Intervention requise",
        working: "En cours",
        readyToReview: "Prêt à vérifier",
        failed: "Échec",
        done: "Terminé",
      },
      visibility: { visible: "Visible", hidden: "Masqué" },
      activity: {
        anyTime: "À tout moment",
        today: "Aujourd’hui",
        pastSevenDays: "7 derniers jours",
      ...
      workspaceTitle: { title: "Titre", branchName: "Nom de la branche" },
      selection: {
        all: "Tous",
        oneSelected: "1 sélectionné",
        selectedCount: "{{count}} sélectionnés",
      ...
      actions: {
        ...
        newWorkspaceLabel: "Nouveau libellé d’espace de travail…",
        newWorkspaceLabelSelectHost: "Nouveau libellé d’espace de travail… · Sélectionnez un hôte",
        clearFilters: "Effacer les filtres",
        create: "Créer",
      },
      project: {
        ...
        moveToProjectGroup: "Déplacer vers le groupe de projets",
        noProjectGroup: "Aucun groupe",
      },
      projectGroup: {
        modalTitle: "Nouveau groupe de projets",
        placeholder: "Nom du groupe",
        renameTitle: "Renommer le groupe de projets",
        delete: "Supprimer le groupe de projets",
        deleteMessage: "Supprimer « {{name}} » ? Ses projets ne seront pas supprimés.",
        actionsAccessibility: "Actions du groupe de projets {{name}}",
      },
      hiddenProjects: {
        title: "Projets masqués",
        unhideAll: "Tout afficher",
        empty: "Aucun projet masqué",
        description:
          "Les projets et espaces de travail masqués restent absents de la barre latérale jusqu’à leur réaffichage.",
        showVisible: "Afficher les éléments visibles",
      },
      sections: {
        hidden: "Masqués",
      ...
      workspaceLabel: {
        modalTitle: "Nouveau libellé d’espace de travail",
        placeholder: "Nom du libellé",
        none: "Aucun libellé",
        unknown: "Libellé inconnu",
        renameTitle: "Renommer le libellé d’espace de travail",
        delete: "Supprimer le libellé d’espace de travail",
        deleteMessage: "Supprimer « {{name}} » ? Ses espaces de travail ne seront pas supprimés.",
        accessibility: "Libellé d’espace de travail : {{label}}",
        actionsAccessibility: "Actions du libellé d’espace de travail {{name}}",
      },
      errors: {
        selectOneHost: "Sélectionnez un hôte avant de créer un libellé d’espace de travail",
        moveFailed: "Impossible de déplacer l’espace de travail",
        createdMoveFailed: "Le libellé a été créé, mais l’espace de travail n’a pas été déplacé",
        createdMoveFailedWithError:
          "Le libellé a été créé, mais l’espace de travail n’a pas été déplacé : {{error}}",
        createFailed: "Impossible de créer le libellé d’espace de travail",
        hostDisconnected: "L’hôte n’est pas connecté",
        deleteWorkspaceLabelFailed: "Impossible de supprimer le libellé d’espace de travail",
      },
    },
    host: {
      noHost: "Aucun hôte",
