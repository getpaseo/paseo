  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        submodule: {
          detached: "détaché {{sha}}",
          notInitialized: "Le sous-module n’est pas initialisé",
          unavailable: "Le checkout du sous-module est indisponible",
          added: "Le sous-module a été ajouté",
          deleted: "Le sous-module a été supprimé",
          historyUnavailable: "L’historique des commits du sous-module est indisponible",
          headDiffers: "HEAD {{currentSha}} diffère du commit épinglé {{pinnedSha}}",
          emptyCommitted: "Aucune modification validée",
        },
