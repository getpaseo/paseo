    ...
    host: {
      ...
      orchestration: {
        ...
        managedMcp: {
          ...
          hint: "Injecte les serveurs partagés dans chaque agent compatible lancé par cet hôte.",
          empty: "Aucun serveur MCP externe configuré.",
          ...
          url: "URL",
          arguments: "Arguments",
          argumentsHint: "Saisissez un argument par ligne.",
          alwaysLoad: "Toujours charger les outils",
          alwaysLoadHint: "Conserve tous les outils de ce serveur dans le prompt de l’agent.",
          alwaysLoadAccessibility: "Toujours charger les outils MCP",
          environmentVariables: "Variables d’environnement",
          requestHeaders: "En-têtes de requête",
          secretHint: "Utilisez une valeur privée directe ou référencez l’environnement du daemon.",
          add: "Ajouter",
          directValue: "Valeur directe",
          environmentSource: "Environnement",
          variable: "Variable",
          header: "En-tête",
          environmentVariableName: "Nom de la variable d’environnement",
          value: "Valeur",
          keepValueHint: "Laissez vide pour conserver la valeur configurée.",
          save: "Enregistrer",
          test: "Tester",
          edit: "Modifier",
          remove: "Supprimer",
          enable: "Activer {{name}}",
          connected: "Connecté en {{latencyMs}} ms · {{toolCount}} outils",
          rejected: "Le serveur MCP a refusé la connexion.",
          duplicateName: "Un serveur MCP nommé « {{name}} » existe déjà.",
          updateFailed: "Impossible de mettre à jour le serveur MCP.",
          removeTitle: "Supprimer le serveur MCP ?",
          removeMessage: "Supprimer « {{name}} » de chaque agent lancé par cet hôte ?",
          removeFailed: "Impossible de supprimer le serveur MCP.",
          testFailed: "Impossible de tester le serveur MCP.",
          saveFailed: "Impossible d’enregistrer le serveur MCP.",
          entryNameRequired: "Chaque en-tête ou entrée d’environnement doit avoir un nom.",
          envNameRequired: "Une référence d’environnement doit avoir un nom de variable.",
          directValueRequired: "Une valeur directe ne peut pas être vide.",
          uniqueEntries: "Les noms d’en-têtes et d’entrées d’environnement doivent être uniques.",
          nameRequired: "Le nom du serveur est requis.",
          commandRequired: "La commande est requise.",
          urlRequired: "L’URL est requise.",
          invalidUrl: "Saisissez une URL de serveur MCP valide.",
          httpOnly: "Les URL de serveur MCP doivent utiliser HTTP ou HTTPS.",
        },
        systemPrompt: {
