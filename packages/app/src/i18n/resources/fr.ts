...
export const fr: TranslationResources = {
  ...
  plugins: {
    ...
    conflictsTitle: "Extensions de fichier revendiquées par plusieurs extensions",
    conflictLine: "{{extension}} : {{winner}} l'emporte, {{losers}} ignorée",
    views: {
    ...
    errors: {
      ...
      entryMissing: "Le fichier d'entrée de l'extension est manquant.",
      previewFailed: "{{plugin}} n'a pas pu afficher ce fichier : {{reason}}",
      panelFailed: "{{plugin}} n'a pas pu afficher ce panneau : {{reason}}",
    },
  },
  settings: {
    title: "Paramètres",
