...
export const fr: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      videoPreviewUnavailable: "Aperçu de la vidéo indisponible.",
      videoPreviewLoadFailed: "Impossible de charger l'aperçu de la vidéo.",
      videoPlaybackUnsupported: "La lecture vidéo n'est pas disponible sur cette plateforme.",
      review: "Revue",
