...
export const fr: TranslationResources = {
  ...
  message: {
    ...
    turnFooter: {
      ...
      endedAt: "{{duration}}, terminé à {{time}}",
    },
  },
  toolCall: {
    displayNames: {
      ...
      search: "Recherche",
      fetch: "Récupération",
      worktreeSetup: "Configuration du worktree",
      task: "Tâche",
      thinking: "Réflexion",
      terminal: "Terminal",
      plan: "Plan",
  ...
  workspace: {
    route: {
      ...
      browserTabTitle: "Espace de travail",
      connecting: "De liaison",
  ...
  sidebar: {
    ...
    workspace: {
      sectionTitle: "Espaces de travail",
      ...
      titleSource: "Titre",
      branchSource: "Nom de la branche",
      groupByProject: "Projet",
      groupByStatus: "Statut",
      projectIcons: "Icônes de projet",
      projectIconsShow: "Afficher",
      projectIconsHide: "Masquer",
      status: {
      ...
      toasts: {
        ...
        markReadFailed: "Impossible de marquer l'espace de travail comme lu",
  ...
  newWorkspace: {
    ...
    projectPicker: {
      ...
      accessibilityLabel: "Projet de l'espace de travail",
    },
    hostPicker: {
      title: "Hôte",
      fallbackLabel: "Hôte",
    ...
    isolation: {
      ...
      label: "Isolation",
      accessibilityLabel: "Isolation de l'espace de travail",
    },
    fields: {
      project: "Projet",
      base: "Base",
    ...
    errors: {
      ...
      chooseHostForProject: "Choisissez un hôte pour ce projet",
      hostDisconnected: "Hostn'est pas connecté",
  ...
  pairing: {
    ...
    direct: {
      ...
      helperSameOrigin:
        "Host est prérempli depuis cette page. Gardez-le pour ce serveur, ou modifiez-le pour en connecter un autre.",
      fields: {
        host: "Host",
        port: "Port",
  ...
  settings: {
    ...
    diagnostics: {
      ...
      notification: {
        ...
        rowHint: "Vérifier l'autorisation et envoyer une notification de test",
        sendTest: "Envoyer un test",
        sending: "Envoi...",
        sent: "Notification de test envoyée.",
        notDelivered:
          "La notification n'a pas été délivrée. Vérifiez les paramètres de notification du navigateur ou du système.",
        failed: "Échec de l'envoi de la notification.",
      },
      app: {
        ...
        rowHint:
          "Collecter les détails de connexion, du daemon, des fournisseurs, du bureau, des notifications et des journaux",
        run: "Exécuter",
    ...
    host: {
      ...
      workspaces: {
        ...
        autoArchiveAfterMerge: {
          ...
          hint: "Archiver automatiquement les espaces de travail Paseo propres une fois leur pull request fusionnée",
          accessibilityLabel: "Archiver les espaces de travail dont la PR est fusionnée",
          updateFailedTitle: "Impossible de mettre à jour les espaces de travail",
        },
      },
      browserTools: {
        title: "Outils du navigateur",
        hint: "Autoriser les agents à accéder et à contrôler les onglets du navigateur Paseo, y compris l'état de connexion. Activez ceci uniquement pour les agents de confiance.",
      ...
      terminalAgents: {
        ...
        enableHooks: {
          ...
          hint: "Recevez notifications et statut des agents terminal. Cela installe des hooks dans vos fichiers de configuration d’agent.",
          accessibilityLabel: "Activer les hooks d’agents terminal",
          updateFailedTitle: "Impossible de mettre à jour les hooks d’agents terminal",
        },
      },
      terminalProfiles: {
      ...
      daemon: {
        ...
        update: {
          ...
          hint: "Mettre à jour le daemon vers la dernière version et le redémarrer",
          ...
          unavailableMessage:
            "Cet hôte n'est pas connecté. Attendez qu'il soit en ligne avant de mettre à jour.",
          offlineTitle: "Hôte hors ligne",
          offlineMessage:
            "Cet hôte est hors ligne. Attendez qu'il soit de nouveau en ligne avant de mettre à jour.",
    ...
    providers: {
      ...
      remove: {
        ...
        confirmMessage:
          "Cela supprime l'entrée du fournisseur de config.json. Cette action est irréversible.",
        confirm: "Supprimer",
  ...
  providerUsage: {
    ...
    hostUpgradeRequired: "Mettez à jour l'hôte pour voir l'utilisation des fournisseurs",
    ...
    resetsIn: "réinitialisation {{duration}}",
    runsOutIn: "épuisement {{duration}}",
    durationMinutes: "{{count}} min",
    durationHours: "{{count}} h",
    durationDays: "{{count}} j",
    amountLeft: "{{amount}} restant",
    labels: {
      session: "Session",
      weekly: "Hebdomadaire",
      ...
      codingUsage: "Utilisation de code",
    ...
    errors: {
      grokNetwork:
        "Impossible d'atteindre l'API de facturation Grok. Vérifiez que cli-chat-proxy.grok.com est accessible (les règles de proxy/VPN le bloquent souvent).",
    },
  },
  addProjectFlow: {
    titles: {
      ...
      addProject: "Ajouter un projet",
      searchDirectory: "Rechercher un répertoire",
      cloneGithub: "Cloner depuis GitHub",
      chooseDestination: "Choisir la destination",
      chooseParent: "Choisir le répertoire parent",
      nameDirectory: "Nommer le répertoire",
    },
    placeholders: {
      searchHosts: "Rechercher des hôtes...",
      searchMethods: "Rechercher des méthodes...",
      searchDirectories: "Rechercher des répertoires ou saisir un chemin...",
      searchGithub: "Rechercher ou saisir un dépôt GitHub...",
      searchParents: "Rechercher des répertoires parents ou saisir un chemin...",
      directoryName: "Nom du répertoire",
    },
    methods: {
      searchDirectory: "Rechercher un répertoire",
      searchDirectoryDescription: "Trouver un répertoire sur {{host}}",
      browse: "Parcourir",
      browseDescription: "Choisir ou créer un répertoire dans le Finder",
      github: "Cloner depuis GitHub",
      githubDescriptionSearch: "Rechercher les projets disponibles pour votre compte GitHub",
      githubDescriptionManual: "Saisir une URL GitHub ou owner/repo",
      githubDescriptionUpgrade: "Mettez à jour cet hôte pour cloner des dépôts GitHub",
      newDirectory: "Nouveau répertoire",
      newDirectoryDescription: "Créer un répertoire vide sur {{host}}",
      newDirectoryDescriptionUpgrade: "Mettez à jour cet hôte pour créer des répertoires",
    },
    empty: {
      noHosts: "Aucun hôte connecté",
      noMatching: "Aucune option correspondante",
      enterGithub: "Saisir une URL GitHub ou owner/repo",
    ...
    progress: {
      ...
      creating: "Création du répertoire...",
      loading: "Chargement...",
    },
    rows: {
      addHost: "Ajouter un hôte",
      openThisPath: "Ouvrir ce chemin",
      useThisParent: "Utiliser ce parent",
      existingProject: "Projet existant · {{path}}",
      alreadyExists: "Existe déjà",
      parentDirectory: "Répertoire parent : {{path}}",
      cloneRepositoryUrl: "Cloner cette URL de dépôt",
      cloneViaProtocol: "Cloner owner/repo via {{protocol}}",
      viaProtocol: "{{name}} via {{protocol}}",
    },
    errors: {
      hostUnavailable: "L'hôte est indisponible",
      directoryNotFound: "Répertoire introuvable",
      unableToAdd: "Impossible d'ajouter le projet",
      unableToBrowse: "Impossible de parcourir un répertoire",
      unableToClone: "Impossible de cloner le dépôt",
      unableToCreateDirectory: "Impossible de créer le répertoire",
      enterDirectoryName: "Saisissez un nom de répertoire",
      unableToSearchDirectories: "Impossible de rechercher des répertoires",
      unableToSearchGithub: "Impossible de rechercher des dépôts GitHub",
      githubUnavailable: "La recherche GitHub est indisponible",
    },
    accessibility: {
      back: "Retour",
      page: "Ajouter un projet : {{kind}}",
    },
  },
  schedules: {
    screen: {
    ...
    empty: {
      noActive: "Aucune planification active",
      description: "Les planifications exécutent des agents selon une cadence.",
      noEnded: "Aucune planification terminée",
    },
    errors: {
      unableToLoad: "Impossible de charger les planifications",
      hostLoadFailed: "{{serverName}} : Impossible de charger les planifications",
    },
    row: {
      created: "Créée {{time}}",
      ...
      menu: {
        actions: "Actions {{productName}}",
        edit: "Modifier {{productName}}",
        editRow: "Modifier {{productName}} {{title}}",
    ...
    form: {
      titleCreate: "Nouvelle planification",
      titleEdit: "Modifier la planification",
      titleEditHeartbeat: "Modifier le heartbeat",
      cancel: "Annuler",
      ...
      fields: {
        ...
        nameAccessibility: "Nom de la planification",
        prompt: "Invite",
        promptPlaceholder: "Que doit faire l'agent à chaque exécution ?",
        maxRuns: "Exécutions max.",
        maxRunsPlaceholder: "Illimité",
        maxRunsAccessibility: "Exécutions max.",
        host: "Hôte",
        hostPlaceholder: "Sélectionner un hôte",
        hostEmpty: "Aucun hôte trouvé",
        project: "Projet",
        projectPlaceholder: "Sélectionner un projet",
        projectEmpty: "Aucun projet trouvé",
        projectHint: "Choisissez d'abord un hôte.",
        projectSearch: "Rechercher des projets...",
        projectTitle: "Sélectionner un projet",
        model: "Modèle",
        thinking: "Réflexion",
        thinkingPlaceholder: "Sélectionner la réflexion",
        thinkingEmpty: "Aucune option de réflexion trouvée",
        thinkingTitle: "Sélectionner la réflexion",
        mode: "Mode",
        modePlaceholder: "Mode par défaut",
        modeEmpty: "Aucun mode trouvé",
        modeHint: "Aucun mode disponible pour ce modèle.",
        modeTitle: "Sélectionner un mode",
        archiveOnFinish: "Archiver à la fin",
        isolation: "Isolation",
        isolationPlaceholder: "Sélectionner l'isolation",
        isolationEmpty: "Aucune option d'isolation trouvée",
    ...
    cadence: {
      fieldLabel: "Cadence",
      placeholder: "Sélectionner une cadence",
      ...
      presets: {
        ...
        weekdays9: "Jours ouvrés à 9:00",
        mondays9: "Les lundis à 9:00",
        custom: "Cron personnalisé",
      },
    },
    format: {
      untitled: "{{productName}} sans titre",
      everyMinute: "Chaque minute",
      everyHour: "Chaque heure",
      everyHourAt: "Chaque heure à :{{minutes}}",
      everyInterval: "Tous les {{count}} {{unit}}",
      unitMinute: "minute",
      unitMinutes: "minutes",
      unitHour: "heure",
      unitHours: "heures",
      ...
      weekends: "Week-ends",
      dayPlural: "{{day}}s",
      atTime: "{{when}} à {{time}} {{timezone}}",
      soon: "bientôt",
      inMinutes: "dans {{count}} min",
      inHours: "dans {{count}} h",
      inDays: "dans {{count}} j",
      enterCron: "Saisissez une expression cron",
      invalidCron: "{{detail}} invalide",
      days: {
        sunday: "Dimanche",
        monday: "Lundi",
        tuesday: "Mardi",
