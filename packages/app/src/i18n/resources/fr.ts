...
export const fr: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      removeFile: "Supprimer la pièce jointe du fichier",
  ...
  workspace: {
    ...
    tabs: {
      ...
      actions: {
        ...
        splitRight: "Diviser le volet à droite",
      ...
      toasts: {
        ...
        resumeIdUnavailable: "ID de reprise non disponible",
    ...
    git: {
      actions: {
        ...
        archiveWarning: {
          ...
          unpushedCommit: "{{count}} commit non poussé",
          unpushedCommits: "{{count}} commits non poussés",
        },
      },
      diff: {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        archive: "Archiver",
        archiveWorktree: "Archiver l'arbre de travail",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Laissez Paseo démarrer et arrêter le démon intégré",
  ...
  settings: {
    ...
    general: {
      ...
      terminalScrollback: {
        label: "Défilement du terminal",
        description: "Lignes conservées dans le tampon du terminal intégré",
        accessibilityLabel: "Lignes de défilement du terminal",
      },
      language: {
        label: "Langue",
    ...
    diagnostics: {
      ...
      app: {
        ...
        rowTitle: "Diagnostic de l'app",
        rowHint:
          "Recueillir les détails de connexion, du démon, des fournisseurs, du bureau et des journaux",
        run: "Exécuter",
        running: "Exécution du diagnostic...",
        copyLabel: "rapport de diagnostic",
    ...
    about: {
      ...
      releaseChannel: {
        ...
        description:
          "Passez à Beta pour obtenir des mises à jour plus tôt et contribuer à les façonner",
        stable: "Stable",
        beta: "Bêta",
      },
      updates: {
    ...
    appearance: {
      ...
      syntax: {
        ...
        highlightThemeAccessibility: "Thème de surbrillance : {{value}}",
    ...
    shortcuts: {
      ...
      help: {
        ...
        focusMessageInput: "Concentrer la saisie du message",
        ...
        muteUnmuteVoiceMode: "Couper/réactiver le mode vocal",
      },
      helpNotes: {
    ...
    integrations: {
      ...
      commandLine: {
        ...
        description: "Contrôlez et scriptez les agents depuis votre terminal",
      },
      skills: {
        title: "Compétences d'orchestration",
        ...
        uninstallMessage:
          "Supprime toutes les compétences d'orchestration Paseo de ~/.agents, ~/.claude, ~/.codex.",
      },
      actions: {
        install: "Installer",
        installing: "Installation...",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          hint: "Les agents pourront gérer les arbres de travail, les agents et les plannings",
      ...
      daemon: {
        ...
        restart: {
          ...
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage. Paseo se reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          title: "Mettre à jour le démon",
          hint: "Mettre à jour le démon vers la dernière version et le redémarrer",
          confirm: "Mettre à jour",
          confirmTitle: "Mettre à jour {{name}}",
          confirmMessage:
            "Cela mettra à jour le démon vers la dernière version et le redémarrera. Les agents en cours d'exécution seront brièvement interrompus.",
          ...
          unableToReconnectTitle: "Impossible de se reconnecter",
          unableToReconnectMessage:
            "{{name}} n'est pas revenu en ligne après la mise à jour. Veuillez vérifier que le démon a redémarré.",
          unavailableTitle: "Hôte indisponible",
          unavailableMessage:
    ...
    project: {
      ...
      metadata: {
        ...
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA que Paseo utilise pour générer des métadonnées : utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le format des PR.",
        branchName: "Nom des branches",
