...
export const fr: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      imagePreviewHint: "Touchez pour ouvrir. Appuyez longuement pour enregistrer.",
      imageSaving: "Enregistrement de l'image…",
      imageSaved: "Enregistrée dans Photos",
      imageSavePermissionDenied: "Autorisez l'accès aux photos pour enregistrer cette image.",
