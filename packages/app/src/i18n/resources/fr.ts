  ...
  workspace: {
    ...
    browser: {
      ...
      controls: {
        ...
        annotateElement: "Modifier l'élément",
      ...
      annotate: {
        ...
        submit: "Joindre",
        cancel: "Annuler",
        reset: "Restaurer l’original",
        adjust: "Ajuster les propriétés",
        previewFailed: "Impossible de mettre à jour l’aperçu de l’élément",
        groups: { content: "Contenu", appearance: "Apparence", properties: "Propriétés" },
        fields: {
          checked: "Coché",
          value: "Valeur",
          text: "Texte",
