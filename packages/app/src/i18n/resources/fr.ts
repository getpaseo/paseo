...
export const fr: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        unstageFile: "Retirer de l'index",
        discardFile: "Annuler les changements du fichier",
        discardFileTitle: "Annuler les changements du fichier ?",
        discardFileMessage:
          "Cela supprimera définitivement les changements non validés dans {{path}}.",
        discardFileConfirm: "Annuler",
        fileActionFailed: "Échec de la mise à jour des changements du fichier.",
        fileActionUnavailable: "Les actions de changement de fichier ne sont pas disponibles.",
  ...
  newWorkspace: {
    ...
    newBranch: {
      accessibilityLabel: "Nom de la nouvelle branche",
      placeholder: "Nouvelle branche",
      invalid: "Saisissez un nom de branche valide.",
    },
  },
  desktop: {
    quitting: {
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        newTerminal: "Nouvelle borne",
        openScripts: "Ouvrir les scripts",
