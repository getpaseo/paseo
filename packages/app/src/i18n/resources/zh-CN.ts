  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        ...
        enabledStatus: "已启用",
        disabledStatus: "已停用",
        updateRequired: "请更新此主机以配置 Relay 端点",
        configure: "配置",
        configureTitle: "配置 Relay",
        enabled: "启用 Relay",
        endpoint: "Daemon 端点",
        endpointHint: "Daemon 用于连接 Relay 的地址，格式为 host:port",
        useTls: "Daemon 连接使用 TLS",
        publicEndpoint: "公网端点",
        publicEndpointHint: "写入配对链接的地址，格式为 host:port",
        publicUseTls: "公网连接使用 TLS",
        controlledBy: "此设置由 {{env}} 控制。移除启动覆盖后才能编辑。",
        hostPortError: "请输入 host:port 格式的地址，不要包含 URL scheme",
        save: "保存",
