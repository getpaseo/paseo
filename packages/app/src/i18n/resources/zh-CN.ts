  ...
  settings: {
    ...
    host: {
      ...
      orchestration: {
        ...
        managedMcp: {
          title: "外部 MCP 服务器",
          hint: "将共享服务器注入此主机启动的每个兼容代理。",
          empty: "尚未配置外部 MCP 服务器。",
          addServer: "添加服务器",
          addTitle: "添加 MCP 服务器",
          editTitle: "编辑 {{name}}",
          serverName: "服务器名称",
          ...
          url: "URL",
          arguments: "参数",
          argumentsHint: "每行输入一个参数。",
          alwaysLoad: "始终加载工具",
          alwaysLoadHint: "将此服务器的所有工具保留在代理提示词中。",
          alwaysLoadAccessibility: "始终加载 MCP 工具",
          environmentVariables: "环境变量",
          requestHeaders: "请求标头",
          secretHint: "使用直接私密值或引用 daemon 环境。",
          add: "添加",
          directValue: "直接值",
          environmentSource: "环境",
          variable: "变量",
          header: "标头",
          environmentVariableName: "环境变量名称",
          value: "值",
          keepValueHint: "留空以保留已配置的值。",
          save: "保存",
          test: "测试",
          edit: "编辑",
          remove: "移除",
          enable: "启用 {{name}}",
          connected: "已在 {{latencyMs}} 毫秒内连接 · {{toolCount}} 个工具",
          rejected: "MCP 服务器拒绝了连接。",
          duplicateName: "名为“{{name}}”的 MCP 服务器已存在。",
          updateFailed: "无法更新 MCP 服务器。",
          removeTitle: "移除 MCP 服务器？",
          removeMessage: "从此主机启动的每个代理中移除“{{name}}”？",
          removeFailed: "无法移除 MCP 服务器。",
          testFailed: "无法测试 MCP 服务器。",
          saveFailed: "无法保存 MCP 服务器。",
          entryNameRequired: "每个标头或环境条目都需要名称。",
          envNameRequired: "环境引用需要变量名称。",
          directValueRequired: "直接值不能为空。",
          uniqueEntries: "标头和环境条目名称必须唯一。",
          nameRequired: "服务器名称为必填项。",
          commandRequired: "命令为必填项。",
          urlRequired: "URL 为必填项。",
          invalidUrl: "请输入有效的 MCP 服务器 URL。",
          httpOnly: "MCP 服务器 URL 必须使用 HTTP 或 HTTPS。",
        },
        systemPrompt: {
          title: "System prompt",
