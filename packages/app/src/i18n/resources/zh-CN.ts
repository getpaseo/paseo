  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        ...
        generate: "生成",
        generating: "生成中...",
        generationFailed: "无法生成提交消息。",
        generationUnsupported: "更新主机后才能生成提交消息。",
        selectAll: "选择所有更改",
        selectedCount: "已选择 {{total}} 项中的 {{count}} 项",
        selectAtLeastOne: "至少选择一个文件后再提交。",
        includeFile: "将 {{path}} 包含在提交中",
        discardFile: "放弃 {{path}} 中的更改",
        commitFailed: "无法提交更改。",
      },
      sourceControl: {
        staged: "已暂存的更改",
        ...
        stageBeforeCommit: "请先暂存文件再提交。",
        indexUpdateFailed: "无法更新已暂存的更改。",
        resizeSections: "调整已暂存和未暂存区域的大小",
      },
      diff: {
