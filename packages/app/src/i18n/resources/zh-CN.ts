...
export const zhCN: TranslationResources = {
  ...
  sessions: {
    ...
    organization: {
      ...
      status: { active: "活动中", archived: "已归档" },
      activity: {
        anyTime: "不限时间",
        today: "今天",
      ...
      group: { lastActivity: "最近活动", project: "项目", none: "不分组" },
      sort: { alphabetical: "按字母顺序", createdTime: "创建时间", recency: "最近活动" },
      selection: {
        all: "全部",
        oneSelected: "已选择 1 项",
        selectedCount: "已选择 {{count}} 项",
      },
      updateHost: "{{label}} · 更新主机",
      clearFilters: "清除筛选条件",
    },
  },
  agentList: {
    ...
    sections: { pinned: "已置顶" },
    actions: {
      menuAccessibility: "{{title}}的操作",
      fallbackSession: "会话",
      sheetTitle: "会话操作",
      updateHostToPin: "更新主机以置顶会话",
      pin: "置顶会话",
      unpin: "取消置顶会话",
      pinning: "正在置顶...",
      unpinning: "正在取消置顶...",
      archive: "归档会话",
      updatePinFailed: "无法更新会话置顶状态",
    },
    dateSections: {
      recent: "最近",
      today: "今天",
  ...
  sidebar: {
    ...
    organization: {
      ...
      workspaceTitle: { title: "标题", branchName: "分支名称" },
      selection: {
        all: "全部",
        oneSelected: "已选择 1 项",
        selectedCount: "已选择 {{count}} 项",
      ...
      actions: {
        ...
        newWorkspaceLabel: "新建工作区标签…",
        newWorkspaceLabelSelectHost: "新建工作区标签… · 选择一台主机",
        clearFilters: "清除筛选条件",
        create: "创建",
      },
      project: {
      ...
      projectGroup: {
        ...
        renameTitle: "重命名项目组",
        delete: "删除项目组",
        deleteMessage: "删除“{{name}}”？其中的项目不会被删除。",
        actionsAccessibility: "{{name}}的项目组操作",
      },
      hiddenProjects: {
        title: "隐藏的项目",
        unhideAll: "取消全部隐藏",
        empty: "没有隐藏的项目",
        description: "隐藏的项目和工作区不会显示在侧边栏中，您可以随时恢复显示。",
        showVisible: "显示可见项",
      },
      sections: {
        hidden: "隐藏",
      ...
      workspaceLabel: {
        ...
        none: "无标签",
        unknown: "未知标签",
        renameTitle: "重命名工作区标签",
        delete: "删除工作区标签",
        deleteMessage: "删除“{{name}}”？工作区不会被删除。",
        accessibility: "工作区标签：{{label}}",
        actionsAccessibility: "工作区标签“{{name}}”的操作",
      },
      errors: {
        selectOneHost: "创建工作区标签前请选择一台主机",
        moveFailed: "无法移动工作区",
        createdMoveFailed: "工作区标签已创建，但工作区未移动",
        createdMoveFailedWithError: "工作区标签已创建，但工作区未移动：{{error}}",
        createFailed: "无法创建工作区标签",
        hostDisconnected: "主机未连接",
        deleteWorkspaceLabelFailed: "无法删除工作区标签",
      },
    },
    host: {
      noHost: "没有 Host",
