  ...
  settings: {
    ...
    appearance: {
      ...
      fonts: {
        ...
        codeFont: "代码字体",
        codeFontHint: "用于代码和 diff。留空则使用系统默认",
      ...
      terminal: {
        title: "终端",
        font: "终端字体",
        fontHint: "必须是等宽字体。留空则使用默认字体栈，其中包含用于提示符的 Nerd Font 字形",
        fontAccessibility: "终端字体族",
        size: "终端字号",
        sizeAccessibility: "终端字号",
        sizeInherit: "自动",
        lineHeight: "行高",
        lineHeightAccessibility: "终端行高",
        boldText: "粗体文本",
        boldTextHint: "关闭后粗体输出以常规字重显示。颜色不受影响",
      },
      syntax: {
        title: "语法",
        highlightTheme: "高亮主题",
