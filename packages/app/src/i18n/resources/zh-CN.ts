...
export const zhCN: TranslationResources = {
  ...
  plugins: {
    ...
    conflictsTitle: "被多个插件占用的扩展名",
    conflictLine: "{{extension}}：由 {{winner}} 处理，已忽略 {{losers}}",
    views: {
      installed: "已安装",
      browse: "浏览",
    },
    ...
    errors: {
      ...
      installFailed: "安装失败",
      entryMissing: "缺少插件入口文件。",
      previewFailed: "{{plugin}} 无法渲染此文件：{{reason}}",
      panelFailed: "{{plugin}} 无法渲染此面板：{{reason}}",
    },
  },
  settings: {
    title: "设置",
