  ...
  settings: {
    ...
    diagnostics: {
      ...
      app: {
        title: "应用诊断",
        rowTitle: "应用诊断",
        rowHint: "收集连接、daemon、provider、desktop 和日志详情",
        run: "运行",
        running: "正在运行诊断...",
        copyLabel: "诊断报告",
        copyAccessibility: "复制诊断报告",
        copyFailed: "复制诊断报告失败",
        refreshAccessibility: "刷新诊断报告",
        refreshingAccessibility: "正在刷新诊断报告",
        progress: {
          client: "客户端",
          desktop: "桌面",
        },
    ...
    host: {
      ...
      terminalProfiles: {
        unavailable: "连接到这个 Host 以管理 terminal 配置",
        ...
        moveDown: "下移",
        save: "保存",
        emptyState: "暂无配置。添加一个以使用特定命令启动 terminal。",
      },
      daemon: {
        rename: {
          editLabel: "编辑标签",
        ...
        update: {
          ...
          unableToReconnectTitle: "无法重新连接",
          unableToReconnectMessage: "{{name}} 更新后未能重新上线。请确认 daemon 已重启。",
          unavailableTitle: "Host 不可用",
