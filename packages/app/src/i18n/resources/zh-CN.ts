    ...
    git: {
      ...
      pr: {
        ...
        reviewComments: {
          ...
          loading: "正在加载审查评论…",
          empty: "没有未解决的审查评论。",
          hostUpdateRequired: "请更新主机以使用 PR 审查评论。",
          fixWithAgent: "用 Agent 修复 {{count}} 条评论",
          fixWithAgentPlural: "用 Agent 修复 {{count}} 条评论",
          replies: "{{count}} 条回复",
          repliesPlural: "{{count}} 条回复",
          noActiveAgent: "在此工作区中打开一个 Agent 以修复审查评论。",
          errors: {
            missingCli: "拉取 PR 审查评论需要 GitHub CLI。请在主机上安装 gh，然后重试。",
            authRequired: "GitHub CLI 未认证。请在主机上运行 gh auth login，然后重试。",
            forbidden: "GitHub CLI 无法访问此 PR。请检查仓库权限。",
            notFound: "无法为此工作区加载 PR 审查评论。",
            unknown: "无法为此工作区加载 PR 审查评论。",
          },
        },
      },
    },
