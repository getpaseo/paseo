  ...
  workspace: {
    ...
    browser: {
      ...
      annotate: {
        ...
        adjust: "Ajustar propriedades",
        previewFailed: "Não foi possível atualizar a prévia do elemento",
        groups: { content: "Conteúdo", appearance: "Aparência", properties: "Propriedades" },
        fields: {
          checked: "Marcado",
          value: "Valor",
          text: "Texto",
