...
export const ptBR: TranslationResources = {
  ...
  settings: {
    ...
    notifications: {
      ...
      customSound: "Som da notificação",
      customSoundDefault: "Som do sistema",
      customSoundChoose: "Escolher",
      customSoundClear: "Redefinir",
      customSoundFilter: "Arquivos de áudio",
