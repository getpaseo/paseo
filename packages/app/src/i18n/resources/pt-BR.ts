...
export const ptBR: TranslationResources = {
  ...
  message: {
    ...
    turnFooter: {
      ...
      endedAt: "{{duration}}, terminou às {{time}}",
    },
  },
  toolCall: {
    displayNames: {
      ...
      search: "Buscar",
      fetch: "Obter",
      worktreeSetup: "Configuração do worktree",
      task: "Tarefa",
      thinking: "Pensamento",
      terminal: "Terminal",
      plan: "Plano",
  ...
  workspace: {
    route: {
      ...
      browserTabTitle: "Espaço de trabalho",
      connecting: "Conectando",
    ...
    scripts: {
      title: "Scripts do espaço de trabalho",
      actions: {
    ...
    git: {
      ...
      pr: {
        ...
        accessibility: {
          ...
          pullRequest_mr: "Solicitação de merge !{{number}}",
        },
        states: {
          draft: "Rascunho",
          merged: "Mergeada",
  ...
  sidebar: {
    ...
    workspace: {
      sectionTitle: "Espaços de trabalho",
      ...
      workspaceTitle: "Título do espaço de trabalho",
      titleSource: "Título",
      ...
      toasts: {
        ...
        markReadFailed: "Falha ao marcar o espaço de trabalho como lido",
  ...
  newWorkspace: {
    ...
    projectPicker: {
      ...
      accessibilityLabel: "Projeto do espaço de trabalho",
    },
    hostPicker: {
      title: "Host",
      fallbackLabel: "Host",
    ...
    isolation: {
      ...
      label: "Isolamento",
      accessibilityLabel: "Isolamento do espaço de trabalho",
    },
    fields: {
      project: "Projeto",
      base: "Branch base",
    ...
    errors: {
      ...
      chooseHostForProject: "Escolha um host para este projeto",
      hostDisconnected: "Host não está conectado",
  ...
  settings: {
    ...
    diagnostics: {
      ...
      notification: {
        rowTitle: "Notificações",
        rowHint: "Verificar a permissão e enviar uma notificação de teste",
        sendTest: "Enviar teste",
        sending: "Enviando...",
        sent: "Notificação de teste enviada.",
        notDelivered:
          "A notificação não foi entregue. Verifique as configurações de notificação do navegador ou do sistema.",
        failed: "Falha ao enviar a notificação.",
      },
      app: {
        title: "Diagnóstico do app",
        rowTitle: "Diagnóstico do app",
        rowHint: "Coletar detalhes de conexão, daemon, provedor, desktop, notificação e logs",
        run: "Executar",
    ...
    host: {
      ...
      workspaces: {
        ...
        autoArchiveAfterMerge: {
          ...
          updateFailedTitle: "Não foi possível atualizar workspaces",
        },
      },
      browserTools: {
        title: "Ferramentas do navegador",
        hint: "Permitir que agents acessem e controlem abas do navegador Paseo, incluindo estado logado. Ative apenas para agents em que você confia.",
      ...
      terminalAgents: {
        ...
        enableHooks: {
          title: "Ativar hooks de agents de terminal",
          hint: "Receba notificações e status dos agents de terminal. Isso instala hooks nos arquivos de configuração do agent.",
          accessibilityLabel: "Ativar hooks de agents de terminal",
          updateFailedTitle: "Não foi possível atualizar os hooks de agents de terminal",
        },
      },
      terminalProfiles: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineTitle: "Host desconectado",
          offlineMessage:
    ...
    providers: {
      ...
      remove: {
        ...
        confirmMessage:
          "Isso exclui a entrada do provedor de config.json. Não é possível desfazer.",
        confirm: "Remover",
        errorTitle: "Não foi possível remover o provedor",
      },
      statuses: {
        disabled: "Desativado",
        loading: "Carregando",
  ...
  providerUsage: {
    ...
    labels: {
      ...
      quotaReset: "Redefinição da cota",
      status: "Estado",
      valid: "Válido",
      purchased: "Comprado",
    },
    errors: {
      grokNetwork:
        "Não foi possível acessar a API de cobrança do Grok. Verifique se cli-chat-proxy.grok.com está acessível (regras de proxy/VPN costumam bloqueá-lo).",
    },
  },
  addProjectFlow: {
    titles: {
      ...
      addProject: "Adicionar projeto",
      searchDirectory: "Buscar diretório",
      cloneGithub: "Clonar do GitHub",
      chooseDestination: "Escolher destino",
      chooseParent: "Escolher diretório pai",
      nameDirectory: "Nomear diretório",
    },
    placeholders: {
      searchHosts: "Buscar hosts...",
      searchMethods: "Buscar métodos...",
      searchDirectories: "Buscar diretórios ou inserir um caminho...",
      searchGithub: "Buscar ou inserir um repositório do GitHub...",
      searchParents: "Buscar diretórios pai ou inserir um caminho...",
      directoryName: "Nome do diretório",
    },
    methods: {
      searchDirectory: "Buscar diretório",
      searchDirectoryDescription: "Encontrar um diretório em {{host}}",
      browse: "Navegar",
      browseDescription: "Escolher ou criar um diretório no Finder",
      github: "Clonar do GitHub",
      githubDescriptionSearch: "Buscar projetos disponíveis na sua conta do GitHub",
      githubDescriptionManual: "Inserir uma URL do GitHub ou owner/repo",
      githubDescriptionUpgrade: "Atualize este host para clonar repositórios do GitHub",
      newDirectory: "Novo diretório",
      newDirectoryDescription: "Criar um diretório vazio em {{host}}",
      newDirectoryDescriptionUpgrade: "Atualize este host para criar diretórios",
    },
    empty: {
      noHosts: "Nenhum host conectado",
      noMatching: "Nenhuma opção correspondente",
      enterGithub: "Insira uma URL do GitHub ou owner/repo",
    ...
    progress: {
      ...
      creating: "Criando diretório...",
      loading: "Carregando...",
    },
    rows: {
      addHost: "Adicionar host",
      openThisPath: "Abrir este caminho",
      useThisParent: "Usar este pai",
      existingProject: "Projeto existente · {{path}}",
      alreadyExists: "Já existe",
      parentDirectory: "Diretório pai: {{path}}",
      cloneRepositoryUrl: "Clonar esta URL de repositório",
      cloneViaProtocol: "Clonar owner/repo via {{protocol}}",
      viaProtocol: "{{name}} ({{protocol}})",
    },
    errors: {
      hostUnavailable: "Host indisponível",
      directoryNotFound: "Diretório não encontrado",
      unableToAdd: "Não foi possível adicionar o projeto",
      unableToBrowse: "Não foi possível navegar por um diretório",
      unableToClone: "Não foi possível clonar o repositório",
      unableToCreateDirectory: "Não foi possível criar o diretório",
      enterDirectoryName: "Insira um nome de diretório",
      unableToSearchDirectories: "Não foi possível buscar diretórios",
      unableToSearchGithub: "Não foi possível buscar repositórios do GitHub",
      githubUnavailable: "A busca do GitHub está indisponível",
    },
    accessibility: {
      back: "Voltar",
      page: "Adicionar projeto: {{kind}}",
    },
  },
  schedules: {
    screen: {
    ...
    empty: {
      noActive: "Nenhum agendamento ativo",
      description: "Agendamentos executam agentes em uma cadência.",
      noEnded: "Nenhum agendamento encerrado",
    },
    errors: {
      unableToLoad: "Não foi possível carregar os agendamentos",
      hostLoadFailed: "{{serverName}}: Não foi possível carregar os agendamentos",
    },
    row: {
      created: "Criado {{time}}",
      ...
      status: {
        ...
        expired: "Expirado",
        finished: "Concluído",
        targetGone: "Alvo inexistente",
      },
      menu: {
        actions: "Ações de {{productName}}",
        ...
        starting: "Iniciando...",
        delete: "Excluir {{productName}}",
        deleting: "Excluindo...",
      },
    },
    delete: {
      title: "Excluir {{productName}}",
      message: 'Excluir "{{title}}"? Não é possível desfazer.',
      confirm: "Excluir",
    },
    form: {
      titleCreate: "Novo agendamento",
      titleEdit: "Editar agendamento",
      titleEditHeartbeat: "Editar batimento",
      cancel: "Cancelar",
      ...
      fields: {
        ...
        nameAccessibility: "Nome do agendamento",
        prompt: "Instrução",
        promptPlaceholder: "O que o agente deve fazer a cada execução?",
        maxRuns: "Máximo de execuções",
        maxRunsPlaceholder: "Ilimitado",
        maxRunsAccessibility: "Máximo de execuções",
        host: "Host",
        hostPlaceholder: "Selecionar host",
        hostEmpty: "Nenhum host encontrado",
        project: "Projeto",
        projectPlaceholder: "Selecionar projeto",
        projectEmpty: "Nenhum projeto encontrado",
        projectHint: "Escolha um host primeiro.",
        projectSearch: "Buscar projetos...",
        projectTitle: "Selecionar projeto",
        model: "Modelo",
        thinking: "Pensamento",
        thinkingPlaceholder: "Selecionar pensamento",
        thinkingEmpty: "Nenhuma opção de pensamento encontrada",
        thinkingTitle: "Selecionar pensamento",
        mode: "Modo",
        modePlaceholder: "Modo padrão",
        modeEmpty: "Nenhum modo encontrado",
        modeHint: "Nenhum modo disponível para este modelo.",
        modeTitle: "Selecionar modo",
        archiveOnFinish: "Arquivar ao concluir",
        isolation: "Isolamento",
        isolationPlaceholder: "Selecionar isolamento",
        isolationEmpty: "Nenhuma opção de isolamento encontrada",
        isolationLocal: "Checkout local",
    ...
    format: {
      untitled: "{{productName}} sem título",
      everyMinute: "A cada minuto",
      everyHour: "A cada hora",
      everyHourAt: "A cada hora em :{{minutes}}",
      ...
      dayPlural: "{{day}}",
      atTime: "{{when}} às {{time}} {{timezone}}",
      soon: "em breve",
      inMinutes: "em {{count}} min",
      inHours: "em {{count}} h",
      inDays: "em {{count}} d",
      enterCron: "Insira uma expressão cron",
      invalidCron: "{{detail}} inválido",
      days: {
        sunday: "Domingo",
