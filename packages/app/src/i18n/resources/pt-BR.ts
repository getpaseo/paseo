  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        submodule: {
          detached: "desanexado {{sha}}",
          notInitialized: "O submódulo não foi inicializado",
          unavailable: "O checkout do submódulo não está disponível",
          added: "O submódulo foi adicionado",
          deleted: "O submódulo foi excluído",
          historyUnavailable: "O histórico de commits do submódulo não está disponível",
          headDiffers: "HEAD {{currentSha}} difere do commit fixado {{pinnedSha}}",
          emptyCommitted: "Nenhuma alteração com commit",
        },
