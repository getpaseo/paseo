  ...
  workspace: {
    ...
    git: {
      ...
      commitComposer: {
        ...
        placeholder: "Descreva suas alteracoes",
        generate: "Gerar",
        generating: "Gerando...",
        generationFailed: "Nao foi possivel gerar uma mensagem de commit.",
        generationUnsupported: "Atualize o host para gerar mensagens de commit.",
        selectAll: "Selecionar todas as alteracoes",
        selectedCount: "{{count}} de {{total}} selecionados",
        selectAtLeastOne: "Selecione pelo menos um arquivo para confirmar.",
        includeFile: "Incluir {{path}} no commit",
        discardFile: "Descartar alteracoes em {{path}}",
        commitFailed: "Nao foi possivel confirmar as alteracoes.",
      },
      sourceControl: {
        ...
        stageBeforeCommit: "Prepare os arquivos antes de fazer o commit.",
        indexUpdateFailed: "Não foi possível atualizar as alterações preparadas.",
        resizeSections: "Redimensionar seções preparadas e não preparadas",
      },
      diff: {
