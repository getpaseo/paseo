...
export const ptBR: TranslationResources = {
  ...
  plugins: {
    ...
    conflictsTitle: "Extensões reivindicadas por mais de um plugin",
    conflictLine: "{{extension}}: {{winner}} vence, {{losers}} ignorado",
    views: {
    ...
    errors: {
      ...
      entryMissing: "O arquivo de entrada do plugin está faltando.",
      previewFailed: "{{plugin}} não conseguiu renderizar este arquivo: {{reason}}",
      panelFailed: "{{plugin}} não conseguiu renderizar este painel: {{reason}}",
    },
  },
  settings: {
    title: "Configurações",
