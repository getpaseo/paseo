...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        commits: {
          openHistory: "Abrir a aba Histórico",
          title: "Commits",
  ...
  panels: {
    ...
    commitLog: {
      label: "Histórico",
      subtitle: "Histórico de commits",
      tooltip: "Navegar pelo histórico de commits",
      directoryMissing: "Diretório do espaço de trabalho não encontrado.",
      capabilityMissing: "Atualize o host para navegar pelo histórico de commits.",
      connecting: "Conectando ao host…",
      loading: "Carregando o histórico…",
      loadError: "Falha ao carregar o histórico de commits",
      empty: "Ainda não há commits",
      loadMore: "Carregar mais",
      loadingMore: "Carregando…",
      refresh: "Atualizar",
      refreshing: "Atualizando",
      truncatedRefs: "Mostrando apenas os branches e tags atualizados mais recentemente",
      cursorExpired: "O histórico mudou durante o carregamento. Recarregado do início.",
      scope: {
        head: "Branch atual",
        all: "Todos os branches",
      },
    },
    diff: {
