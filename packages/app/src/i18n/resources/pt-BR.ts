    ...
    host: {
      ...
      orchestration: {
        ...
        managedMcp: {
          ...
          hint: "Injeta servidores compartilhados em cada agente compatível iniciado por este host.",
          empty: "Nenhum servidor MCP externo configurado.",
          ...
          argumentsHint: "Insira um argumento por linha.",
          alwaysLoad: "Sempre carregar ferramentas",
          alwaysLoadHint: "Mantém todas as ferramentas deste servidor no prompt do agente.",
          alwaysLoadAccessibility: "Sempre carregar ferramentas MCP",
          environmentVariables: "Variáveis de ambiente",
          requestHeaders: "Cabeçalhos da requisição",
          secretHint: "Use um valor privado direto ou referencie o ambiente do daemon.",
          add: "Adicionar",
          directValue: "Valor direto",
          environmentSource: "Ambiente",
          variable: "Variável",
          header: "Cabeçalho",
          environmentVariableName: "Nome da variável de ambiente",
          value: "Valor",
          keepValueHint: "Deixe em branco para manter o valor configurado.",
          save: "Salvar",
          test: "Testar",
          edit: "Editar",
          remove: "Remover",
          enable: "Ativar {{name}}",
          connected: "Conectado em {{latencyMs}} ms · {{toolCount}} ferramentas",
          rejected: "O servidor MCP recusou a conexão.",
          duplicateName: "Já existe um servidor MCP chamado '{{name}}'.",
          updateFailed: "Não foi possível atualizar o servidor MCP.",
          removeTitle: "Remover servidor MCP?",
          removeMessage: "Remover '{{name}}' de todos os agentes iniciados por este host?",
          removeFailed: "Não foi possível remover o servidor MCP.",
          testFailed: "Não foi possível testar o servidor MCP.",
          saveFailed: "Não foi possível salvar o servidor MCP.",
          entryNameRequired: "Cada cabeçalho ou entrada de ambiente precisa de um nome.",
          envNameRequired: "Uma referência de ambiente precisa de um nome de variável.",
          directValueRequired: "Um valor direto não pode estar vazio.",
          uniqueEntries: "Os nomes de cabeçalhos e entradas de ambiente devem ser únicos.",
          nameRequired: "O nome do servidor é obrigatório.",
          commandRequired: "O comando é obrigatório.",
          urlRequired: "A URL é obrigatória.",
          invalidUrl: "Insira uma URL válida do servidor MCP.",
          httpOnly: "As URLs do servidor MCP devem usar HTTP ou HTTPS.",
        },
        systemPrompt: {
