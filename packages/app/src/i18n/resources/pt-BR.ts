...
export const ptBR: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      videoPreviewUnavailable: "Prévia do vídeo indisponível.",
      videoPreviewLoadFailed: "Não foi possível carregar a prévia do vídeo.",
      videoPlaybackUnsupported: "A reprodução de vídeo não está disponível nesta plataforma.",
      review: "Revisão",
