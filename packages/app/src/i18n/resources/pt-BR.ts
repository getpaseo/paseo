...
export const ptBR: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      imagePreviewHint: "Toque para abrir. Toque e segure para salvar.",
      imageSaving: "Salvando imagem…",
      imageSaved: "Salva em Fotos",
      imageSavePermissionDenied: "Permita o acesso às Fotos para salvar esta imagem.",
