...
export const ptBR: TranslationResources = {
  ...
  sessions: {
    ...
    organization: {
      trigger: "Filtros e ordenação do histórico",
      emptyFiltered: "Nenhuma sessão corresponde a estes filtros",
      labels: {
        status: "Status",
        project: "Projeto",
        host: "Host",
      ...
      status: { active: "Ativas", archived: "Arquivadas" },
      activity: {
        anyTime: "Qualquer período",
        today: "Hoje",
        pastSevenDays: "Últimos 7 dias",
        pastThirtyDays: "Últimos 30 dias",
      },
      group: { lastActivity: "Última atividade", project: "Projeto", none: "Nenhum" },
      sort: {
      ...
      selection: {
        all: "Todos",
        oneSelected: "1 selecionado",
        selectedCount: "{{count}} selecionados",
      },
      updateHost: "{{label}} · Atualize o host",
  ...
  agentList: {
    ...
    actions: {
      menuAccessibility: "Ações para {{title}}",
      fallbackSession: "sessão",
      sheetTitle: "Ações da sessão",
      updateHostToPin: "Atualize o host para fixar sessões",
      pin: "Fixar sessão",
      unpin: "Desafixar sessão",
      pinning: "Fixando...",
      unpinning: "Desafixando...",
      archive: "Arquivar sessão",
      updatePinFailed: "Não foi possível atualizar a fixação da sessão",
    },
    dateSections: {
      recent: "Recentes",
      today: "Hoje",
  ...
  sidebar: {
    ...
    organization: {
      ...
      labels: {
        ...
        workspaceLabel: "Etiqueta do workspace",
      },
      status: {
        needsInput: "Precisa de atenção",
        working: "Em andamento",
        readyToReview: "Pronto para revisão",
        failed: "Falhou",
        done: "Concluído",
      },
      ...
      group: {
        project: "Projeto",
        projectGroup: "Grupo de projetos",
        status: "Status",
        workspaceLabel: "Etiqueta do workspace",
        none: "Nenhum",
      },
      ...
      workspaceTitle: { title: "Título", branchName: "Nome da branch" },
      selection: {
        all: "Todos",
        oneSelected: "1 selecionado",
        selectedCount: "{{count}} selecionados",
      ...
      actions: {
        ...
        newWorkspaceLabel: "Nova etiqueta de workspace…",
        newWorkspaceLabelSelectHost: "Nova etiqueta de workspace… · Selecione um host",
        clearFilters: "Limpar filtros",
        create: "Criar",
      },
      project: {
        ...
        unhide: "Mostrar projeto",
        moveToProjectGroup: "Mover para grupo de projetos",
        noProjectGroup: "Sem grupo",
      },
      projectGroup: {
        modalTitle: "Novo grupo de projetos",
        placeholder: "Nome do grupo",
        renameTitle: "Renomear grupo de projetos",
        delete: "Excluir grupo de projetos",
        deleteMessage: 'Excluir "{{name}}"? Seus projetos não serão excluídos.',
        actionsAccessibility: "Ações do grupo de projetos {{name}}",
      },
      hiddenProjects: {
        ...
        empty: "Nada oculto",
        description:
          "Projetos e workspaces ocultos ficam fora da barra lateral até serem mostrados novamente.",
        showVisible: "Mostrar itens visíveis",
      },
      sections: {
        hidden: "Ocultos",
        workspaces: "Workspaces",
        projects: "Projetos",
        pinnedProjects: "Projetos fixados",
      },
      workspaceLabel: {
        modalTitle: "Nova etiqueta de workspace",
        placeholder: "Nome da etiqueta",
        none: "Sem etiqueta",
        unknown: "Etiqueta desconhecida",
        renameTitle: "Renomear etiqueta de workspace",
        delete: "Excluir etiqueta de workspace",
        deleteMessage: 'Excluir "{{name}}"? Seus workspaces não serão excluídos.',
        accessibility: "Etiqueta de workspace: {{label}}",
        actionsAccessibility: "Ações da etiqueta de workspace {{name}}",
      },
      errors: {
        selectOneHost: "Selecione um host antes de criar uma etiqueta de workspace",
        moveFailed: "Não foi possível mover o workspace",
        createdMoveFailed: "A etiqueta foi criada, mas o workspace não foi movido",
        createdMoveFailedWithError:
          "A etiqueta foi criada, mas o workspace não foi movido: {{error}}",
        createFailed: "Não foi possível criar a etiqueta de workspace",
        hostDisconnected: "O host não está conectado",
        deleteWorkspaceLabelFailed: "Não foi possível excluir a etiqueta de workspace",
      },
    },
    host: {
      noHost: "Nenhum host",
