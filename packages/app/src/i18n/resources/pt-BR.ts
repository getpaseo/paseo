  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        ...
        updateRequired: "Atualize este host para configurar os endpoints do relay",
        configure: "Configurar",
        configureTitle: "Configurar relay",
        enabled: "Ativar relay",
        endpoint: "Endpoint do daemon",
        endpointHint: "Endereço usado pelo daemon para conectar, como host:port",
        useTls: "Usar TLS na conexão do daemon",
        publicEndpoint: "Endpoint público",
        publicEndpointHint: "Endereço incluído nos links de pareamento, como host:port",
        publicUseTls: "Usar TLS na conexão pública",
        controlledBy: "Controlado por {{env}}. Remova a substituição de inicialização para editar.",
        hostPortError: "Informe um endereço como host:port, sem esquema de URL",
        save: "Salvar",
