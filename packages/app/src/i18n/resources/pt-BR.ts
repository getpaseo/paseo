  ...
  settings: {
    ...
    project: {
      ...
      scripts: {
        ...
        urlAccessibility: "URL do link",
        nameRequired: "O nome é obrigatório",
        commandRequired: "O comando é obrigatório",
        urlRequired: "A URL é obrigatória",
        urlInvalid: "Insira uma URL HTTP ou HTTPS",
        ...
        openUrlHint:
          "Abre no navegador do cliente. Use {workspacePath} para o caminho da árvore de trabalho ou da pasta.",
        openUrlUpdateHost: "Atualize este host do Paseo para adicionar links do navegador.",
        actions: {
