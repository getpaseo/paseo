...
const WEB_SPLASH_SHIMMER_KEYFRAME_ID = "hubcode-splash-shimmer-keyframes";
const WEB_SPLASH_SHIMMER_ANIMATION_NAME = "hubcode-splash-shimmer";
  ...
  const maskElement = useMemo(
    () => (
      <View style={styles.shimmerMask}>
        <HubcodeLogo size={LOGO_SIZE} color="#000000" />
      </View>
    ),
    [],
  );
    ...
    <MaskedView style={trackStyle} maskElement={maskElement}>
      <View style={trackStyle}>
        <View style={styles.nativeShimmerBase}>
          <HubcodeLogo size={LOGO_SIZE} color={color} />
        </View>
