...
function WorkspaceBackingControls({
  backing,
  onBackingChange,
  canCreateWorktree,
  title,
    ...
    () => [
      {
        ...
        label: t("newWorkspace.backing.local"),
        disabled,
      ...
      },
      {
        ...
        label: t("newWorkspace.backing.worktree"),
        disabled: disabled || !canCreateWorktree,
  ...
  return (
    <>
      <SegmentedControl
        ...
        options={options}
        value={backing}
        onValueChange={onBackingChange}
        testID="workspace-create-backing"
      />
      <TextInput
