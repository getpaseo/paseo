...
const terminalColorOverridesSchema = z.strictObject({
...
const colorOverridesSchema = z.strictObject({
  surface3: hexColorSchema.optional(),
  surface4: hexColorSchema.optional(),
  surfaceDiffEmpty: hexColorSchema.optional(),
  surfaceSidebar: hexColorSchema.optional(),
  surfaceSidebarHover: hexColorSchema.optional(),
  surfaceSidebarSelected: hexColorSchema.optional(),
  surfaceWorkspace: hexColorSchema.optional(),
  interactionHighlight: hexColorSchema.optional(),
  foregroundExtraMuted: hexColorSchema.optional(),
  borderAccent: hexColorSchema.optional(),
  ...
  diffAddition: hexColorSchema.optional(),
  diffDeletion: hexColorSchema.optional(),
  statusSuccess: hexColorSchema.optional(),
  statusDanger: hexColorSchema.optional(),
  statusWarning: hexColorSchema.optional(),
  statusMerged: hexColorSchema.optional(),
  statusDotSuccess: hexColorSchema.optional(),
  statusDotDanger: hexColorSchema.optional(),
  statusDotWarning: hexColorSchema.optional(),
  statusDotRunning: hexColorSchema.optional(),
  terminal: terminalColorOverridesSchema.optional(),
});
...
const contributionSchema: z.ZodType<PluginThemeContribution> = z.strictObject({
  ...
  colors: z.strictObject({
    ...
    ring: hexColorSchema,
    overrides: colorOverridesSchema.optional(),
  }),
});
