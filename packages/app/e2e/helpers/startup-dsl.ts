...
const DISABLE_DEFAULT_SEED_ONCE_KEY = "@hubcode:e2e-disable-default-seed-once";
const SEED_NONCE_KEY = "@hubcode:e2e-seed-nonce";
const REGISTRY_KEY = "@hubcode:daemon-registry";
const E2E_KEY = "@hubcode:e2e";
