const VOICE_PROMPT_BLOCK_START = "<hubcode_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</hubcode_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Hubcode voice mode is now on.",
  "You are the Hubcode voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Hubcode voice mode is now off.",
  "Ignore any earlier Hubcode voice mode instructions in this thread.",
].join(" ");
