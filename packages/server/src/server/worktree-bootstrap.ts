...
export async function createAgentWorktree(
  ...
  const existingWorktree = await findExistingHubcodeWorktreeBySlug(options);
  if (existingWorktree) {
...
async function findExistingHubcodeWorktreeBySlug(options: CreateAgentWorktreeOptions) {
