...
const INBOUND_PERMISSION = {
  ...
  "agent.plan.review.claim.request": "workspace.write",
  "agent.plan.revision.send.request": ["workspace.write", "hub.execute"],
  "agent.plan.permission.ensure.request": "workspace.write",
  ...
  "workspace.intent.set.request": "workspace.manage",
...
const OUTBOUND_PERMISSION = {
  ...
  "workspace.intent.set.response": "workspace.manage",
  "agent.plan.review.claim.response": "workspace.write",
  "agent.plan.revision.send.response": ["workspace.write", "hub.execute"],
  "agent.plan.permission.ensure.response": "workspace.write",
