...
const INBOUND_PERMISSION = {
  ...
  "background.activity.snapshot.request": "daemon.manage",
  "background.activity.subscribe.request": "daemon.manage",
...
const OUTBOUND_PERMISSION = {
  ...
  "checkout.chapters.get.response": "workspace.read",
  "background.activity.snapshot.response": "daemon.manage",
  "background.activity.subscribe.response": "daemon.manage",
  "background.activity.changed": "daemon.manage",
