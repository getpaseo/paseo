...
export const StashListRequestSchema = z.object({
  ...
  cwd: z.string(),
  /** If true, only return hubcode-created stashes. Default true. */
  hubcodeOnly: z.boolean().optional(),
  requestId: z.string(),
});
...
export const HubcodeWorktreeListRequestSchema = z.object({
  type: z.literal("hubcode_worktree_list_request"),
  cwd: z.string().optional(),
  repoRoot: z.string().optional(),
  requestId: z.string(),
});

export const HubcodeWorktreeArchiveRequestSchema = z.object({
  type: z.literal("hubcode_worktree_archive_request"),
...
export const SessionInboundMessageSchema = z.discriminatedUnion("type", [
  ...
  HubcodeWorktreeListRequestSchema,
  HubcodeWorktreeArchiveRequestSchema,
...
export const ProjectCheckoutLiteNotGitPayloadSchema = z
  .object({
    ...
    isHubcodeOwnedWorktree: z.literal(false),
    mainRepoRoot: z.null(),
  })
  .transform((value) => ({
    ...value,
...
export const ProjectCheckoutLiteGitNonHubcodePayloadSchema = z
  .object({
    cwd: z.string(),
...
export const ProjectCheckoutLiteGitHubcodePayloadSchema = z
  .object({
    cwd: z.string(),
    isGit: z.literal(true),
    currentBranch: z.string().nullable(),
    remoteUrl: z.string().nullable(),
    worktreeRoot: z.string().optional(),
    isHubcodeOwnedWorktree: z.literal(true),
...
export const ProjectCheckoutLitePayloadSchema = z.union([
  ...
  ProjectCheckoutLiteGitNonHubcodePayloadSchema,
  ProjectCheckoutLiteGitHubcodePayloadSchema,
]);
...
const WorkspaceGitRuntimePayloadSchema = z
  .object({
    ...
    isHubcodeOwnedWorktree: z.boolean().optional(),
...
const CheckoutStatusGitNonHubcodeSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isHubcodeOwnedWorktree: z.literal(false),
  repoRoot: z.string(),
  mainRepoRoot: z.string().nullable().optional().default(null),
...
const CheckoutStatusGitHubcodeSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isHubcodeOwnedWorktree: z.literal(true),
  repoRoot: z.string(),
  mainRepoRoot: z.string(),
...
export const CheckoutStatusResponseSchema = z.object({
  ...
  payload: z.union([
    ...
    CheckoutStatusGitNonHubcodeSchema,
    CheckoutStatusGitHubcodeSchema,
  ]),
});
...
const HubcodeWorktreeSchema = z.object({
  worktreePath: z.string(),
  createdAt: z.string(),
...
export const HubcodeWorktreeListResponseSchema = z.object({
  type: z.literal("hubcode_worktree_list_response"),
  payload: z.object({
    worktrees: z.array(HubcodeWorktreeSchema),
    error: CheckoutErrorSchema.nullable(),
    requestId: z.string(),
  }),
});

export const HubcodeWorktreeArchiveResponseSchema = z.object({
  type: z.literal("hubcode_worktree_archive_response"),
  payload: z.object({
    success: z.boolean(),
...
export const CreateHubcodeWorktreeResponseSchema = z.object({
  type: z.literal("create_hubcode_worktree_response"),
  payload: z.object({
    workspace: WorkspaceDescriptorPayloadSchema.nullable(),
    error: z.string().nullable(),
    errorCode: z.string().optional(),
...
export const SessionOutboundMessageSchema = z.discriminatedUnion("type", [
  ...
  HubcodeWorktreeListResponseSchema,
...
export type HubcodeWorktreeListRequest = z.infer<typeof HubcodeWorktreeListRequestSchema>;
export type HubcodeWorktreeListResponse = z.infer<typeof HubcodeWorktreeListResponseSchema>;
export type HubcodeWorktreeArchiveRequest = z.infer<typeof HubcodeWorktreeArchiveRequestSchema>;
export type HubcodeWorktreeArchiveResponse = z.infer<typeof HubcodeWorktreeArchiveResponseSchema>;
