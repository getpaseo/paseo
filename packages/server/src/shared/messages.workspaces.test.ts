...
describe("workspace message schemas", () => {
  ...
  test.skip("parses workspace descriptors with scripts", () => {
    const parsed = SessionOutboundMessageSchema.parse({
      type: "workspace_update",
      payload: {
        kind: "upsert",
          ...
          scripts: [
            {
              ...
              port: 3000,
              proxyUrl: "http://web.hubcode.localhost:6767",
              lifecycle: "running",
              health: "healthy",
            },
          ],
  ...
  test.skip("parses script_status_update payload", () => {
    const parsed = SessionOutboundMessageSchema.parse({
  ...
  test.skip("parses workspace_setup_progress payload", () => {
    const parsed = SessionOutboundMessageSchema.parse({
