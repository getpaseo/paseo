...
export function Surface() {
  ...
  return <><Icon name="Settings" size={18} color="#123456" /><Text onPress={() => toast.show("Ready")}>Paseo API</Text><Modal open={false} onOpenChange={() => {}} title="Example"><Text>Modal</Text></Modal></>;
}
