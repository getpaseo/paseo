...
export function HeroMockup() {
  // Use a real screenshot of the desktop app instead of the SVG mockup so
  // marketing reflects what the user actually sees today (kanban + workspaces
  // + shared sessions). Asset is in packages/website/public/.
  return (
    <div className="relative w-full max-w-5xl mx-auto">
      <div
        aria-hidden
        className="pointer-events-none absolute -inset-6 rounded-[28px] opacity-60 blur-3xl"
        style={{
          background:
            "radial-gradient(closest-side, rgba(216,27,96,0.55), rgba(255,64,129,0.2) 50%, transparent 75%)",
        }}
      />
      <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-[0_30px_120px_-30px_rgba(216,27,96,0.7)] ring-1 ring-[#D81B60]/20">
        <img
          src="/hero-projects-kanban.png"
          alt="Hubcode desktop — projects, kanban, shared workspaces"
