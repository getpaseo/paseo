...
export const Route = createFileRoute("/docs/configuration")({
  head: () => ({
    meta: pageMeta(
      "Configuration - Hubcode Docs",
      "Configure Hubcode via config.json, environment variables, and CLI overrides.",
    ),
  }),
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          Hubcode loads configuration from a single JSON file in your Hubcode home directory, with
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">Hubcode merges configuration in this order:</p>
  ...
  claude "$@"`}
      ...
      <section className="space-y-4">
        ...
        <ul className="text-white/60 space-y-2 list-disc list-inside">
          ...
          <li>
            File (<code className="font-mono">$HUBCODE_HOME/daemon.log</code>):{" "}
  ...
  "log": {
    ...
    "file": {
      ...
      <section className="space-y-4">
        ...
        <ul className="text-white/60 space-y-2 list-disc list-inside">
          <li>
            <code className="font-mono">HUBCODE_HOME</code> — set Hubcode home directory
          </li>
          <li>
            <code className="font-mono">HUBCODE_LISTEN</code> — override{" "}
          ...
          <li>
            <code className="font-mono">HUBCODE_LOG_FILE_LEVEL</code> — override{" "}
            <code className="font-mono">log.file.level</code>
          </li>
          <li>
            <code className="font-mono">HUBCODE_LOG_FILE_PATH</code> — override{" "}
            <code className="font-mono">log.file.path</code>
          </li>
          <li>
            <code className="font-mono">HUBCODE_LOG_FILE_ROTATE_SIZE</code> — override{" "}
            <code className="font-mono">log.file.rotate.maxSize</code>
          </li>
          <li>
            <code className="font-mono">HUBCODE_LOG_FILE_ROTATE_COUNT</code> — override{" "}
            <code className="font-mono">log.file.rotate.maxFiles</code>
          </li>
          <li>
            <code className="font-mono">HUBCODE_LOG</code>,{" "}
            <code className="font-mono">HUBCODE_LOG_FORMAT</code> — legacy log overrides (still
            supported)
          </li>
          <li>
          ...
          <li>
            <code className="font-mono">HUBCODE_VOICE_LLM_PROVIDER</code> — override voice LLM
            provider (<code className="font-mono">claude</code>,{" "}
            <code className="font-mono">codex</code>, <code className="font-mono">opencode</code>)
          </li>
          <li>
            <code className="font-mono">HUBCODE_DICTATION_STT_PROVIDER</code>,{" "}
            <code className="font-mono">HUBCODE_VOICE_STT_PROVIDER</code>,{" "}
            <code className="font-mono">HUBCODE_VOICE_TTS_PROVIDER</code> — override voice provider
            selection (<code className="font-mono">local</code> or{" "}
            <code className="font-mono">openai</code>)
          </li>
          <li>
            <code className="font-mono">HUBCODE_LOCAL_MODELS_DIR</code> — control local model
            directory
          </li>
          <li>
            <code className="font-mono">HUBCODE_DICTATION_LOCAL_STT_MODEL</code> — override local
            dictation STT model
          </li>
          <li>
            <code className="font-mono">HUBCODE_VOICE_LOCAL_STT_MODEL</code>,{" "}
            <code className="font-mono">HUBCODE_VOICE_LOCAL_TTS_MODEL</code> — override local voice
            STT/TTS models
          </li>
          <li>
            <code className="font-mono">HUBCODE_VOICE_LOCAL_TTS_SPEAKER_ID</code>,{" "}
            <code className="font-mono">HUBCODE_VOICE_LOCAL_TTS_SPEED</code> — optional local voice
            TTS tuning
          </li>
        </ul>
      </section>
