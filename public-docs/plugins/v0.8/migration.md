...
| New context-dependent slash command collection                                                | `client.addSlashCommandProvider(provider)` in `index.client.tsx`; see [dynamic slash command providers](reference#dynamic-slash-command-providers) |
