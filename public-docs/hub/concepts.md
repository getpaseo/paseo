...
3. Hub evaluates triggers and their filters, including the required identity allowlist. See [GitHub events and filters](/docs/hub/configuration/hub-yml#github-events-and-filters) for team filters.
...
Externally sourced triggers require a non-empty identity allowlist. See [GitHub events and filters](/docs/hub/configuration/hub-yml#github-events-and-filters) for team filters. Protect the configuration repository because anyone who can change the active configuration can choose which connections, daemons, and agent capabilities a project uses.
